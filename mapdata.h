...
{"table",            '#', c_red,     4, tr_null,
	mfb(transparent)|mfb(flammable)|mfb(collapses)},
...
{"dresser",          '{', c_brown,   0, tr_null,
	mfb(transparent)|mfb(container)|mfb(flammable)|mfb(collapses)|mfb(bashable)},
{"locker",           '{', c_ltgray,  0, tr_null,
	mfb(container)|mfb(collapses)|mfb(bashable)},
{"display rack",     '{', c_ltgray,  0, tr_null,
        mfb(transparent)|mfb(container)|mfb(l_flammable)|mfb(collapses)|mfb(bashable)},
{"book case",        '{', c_brown,   0, tr_null,
	mfb(container)|mfb(flammable)|mfb(collapses)|mfb(bashable)},
