...
public:
	...
	*/
	...
	/*
	Handles assignment between field classes. Copies of iterators will be "dirty" and won't free memory.
	This is because we want you to be able to copy a temporary field and change the field_entries in it.
	*/
