...
{_("half-built wall"),    '#', c_ltred,   4, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem), &iexamine::none},
{_("wooden wall"),        '#', c_ltred,   0, tr_null,
    mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("chipped wood wall"),  '#', c_ltred,   0, tr_null,
    mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("broken wood wall"),   '&', c_ltred,   0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)|
    mfb(supports_roof), &iexamine::none},
{_("wall"),         LINE_XOXO, c_ltgray,  0, tr_null,
    mfb(flammable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("wall"),         LINE_OXOX, c_ltgray,  0, tr_null,
    mfb(flammable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("concrete wall"),LINE_XOXO, c_dkgray,  0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("concrete wall"),LINE_OXOX, c_dkgray,  0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("metal wall"),   LINE_XOXO, c_cyan,    0, tr_null,
    mfb(noitem)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("metal wall"),   LINE_OXOX, c_cyan,    0, tr_null,
    mfb(noitem)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("glass wall"),   LINE_XOXO, c_ltcyan,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("glass wall"),   LINE_OXOX, c_ltcyan,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("glass wall"),   LINE_XOXO, c_ltcyan,  0, tr_null, // Alarmed
    mfb(transparent)|mfb(bashable)|mfb(alarmed)|mfb(noitem)|
    mfb(supports_roof), &iexamine::none},
{_("glass wall"),   LINE_OXOX, c_ltcyan,  0, tr_null, // Alarmed
    mfb(transparent)|mfb(bashable)|mfb(alarmed)|mfb(noitem)|
    mfb(supports_roof), &iexamine::none},
{_("reinforced glass"), LINE_XOXO, c_ltcyan,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("reinforced glass"), LINE_OXOX, c_ltcyan,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("metal bars"),         '"', c_ltgray,  0, tr_null,
    mfb(transparent)|mfb(noitem), &iexamine::none},
{_("closed wood door"),   '+', c_brown,   0, tr_null,
    mfb(bashable)|mfb(flammable2)|mfb(door)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("damaged wood door"),  '&', c_brown,   0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)|
    mfb(supports_roof), &iexamine::none},
{_("open wood door"),     '\'', c_brown,  2, tr_null,
    mfb(flammable2)|mfb(transparent)|mfb(supports_roof)|mfb(flat), &iexamine::none},
{_("closed wood door"),   '+', c_brown,   0, tr_null, // Locked from all directions
    mfb(bashable)|mfb(flammable2)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("closed wood door"),   '+', c_brown,   0, tr_null, // Actually locked
    mfb(bashable)|mfb(flammable2)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("closed wood door"),   '+', c_brown,   0, tr_null, // Locked and alarmed
    mfb(bashable)|mfb(flammable2)|mfb(alarmed)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("empty door frame"),   '.', c_brown,   2, tr_null,
    mfb(transparent)|mfb(supports_roof)|mfb(flat), &iexamine::none},
{_("locked wire gate"),   '+', c_cyan,    0, tr_null,
    mfb(transparent)|mfb(supports_roof), &iexamine::none},
{_("closed wooden gate"), '+', c_brown,   3, tr_null,
    mfb(transparent)|mfb(supports_roof) |mfb(bashable)|mfb(flammable2), &iexamine::none},
{_("open wooden gate"),   '.', c_brown,   2, tr_null,
    mfb(transparent)|mfb(supports_roof) |mfb(bashable)|mfb(flammable2)|mfb(flat), &iexamine::none},
{_("closed wire gate"),   '+', c_cyan,    0, tr_null,
    mfb(transparent)|mfb(supports_roof), &iexamine::none},
{_("open wire gate"),     '.', c_cyan,    2, tr_null,
    mfb(transparent)|mfb(supports_roof)|mfb(flat), &iexamine::none},
{_("boarded up door"),    '#', c_brown,   0, tr_null,
    mfb(bashable)|mfb(flammable2)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("closed metal door"),  '+', c_cyan,    0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("open metal door"),    '\'', c_cyan,   2, tr_null,
    mfb(transparent)|mfb(supports_roof)|mfb(flat), &iexamine::none},
{_("closed metal door"),  '+', c_cyan,    0, tr_null, // Actually locked
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("closed bar door"),    '+', c_cyan,    0, tr_null,// unlocked, only created at map gen
    mfb(transparent)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("open bar door"),      '\'', c_cyan,   2, tr_null,
    mfb(transparent)|mfb(supports_roof)|mfb(flat), &iexamine::none},
{_("closed bar door"),    '+', c_cyan,    0, tr_null, // locked
    mfb(transparent)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("closed glass door"),  '+', c_ltcyan,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(door)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("open glass door"),    '\'', c_ltcyan, 2, tr_null,
    mfb(transparent)|mfb(supports_roof)|mfb(flat), &iexamine::none},
{_("makeshift portcullis"), '&', c_cyan,   0, tr_null,
    mfb(noitem), &iexamine::none},
{_("steel compactor"),    '&', c_green,   0, tr_null,
    mfb(transparent), &iexamine::recycler},
{_("window"),             '"', c_ltcyan,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)|
    mfb(supports_roof)|mfb(deconstruct), &iexamine::none}, // Plain Ol' window
{_("taped window"),       '"', c_dkgray,  0, tr_null,
...
{_("empty window"),       '0', c_yellow,  8, tr_null,
    mfb(transparent)|mfb(flammable)|mfb(supports_roof), &iexamine::none},
{_("window frame"),       '0', c_ltcyan,  8, tr_null,
    mfb(transparent)|mfb(sharp)|mfb(flammable)|mfb(noitem)|
    mfb(supports_roof), &iexamine::none},
{_("boarded up window"),  '#', c_brown,   0, tr_null,
    mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("high stained glass window"),'"', c_ltgreen,  0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("high stained glass window"),'"', c_ltred,  0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("high stained glass window"),'"', c_ltblue,  0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("solid rock"),         '#', c_white,   0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("odd fault"),          '#', c_magenta, 0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::fault},
{_("paper wall"),         '#', c_white,   0, tr_null,
    mfb(bashable)|mfb(flammable2)|mfb(noitem), &iexamine::none},
{_("tree"),               '7', c_green,   0, tr_null,
    mfb(flammable2)|mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("young tree"),         '1', c_green,   4, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem), &iexamine::none},
{_("apple tree"),         '7', c_ltgreen, 0, tr_null,
    mfb(flammable2)|mfb(noitem)|mfb(supports_roof), &iexamine::tree_apple},
{_("underbrush"),         '#', c_ltgreen, 6, tr_null,
...
{_("shrub"),              '#', c_green,   8, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable2)|
    mfb(thin_obstacle)|mfb(place_item), &iexamine::none},
{_("blueberry bush"),     '#', c_ltgreen, 8, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable2)|mfb(thin_obstacle),
    &iexamine::shrub_blueberry},
{_("strawberry bush"),    '#', c_ltgreen, 8, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable2)|mfb(thin_obstacle),
    &iexamine::shrub_strawberry},
{_("tree trunk"),         '1', c_brown,   4, tr_null,
    mfb(transparent)|mfb(flammable2)|mfb(diggable), &iexamine::none},
{_("root wall"),          '#', c_brown,   0, tr_null,
    mfb(noitem)|mfb(supports_roof), &iexamine::none},
{_("wax wall"),           '#', c_yellow,  0, tr_null,
    mfb(flammable2)|mfb(noitem)|mfb(supports_roof)|mfb(place_item), &iexamine::none},
{_("wax floor"),          '.', c_yellow,  2, tr_null,
    mfb(transparent)|mfb(l_flammable)|mfb(indoors)|mfb(flat), &iexamine::none},
{_("picket fence"),       '|', c_brown,   3, tr_null,
    mfb(bashable)|mfb(transparent)|mfb(diggable)|mfb(flammable2)|mfb(noitem)|mfb(thin_obstacle),
    &iexamine::none},
{_("picket fence"),       '-', c_brown,   3, tr_null,
    mfb(bashable)|mfb(transparent)|mfb(diggable)|mfb(flammable2)|mfb(noitem)|mfb(thin_obstacle),
    &iexamine::none},
{_("chain link fence"),   '|', c_cyan,    0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(thin_obstacle)|mfb(supports_roof), &iexamine::chainfence},
{_("chain link fence"),   '-', c_cyan,    0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(thin_obstacle)|mfb(supports_roof), &iexamine::chainfence},
{_("metal post"),         '#', c_cyan,    2, tr_null,
    mfb(transparent)|mfb(thin_obstacle), &iexamine::none},
{_("fence post"),         '#', c_brown,   2, tr_null,
    mfb(transparent)|mfb(thin_obstacle), &iexamine::fence_post},
{_("wire fence"),         '$', c_blue,    4, tr_null,
    mfb(transparent)|mfb(thin_obstacle), &iexamine::remove_fence_wire},
{_("barbed wire fence"),  '$', c_blue,    4, tr_null,
    mfb(transparent)|mfb(sharp)|mfb(thin_obstacle), &iexamine::remove_fence_barbed},
{_("rope fence"),         '$', c_brown,   3, tr_null,
    mfb(transparent)|mfb(thin_obstacle), &iexamine::remove_fence_rope},
{_("railing"),            '|', c_yellow,  3, tr_null,
    mfb(transparent)|mfb(noitem)|mfb(thin_obstacle), &iexamine::none},
{_("railing"),            '-', c_yellow,  3, tr_null,
    mfb(transparent)|mfb(noitem)|mfb(thin_obstacle), &iexamine::none},
{_("marloss bush"),       '1', c_dkgray,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(flammable2), &iexamine::none},
{_("fungal bed"),         '#', c_dkgray,  3, tr_null,
    mfb(transparent)|mfb(flammable2)|mfb(diggable), &iexamine::none},
{_("fungal tree"),        '7', c_dkgray,  0, tr_null,
    mfb(flammable2)|mfb(noitem), &iexamine::none},
{_("shallow water"),      '~', c_ltblue,  5, tr_null,
    mfb(transparent)|mfb(liquid)|mfb(swimmable), &iexamine::water_source},
{_("deep water"),         '~', c_blue,    0, tr_null,
    mfb(transparent)|mfb(liquid)|mfb(swimmable), &iexamine::water_source},
{_("pool water"),         '~', c_ltblue,  5, tr_null,
    mfb(transparent)|mfb(liquid)|mfb(swimmable)|mfb(indoors),
    &iexamine::water_source},
{_("sewage"),             '~', c_ltgreen, 6, tr_null,
    mfb(transparent)|mfb(swimmable), &iexamine::water_source},
{_("lava"),               '~', c_red,     4, tr_lava,
        mfb(transparent)|mfb(liquid)|mfb(destroy_item), &iexamine::none},
{_("sandbox"),            '#', c_yellow,  3, tr_null,
    mfb(transparent)|mfb(deconstruct), &iexamine::none},
{_("slide"),              '#', c_ltcyan,  4, tr_null,
    mfb(transparent)|mfb(deconstruct), &iexamine::none},
{_("monkey bars"),        '#', c_cyan,    4, tr_null,
    mfb(transparent)|mfb(deconstruct), &iexamine::none},
{_("backboard"),          '7', c_red,     0, tr_null,
    mfb(transparent)|mfb(deconstruct), &iexamine::none},
{_("gasoline pump"),      '&', c_red,     0, tr_null,
    mfb(transparent)|mfb(explodes)|mfb(noitem)|mfb(sealed)|mfb(container), &iexamine::gaspump},
{_("smashed gas pump"),   '&', c_ltred,   0, tr_null,
    mfb(transparent)|mfb(noitem), &iexamine::none},
{_("broken generator"),   '&', c_ltgray,  0, tr_null,
    mfb(transparent)|mfb(noitem), &iexamine::none},
{_("missile"),            '#', c_ltblue,  0, tr_null,
    mfb(explodes)|mfb(noitem), &iexamine::none},
{_("blown-out missile"),  '#', c_ltgray,  0, tr_null,
    mfb(noitem), &iexamine::none},
{_("radio tower"),        '&', c_ltgray,  0, tr_null,
    mfb(noitem), &iexamine::none},
{_("radio controls"),     '6', c_green,   0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(noitem), &iexamine::none},
{_("broken console"),     '6', c_ltgray,  0, tr_null,
    mfb(transparent)|mfb(noitem)|mfb(collapses)|mfb(indoors), &iexamine::none},
{_("computer console"),   '6', c_blue,    0, tr_null,
    mfb(transparent)|mfb(console)|mfb(noitem)|mfb(collapses)|mfb(indoors), &iexamine::none},
{_("mechanical winch"),   '6', c_cyan_red, 0, tr_null,
    mfb(transparent)|mfb(noitem)|mfb(collapses), &iexamine::controls_gate},
{_("mechanical winch"),   '6', c_cyan_red, 0, tr_null,
    mfb(transparent)|mfb(noitem)|mfb(collapses), &iexamine::controls_gate},
{_("rope and pulley"),    '|', c_brown,   0, tr_null,
    mfb(transparent)|mfb(noitem)|mfb(collapses), &iexamine::controls_gate},
{_("rope and pulley"),    '|', c_brown,   0, tr_null,
    mfb(transparent)|mfb(noitem)|mfb(collapses), &iexamine::controls_gate},
{_("sewage pipe"),        '1', c_ltgray,  0, tr_null,
    mfb(transparent), &iexamine::none},
{_("sewage pump"),        '&', c_ltgray,  0, tr_null,
    mfb(noitem), &iexamine::none},
{_("centrifuge"),         '{', c_magenta, 0, tr_null,
    mfb(transparent), &iexamine::none},
{_("column"),             '1', c_ltgray,  0, tr_null,
    mfb(flammable), &iexamine::none},
{_("cloning vat"),        '0', c_ltcyan,  0, tr_null,
    mfb(transparent)|mfb(bashable)|mfb(sealed)|mfb(place_item), &iexamine::none},
{_("stairs down"),        '>', c_yellow,  2, tr_null,
    mfb(transparent)|mfb(goes_down)|mfb(place_item), &iexamine::none},
{_("stairs up"),          '<', c_yellow,  2, tr_null,
    mfb(transparent)|mfb(goes_up)|mfb(place_item), &iexamine::none},
{_("manhole"),            '>', c_dkgray,  2, tr_null,
    mfb(transparent)|mfb(goes_down)|mfb(place_item), &iexamine::none},
{_("ladder"),             '<', c_dkgray,  2, tr_null,
    mfb(transparent)|mfb(goes_up)|mfb(place_item), &iexamine::none},
{_("ladder"),             '>', c_dkgray,  2, tr_null,
    mfb(transparent)|mfb(goes_down)|mfb(place_item), &iexamine::none},
{_("downward slope"),     '>', c_brown,   2, tr_null,
    mfb(transparent)|mfb(goes_down)|mfb(place_item), &iexamine::none},
{_("upward slope"),       '<', c_brown,   2, tr_null,
    mfb(transparent)|mfb(goes_up)|mfb(place_item), &iexamine::none},
{_("rope leading up"),    '<', c_white,   2, tr_null,
    mfb(transparent)|mfb(goes_up), &iexamine::none},
{_("manhole cover"),      '0', c_dkgray,  2, tr_null,
    mfb(transparent), &iexamine::none},
{_("card reader"),        '6', c_pink,    0, tr_null, // Science
    mfb(noitem), &iexamine::cardreader},
{_("card reader"),        '6', c_pink,    0, tr_null, // Military
    mfb(noitem), &iexamine::cardreader},
{_("broken card reader"), '6',c_ltgray,   0, tr_null,
    mfb(noitem), &iexamine::none},
{_("slot machine"),       '6', c_green,   0, tr_null,
    mfb(bashable)|mfb(noitem)|mfb(indoors), &iexamine::slot_machine},
{_("elevator controls"),  '6', c_ltblue,  0, tr_null,
    mfb(noitem)|mfb(indoors), &iexamine::elevator},
{_("powerless controls"), '6',c_ltgray,   0, tr_null,
    mfb(noitem)|mfb(indoors), &iexamine::none},
{_("elevator"),           '.', c_magenta, 2, tr_null,
    mfb(indoors)|mfb(transparent), &iexamine::none},
{_("dark pedestal"),      '&', c_dkgray,  0, tr_null,
    mfb(transparent), &iexamine::pedestal_wyrm},
{_("light pedestal"),     '&', c_white,   0, tr_null,
    mfb(transparent), &iexamine::pedestal_temple},
{_("red stone"),          '#', c_red,     0, tr_null,
    0, &iexamine::none},
{_("green stone"),        '#', c_green,   0, tr_null,
    0, &iexamine::none},
{_("blue stone"),         '#', c_blue,    0, tr_null,
    0, &iexamine::none},
{_("red floor"),          '.', c_red,     2, tr_null,
    mfb(transparent)|mfb(flat), &iexamine::none},
{_("green floor"),        '.', c_green,   2, tr_null,
    mfb(transparent)|mfb(flat), &iexamine::none},
{_("blue floor"),         '.', c_blue,    2, tr_null,
    mfb(transparent)|mfb(flat), &iexamine::none},
{_("yellow switch"),       '6', c_yellow,  0, tr_null,
    mfb(transparent), &iexamine::fswitch},
{_("cyan switch"),         '6', c_cyan,    0, tr_null,
    mfb(transparent), &iexamine::fswitch},
{_("purple switch"),       '6', c_magenta, 0, tr_null,
    mfb(transparent), &iexamine::fswitch},
{_("checkered switch"),    '6', c_white,   0, tr_null,
    mfb(transparent), &iexamine::fswitch}
};
