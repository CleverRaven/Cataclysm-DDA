...
// Ground
t_dirt, t_dirtmound, t_pit_shallow, t_pit, t_pit_corpsed, t_pit_covered, t_pit_spiked, t_pit_spiked_covered,
...
{"toilet",           '&', c_white,   4, tr_null,
	mfb(transparent)|mfb(bashable)|mfb(l_flammable)|mfb(collapses)|mfb(deconstruct)},
