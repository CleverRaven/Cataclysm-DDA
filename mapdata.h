...
{"underbrush",       '#', c_ltgreen, 6, tr_null,
	...
	mfb(flammable)|mfb(thin_obstacle)},
{"shrub",            '#', c_green,   8, tr_null,
	mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable)|mfb(thin_obstacle)},
...
{"makeshift bed",    '#', c_magenta, 5, tr_null,
        mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(collapses)},
