...
t_root_wall,
t_wax, t_floor_wax,
t_fence_gate, t_fence_v, t_fence_h, t_chainfence_v, t_chainfence_h, t_chainfence_posts,
...
{"closed wood gate", '+', c_brown,   0, tr_null,
        mfb(bashable)|mfb(flammable2)|mfb(door)|mfb(noitem)|mfb(transparent)},
