...
struct islot_gun : common_ranged_data {
    ...
    int ups_charges = 0;
	/**
     * If this uses "compressed air" charges, how many (per shoot), 0 for no charges at all.
     */
	 int comp_air_charges = 0;
    /**
...
struct islot_gunmod : common_ranged_data {
	...
	/** Increases base gun compressed air consumption by this many charges per shot */
    int comp_air_charges = 0;
