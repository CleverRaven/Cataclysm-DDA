...
// Make it seen on our map
 ...
 tinymap doghouse(&(g->itypes), &(g->traps));
...
// Make it seen on our map
 ...
 tinymap zomhouse(&(g->itypes), &(g->traps));
...
// Make it seen on our map
 ...
 tinymap grove(&(g->itypes), &(g->traps));
...
// Make it seen on our map
 ...
 tinymap compmap(&(g->itypes), &(g->traps));
