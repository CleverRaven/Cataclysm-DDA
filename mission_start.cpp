...
// Make it seen on our map
 ...
 doghouse.add_spawn(mon_dog, 1, SEEX, SEEY, true, true, -1, miss->uid);
...
// Make it seen on our map
 ...
 zomhouse.add_spawn(mon_zombie, 1, SEEX, SEEY, false, true, -1, miss->uid, Name::get(nameIsFemaleName | nameIsGivenName));
...
// Make it seen on our map
 ...
 grove.add_spawn(mon_jabberwock, 1, SEEX, SEEY, false, true, -1, miss->uid, "NONE");
...
// Make it seen on our map
 ...
 tile.add_spawn(mon_zombie_master, 1, SEEX, SEEY, false, true, -1, miss->uid, "Demonic Soul");
