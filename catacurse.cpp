...
fin.open("data\\FONTDATA");
 if (!fin.is_open()){
    ...
    WindowWidth= (69 + OPTIONS[OPT_VIEWPORT_X]) * fontwidth;
    WindowHeight=(14 + OPTIONS[OPT_VIEWPORT_Y]) *fontheight;
...
//    WindowCount=0;
    ...
    delete typeface_c;
    mainwin = newwin((14 + (OPTIONS[OPT_VIEWPORT_Y] * 2 + 1)),(69 + (OPTIONS[OPT_VIEWPORT_Y] * 2 + 1)),0,0);
