...
All contributions, including code, data, images, PR summaries, research, textual descriptions, and testing must be authored/performed by the submitter, with a few exceptions such as porting changes from another fork while maintaining attributions.
