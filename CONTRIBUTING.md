...
All contents sourced from LLMs such as ChatGPT (including but not limited to code, configuration, issue and PR text, research, and testing results) are not allowed as they do not have any authorship, and additionally the provenance of this kind of content is legally and morally questionable at best.
