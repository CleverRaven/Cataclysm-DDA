...
- unlike DDA, we are less concerned with perfect statistical simulation, because we don't have to deal with the problem of people adding millions of new guns to the game. Rather, we should have a select list of appropriate guns that cover a lot of use cases, with play balance as important a consideration as verisimilitude.
