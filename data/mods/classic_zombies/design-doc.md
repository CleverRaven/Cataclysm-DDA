...
- - related to this, specifically named locations with a particularly canadian feel, such as "Tim Hortons" and "Canadian Tire" are very much encouraged, either in pure form or in satirically modified recognizable form.
...
##### Guns
Guns are a particular sticking point as DDA is very gun-heavy.  While guns are still very common in Canada, particularly in Alberta, the types of guns and the culture around them is dramatically different.  Disclaimer: I (erk, writing this) am not likely to make these changes myself; on that note, what follows are modifiable with discussion by whomever might take it on.
...
- Special rare weapons that are time period appropriate but unlikely in the setting can be allowed, but these should be set pieces. For example, something like a semiautomatic carbine could be available in a particular quest once the first winter comes.  We should take care not to make these unusable due to lack of ammo, nor to make ammo too common.
