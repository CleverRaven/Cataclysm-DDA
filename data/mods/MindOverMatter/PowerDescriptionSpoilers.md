...
*Channeling Time*: 50 moves, minus 2 moves per level to a minimum of 20<br />
*Effects*: Allows the psion to "see" in the dark--this is technically not sight but functions that way for game purposes.  This increases the psion's night vision by 2 squares plus 1.5 squares per power level.  If the psions also has Heightened Senses level 7 or higher active, they can craft in darkness as well.<br />
