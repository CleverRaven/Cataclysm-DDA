...
### Underlayer
These are a type of bodyglove designed to integrate with the frame.  These are attached to the suit itself rather than worn on the body.  Underlayers are not required for operation, but prevent accidental injury as the frame moves.  Specialized layers are built for various environments or combat.
...
| Name        | Capacity | Fuel      | Volume | Weight
| ---         | ---      | ---       | ---    | ---
| Battery PSU | 40000    | Battery   |   20 L | 15 kg
| ICE PSU     | 10000    | Gasoline  |   25 L | 20 kg
| Large Aux   | 4000     | Battery   |    5 L |  5 kg
| Small Aux   | 1000     | Battery   |    1 L |  2 kg
| Microgen    | 1000     | Generates |  2.5 L |  5 kg
...
| Location | Volume Cap | Weight Cap | Large | Medium | Small | Helmet | PSU
| ---      | ---        | ---        | ---   | ---    | ---   | ---    | ---
...
| ---               | ---    | ---        | ---    | ---
| Large Support     | Large  | 1000       | 10 kg  | Adds an additional 20 kg of carry weight while active.
| Small Support     | Small  |  750       |  2 kg  | Adds an additional 10 kg of carry weight while active.
...
| Cartridge Charger | Small  | As needed  | 500 g  | Recharges a single power cartridge at a time from the frame's power reserves.
