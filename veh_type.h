...
//                                                           size
    ...
    { "wheel",      'o', c_dkgray,  'x', c_ltgray,  50,  200, 10, 0, itm_wheel, 2,
        mfb(vpf_external) | mfb (vpf_mount_over) | mfb(vpf_wheel) | mfb(vpf_mount_point) },
//
    { "1-cylinder combustion engine",    '*', c_ltred,  '#', c_red,     80, 150, 40, AT_GAS, itm_1cyl_combustion, 2,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "V-twin combustion engine",       '*', c_ltred,  '#', c_red,     80, 200, 120, AT_GAS, itm_v2_combustion, 2,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "Inline-4 combustion engine",     '*', c_ltred,  '#', c_red,     80, 300, 300, AT_GAS, itm_i4_combustion, 3,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "V6 combustion engine",       '*', c_ltred,  '#', c_red,     80, 400, 800, AT_GAS, itm_v6_combustion, 4,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "V8 combustion engine",       '*', c_ltred,  '#', c_red,     80, 400, 800, AT_GAS, itm_v8_combustion, 4,
        mfb(vpf_internal) | mfb(vpf_engine) },
