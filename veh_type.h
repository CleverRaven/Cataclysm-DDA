...
//                                                           wheel_width(inches)
    ...
    { "small wheel",    'o',c_dkgray, 'x', c_ltgray,  50,  70, 6, 0, "NULL", "wheel_small", 2,
        mfb(vpf_external) | mfb (vpf_mount_over) | mfb(vpf_wheel) | mfb(vpf_mount_point) | mfb(vpf_variable_size) },
//
    { "1-cylinder engine",    '*', c_ltred,  '#', c_red,     80, 150, 40, 0, "GAS", "1cyl_combustion", 2,
        mfb(vpf_internal) | mfb(vpf_engine) | mfb(vpf_variable_size) },
    { "V-twin engine",       '*', c_ltred,  '#', c_red,     80, 200, 120, 0, "GAS", "v2_combustion", 2,
        mfb(vpf_internal) | mfb(vpf_engine) | mfb(vpf_variable_size) },
    { "Inline-4 engine",     '*', c_ltred,  '#', c_red,     80, 300, 300, 0, "GAS", "i4_combustion", 3,
        mfb(vpf_internal) | mfb(vpf_engine) | mfb(vpf_variable_size) },
    { "V6 engine",       '*', c_ltred,  '#', c_red,     80, 400, 800, 0, "GAS", "v6_combustion", 4,
        mfb(vpf_internal) | mfb(vpf_engine) | mfb(vpf_variable_size) },
    { "V8 engine",       '*', c_ltred,  '#', c_red,     80, 400, 800, 0, "GAS", "v8_combustion", 4,
        mfb(vpf_internal) | mfb(vpf_engine) | mfb(vpf_variable_size) },
    { "electric motor",             '*', c_yellow,  '#', c_red,    80, 200, 70, 0, "BATT", "motor", 3,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "large electric motor",       '*', c_yellow,  '#', c_red,    80, 400, 350, 0, "BATT", "motor_large", 4,
        mfb(vpf_internal) | mfb(vpf_engine) },
    ...
    { "Foot pedals",                '*', c_ltgray,  '#', c_red,     50, 50, 70, 0, "MUSCLE", "foot_crank", 1,
        mfb(vpf_internal) | mfb(vpf_engine) },
//                                                                         capacity type
    { "gasoline tank",              'O', c_ltred,  '#', c_red,     80, 150, 3000, 0, "GAS", "metal_tank", 1,
        mfb(vpf_internal) | mfb(vpf_fuel_tank) },
    { "storage battery",            'O', c_yellow,  '#', c_red,    80, 300, 100000, 0, "BATT", "storage_battery", 2,
        mfb(vpf_internal) | mfb(vpf_fuel_tank) },
    { "minireactor",                'O', c_ltgreen,  '#', c_red,    80, 700, 10000, 0, "PLUT", "minireactor", 7,
        mfb(vpf_internal) | mfb(vpf_fuel_tank) },
...
//                                                          bonus
    ...
    { "mounted flamethrower", 't', c_dkgray,  '#', c_dkgray,  80, 400, 0, 0, "GAS", "flamethrower", 7,
