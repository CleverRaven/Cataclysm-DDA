...
std::string option_string(option_key key)
{
    ...
    case OPT_VIEWPORT_Y:
        return "viewport_y";
    case OPT_STATIC_SPAWN:
        return "static_spawn";
    case OPT_CLASSIC_ZOMBIES:
        return "classic_zombies";
    default:
...
std::string option_desc(option_key key)
{
    ...
    case OPT_RAIN_ANIMATION:
        return "If true, will display weather animations";
    case OPT_QUERY_DISASSEMBLE:
