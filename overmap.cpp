...
oter_id shop(int dir)
{
    ...
    case 13:
        ...
        break;
    case 14:
        ret = ot_s_electronics_north;
        break;
    case 15:
        ret = ot_pawn_north;
        break;
    case 16:
        ret = ot_mil_surplus_north;
        break;
    case 17:
        ret = ot_s_garage_north;
        break;
    case 18:
        ret = ot_police_north;
        break;
                   ...
                   int &origx, int &origy, char &ch, bool blink)
{
             ...
             target.y > cursy + om_map_width / 2    ))
    {
        ...
        case NORTHEAST:
            ...
            break;
        case EAST:
            mvwputch(w, (om_map_height / 2),
                     om_map_width - 1, c_red, '>');
            break;
        case SOUTHEAST:
            mvwputch(w, om_map_height,
                     om_map_width - 1, c_red, LINE_XOOX);
            break;
        case SOUTH:
            mvwputch(w, om_map_height,
                     om_map_height / 2, c_red, 'v');
            break;
        case SOUTHWEST:
