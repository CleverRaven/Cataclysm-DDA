...
int disease_speed_boost(disease dis)
{
    ...
    case DI_WEBBED:
        return -25;
    case DI_ADRENALINE:
        return (dis.duration > 150 ? 40 : -10);
    case DI_ASTHMA:
        return 0 - int(dis.duration / 5);
    case DI_GRACK:
        return +20000;
    case DI_METH:
        return (dis.duration > 600 ? 50 : -40);
    default:
        return 0;
    }
}
...
std::string dis_name(disease dis)
{
    ...
    case DI_COLD_FEET:
        ...
        case 2:
            return "Cold feet!";
        case 3:
            return "Freezing feet!!";
        }
    case DI_FROSTBITE_HANDS:
        switch (dis.intensity)
        {
        case 1:
            return "Frostnip - hands";
        case 2:
    ...
    case DI_HOT_FEET:
        ...
        case 2:
            return "Hot feet!";
        case 3:
            return "Scorching feet!!";
        }
    case DI_BLISTERS_MOUTH:
        return "Blisters - face";
    case DI_BLISTERS_TORSO:
        return "Blisters - torso";
    case DI_BLISTERS_ARMS:
        return "Blisters - arms";
    case DI_BLISTERS_HANDS:
        return "Blisters - hands";
    case DI_BLISTERS_LEGS:
        return "Blisters - legs";
    case DI_BLISTERS_FEET:
        return "Blisters - feet";
    case DI_COMMON_COLD:
        return "Common Cold";
    case DI_FLU:
        return "Influenza";
    ...
    case DI_ARMOR_BOOST:
        return "Armor Bonus";
    case DI_SPEED_BOOST:
        return "Attack Speed Bonus";
    case DI_VIPER_COMBO:
        switch (dis.intensity)
        {
        case 1:
            return "Snakebite Unlocked!";
        case 2:
            return "Viper Strike Unlocked!";
        default:
            return "VIPER BUG!!!!";
        }
    case DI_BITE:
    ...
    case DI_RECOVER:
        return "Recovering From Infection";
...
std::string dis_description(disease dis)
{
    ...
    case DI_COLD_HEAD:
        ...
        {
        case 1:
            return "Your head is exposed to the cold.";
        case 2:
            return "Your head is very exposed to the cold. It is hard to concentrate.";
        case 3:
            return "Your head is dangerously cold. Getting undressed sounds like a good idea.";
        }
    ...
    case DI_COLD_EYES:
        ...
        {
        case 1:
            return "Your eyes are exposed to the cold.";
        case 2:
            return "Your eyes are very exposed to the cold.";
        case 3:
            return "Your eyes are dangerously cold.";
        }
    ...
    case DI_COLD_MOUTH:
        ...
        {
        case 1:
            return "Your mouth is exposed to the cold.";
        case 2:
            return "Your mouth is very exposed to the cold.";
        case 3:
            return "Your mouth is dangerously cold.";
        }
    ...
    case DI_COLD_TORSO:
        ...
        {
        case 1:
            return "Your torso is exposed to the cold.";
        case 2:
            return "Your torso is very exposed to the cold. Your actions are incoordinated.";
        case 3:
            return "Your torso is dangerously cold. Your actions are incredibly incoordinated.";
        }
    ...
    case DI_COLD_ARMS:
        ...
        {
        case 1:
            return "Your arms are exposed to the cold.";
        case 2:
            return "Your arms are very exposed to the cold. Your arms are shivering.";
        case 3:
            return "Your arms is dangerously cold. Your arms are shivering uncontrollably";
        }
    ...
    case DI_COLD_HANDS:
        ...
        {
        case 1:
            return "Your hands are exposed to the cold.";
        case 2:
            return "Your hands are very exposed to the cold. Your hands are shivering.";
        case 3:
            return "Your hands is dangerously cold. Your hands are shivering uncontrollably";
        }
    ...
    case DI_COLD_LEGS:
        ...
        {
        case 1:
            return "Your legs are exposed to the cold.";
        case 2:
            return "Your legs are very exposed to the cold. Your strength is sapped.";
        case 3:
            return "Your legs is dangerously cold. Your strength is sapped.";
        }
    ...
    case DI_COLD_FEET:
        ...
        {
        case 1:
            return "Your feet are exposed to the cold.";
        case 2:
            return "Your feet are very exposed to the cold. Your strength is sapped.";
        case 3:
            return "Your feet is dangerously cold. Your strength is sapped.";
        }
 ...
 Your legs are frostbitten from prolonged exposure to the cold. It is extremely painful.";
    ...
    case DI_HOT_HEAD:
        ...
        {
        case 1:
            return "Your head feels warm.";
        case 2:
            return "Your head is sweating from the heat. You feel nauseated. You have a headache.";
        case 3:
            return "Your head is sweating profusely. You feel very nauseated. You have a headache.";
        }
    ...
    case DI_HOT_TORSO:
        ...
        {
        case 1:
            return "Your torso feels warm.";
        case 2:
            return "Your torso is sweating from the heat. You feel weak.";
        case 3:
            return "Your torso is sweating profusely. You feel very weak.";
        }
    ...
    case DI_HOT_ARMS:
        ...
        {
        case 1:
            return "Your arms feel warm.";
        case 2:
            return "Your arms are sweating from the heat.";
        case 3:
            return "Your arms are sweating profusely. Your muscles are in pain due to cramps.";
        }
    ...
    case DI_HOT_HANDS:
        ...
        {
        case 1:
            return "Your hands feel warm.";
        case 2:
            return "Your hands feel hot and incoordinated.";
        case 3:
            return "Your hands feel disgustinly hot and are very incoordinated.";
        }
    ...
    case DI_HOT_LEGS:
        ...
        {
        case 1:
            return "Your legs feel warm.";
        case 2:
            return "Your legs are sweating from the heat.";
        case 3:
            return "Your legs are sweating profusely. Your muscles are in pain due to cramps.";
        }
    ...
    case DI_HOT_FEET:
        ...
        {
        case 1:
            return "Your feet feel hot.";
        case 2:
            return "Your feet are painfully swollen due to the heat.";
        case 3:
            return "Your feet are painfully swollen due to the heat.";
        }
