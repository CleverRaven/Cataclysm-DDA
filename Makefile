...
astyle:
	$(ASTYLE_BINARY) --options=.astylerc -n $(shell cat doc/astyled_whitelist)
...
ASTYLE_CHECK=$(shell $(ASTYLE_BINARY) --options=.astylerc --dry-run -X -Q $(shell cat doc/astyled_whitelist))
endif
