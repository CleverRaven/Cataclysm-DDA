...
void Item_factory::init(){
    ...
    iuse_function_list["MUTAGEN_SPIDER"] = &iuse::mutagen_spider;
    iuse_function_list["MUTAGEN_SLIME"] = &iuse::mutagen_slime;
    iuse_function_list["MUTAGEN_FISH"] = &iuse::mutagen_fish;
    iuse_function_list["MUTAGEN_RAT"] = &iuse::mutagen_rat;
    iuse_function_list["MUTAGEN_BEAST"] = &iuse::mutagen_beast;
    iuse_function_list["MUTAGEN_CATTLE"] = &iuse::mutagen_cattle;
    iuse_function_list["MUTAGEN_CEPHALOPOD"] = &iuse::mutagen_cephalopod;
    iuse_function_list["MUTAGEN_BIRD"] = &iuse::mutagen_bird;
    iuse_function_list["MUTAGEN_LIZARD"] = &iuse::mutagen_lizard;
    iuse_function_list["MUTAGEN_TROGLOBITE"] = &iuse::mutagen_troglobite;
