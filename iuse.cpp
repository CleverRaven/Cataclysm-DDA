...
void iuse::geiger(game *g, player *p, item *it, bool t)
{
    ...
    {
    case 1:
        g->add_msg_if_player(p,"Your radiation level: %d", p->radiation);
        break;
    case 2:
        g->add_msg_if_player(p,"The ground's radiation level: %d",
...
void iuse::knife(game *g, player *p, item *it, bool t)
{
    ...
    case 2:
    {
        ...
        if (cut->type->id == "stick" || cut->type->id == "2x4")
        {
            ...
            int count = 8;
            g->m.spawn_item(p->posx, p->posy, g->itypes["splinter"], 0);
