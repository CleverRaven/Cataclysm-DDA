...
static int player_get_cash(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_get_cash is not a player");
    }
    lua_pushboolean(L, (*player_instance)->cash);
    return 1;  // 1 return value
}
static int player_set_cash(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_set_cash is not a player");
    }
    luaL_checktype(L, 2, LUA_TBOOLEAN);
    int value = (int) lua_toboolean(L, 2);
    (*player_instance)->cash = value;
...
static int player_get_radiation(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_get_radiation is not a player");
    }
    lua_pushnumber(L, (*player_instance)->radiation);
    return 1;  // 1 return value
}
static int player_set_radiation(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_set_radiation is not a player");
    }
    luaL_checktype(L, 2, LUA_TNUMBER);
    int value = (int) lua_tonumber(L, 2);
    (*player_instance)->radiation = value;
    return 0;  // 0 return values
}
...
static int player_get_pain(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_get_pain is not a player");
    }
    lua_pushnumber(L, (*player_instance)->pain);
    return 1;  // 1 return value
}
static int player_set_pain(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_set_pain is not a player");
    }
    luaL_checktype(L, 2, LUA_TNUMBER);
    int value = (int) lua_tonumber(L, 2);
    (*player_instance)->pain = value;
    return 0;  // 0 return values
}
...
static int player_get_underwater(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_get_underwater is not a player");
    }
    lua_pushboolean(L, (*player_instance)->underwater);
    return 1;  // 1 return value
}
...
static int player_get_dodges_left(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_get_dodges_left is not a player");
    }
    lua_pushnumber(L, (*player_instance)->dodges_left);
    return 1;  // 1 return value
}
static int player_set_dodges_left(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_set_dodges_left is not a player");
    }
    luaL_checktype(L, 2, LUA_TNUMBER);
    int value = (int) lua_tonumber(L, 2);
    (*player_instance)->dodges_left = value;
    return 0;  // 0 return values
}
...
static int player_get_blocks_left(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_get_blocks_left is not a player");
    }
    lua_pushnumber(L, (*player_instance)->blocks_left);
    return 1;  // 1 return value
}
static int player_set_blocks_left(lua_State *L) {
    player** player_instance = (player**) lua_touserdata(L, 1);

    if(!player_instance) {
        return luaL_error(L, "First argument to player_set_blocks_left is not a player");
    }
    luaL_checktype(L, 2, LUA_TNUMBER);
    int value = (int) lua_tonumber(L, 2);
    (*player_instance)->blocks_left = value;
    return 0;  // 0 return values
}
...
static int rng(lua_State *L) {
    ...
    int rval = rng(parameter1, parameter2);
    lua_pushnumber(L, rval);
    return 1; // 1 return values
}
static const struct luaL_Reg gamelib [] = {
    {"player_get_cash", player_get_cash},
    {"player_set_cash", player_set_cash},
    ...
    {"player_get_radiation", player_get_radiation},
    {"player_set_radiation", player_set_radiation},
    ...
    {"player_get_pain", player_get_pain},
    {"player_set_pain", player_set_pain},
    {"player_get_dex_cur", player_get_dex_cur},
    {"player_get_health", player_get_health},
    {"player_get_underwater", player_get_underwater},
    {"player_get_stim", player_get_stim},
    {"player_set_stim", player_set_stim},
    {"player_get_dodges_left", player_get_dodges_left},
    {"player_set_dodges_left", player_set_dodges_left},
    {"player_get_int_max", player_get_int_max},
    {"player_get_str_cur", player_get_str_cur},
    {"player_get_str_max", player_get_str_max},
    {"player_get_blocks_left", player_get_blocks_left},
    {"player_set_blocks_left", player_set_blocks_left},
