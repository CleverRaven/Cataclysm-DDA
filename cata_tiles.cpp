...
void cata_tiles::scroll(int x, int y) {
    ...
    SDL_Rect srcrect; srcrect.x = x; srcrect.y = y; srcrect.w = WindowWidth - x; srcrect.h = WindowHeight - y;
    SDL_Rect dstrect; dstrect.x = 0; dstrect.y = 0; dstrect.w = WindowWidth - x; dstrect.h = WindowHeight - y;
