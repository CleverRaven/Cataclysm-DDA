...
// Set up the main UI windows.
 ...
 werase(w_messages);
 w_location = newwin(LOCATION_HEIGHT, LOCATION_WIDTH, TERMY - STATUS_HEIGHT - LOCATION_HEIGHT, TERMX - LOCATION_WIDTH);
 werase(w_location);
 w_status = newwin(STATUS_HEIGHT, STATUS_WIDTH, TERMY - STATUS_HEIGHT, TERMX - STATUS_WIDTH);
 werase(w_status);
}
