        ...
        if(redraw)
        {
            ...
            werase(head);
            {
                ...
                if ( ! showmsg ) {
                  ...
                  mvwprintz(head,1,2, c_white, "hjkl or arrow keys to move cursor, [m]ove item between screen,");
                 ...
                 /* mvwprintz(head,1,(w_width/2), c_white, "");
                  mvwprintz(head,2,(w_width/2), c_white, "");
                  mvwprintz(head,3,(w_width/2), c_white, "");*/
                } else {
