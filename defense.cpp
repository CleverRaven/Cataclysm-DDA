...
std::string defense_style_name(defense_style style)
{
    ...
    case DEFENSE_HARD:
        return "Hard";
    case DEFENSE_SHAUN:
        return "Shaun of the Dead";
    case DEFENSE_DAWN:
        return "Dawn of the Dead";
    case DEFENSE_SPIDERS:
        return "Eight-Legged Freaks";
    case DEFENSE_TRIFFIDS:
        return "Day of the Triffids";
    case DEFENSE_SKYNET:
        return "Skynet";
    case DEFENSE_LOVECRAFT:
        return "The Call of Cthulhu";
    default:
        return "Bug!  Report this!";
    }
}
...
std::string caravan_category_name(caravan_category cat)
{
    ...
    case CARAVAN_COMPONENTS:
        return "Crafting & Construction Components";
    case CARAVAN_FOOD:
        return "Food & Drugs";
    case CARAVAN_CLOTHES:
        return "Clothing & Armor";
    case CARAVAN_TOOLS:
        return "Tools, Traps & Grenades";
    }
    return "BUG";
}
...
std::string defense_game::special_wave_message(std::string name)
{
    ...
    case 1:
        ...
        break;
    case 2:
        ret << "Attack of the " << name << "s!";
        break;
    case 3:
        ret << name << " Attack!";
        break;
    case 4:
        ret << name << "s from Hell!";
        break;
    case 5:
        ret << "Beware! " << name << "!";
        break;
    case 6:
        ret << "The Day of the " << name << "!";
        break;
    case 7:
        ret << name << " Party!";
        break;
    case 8:
        ret << "Revenge of the " << name << "s!";
        break;
    case 9:
        ret << "Rise of the " << name << "s!";
        break;
    }
