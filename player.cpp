...
player& player::operator= (const player & rhs)
{
 ...
 focus_pool_frac = rhs.focus_pool_frac;
...
{
    int focus_gain_rate = calc_focus_equilibrium() - (focus_pool/5);
    ...
    int gain = focus_gain_rate;

    focus_pool_frac += (gain * base_change);

    focus_pool+= (focus_pool_frac / 100);
    focus_pool_frac -= ((focus_pool_frac / 100) * 100);
...
int player::calc_focus_equilibrium()
{
    ...
    int focus_gain_rate = 20; //100; //rebalance
    it_book* reading;
...
void player::disp_morale(game* g)
{
 ...
 int gain = calc_focus_equilibrium() - (focus_pool/5);
 //debug
 //mvwprintz(w, 21, 1, c_green, "focus_pool_frac:%d",focus_pool_frac);
