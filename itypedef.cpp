...
// Inaccuracy is in quarter-degrees, and measures the maximum this ammo will
//   contribute to the angle of difference.
// Recoil is cumulative between shots.  4 recoil = 1 inaccuracy.
...
inaccuracy,recoil,count,des,effects) \
itypes[id]=new it_ammo(id,rarity,price,name,des,'=',\
color,mat,SOLID,volume,wgt,1,0,0,effects,ammo_type,dmg,AP,inaccuracy,recoil,range,count);
...
to_hit,dmg,range,inaccuracy,recoil,durability,burst,clip,reload_time,des) \
itypes[id]=new it_gun(id,rarity,price,name,des,'(',\
color,mat1,mat2,volume,wgt,melee_dam,0,to_hit,skill,ammo,dmg,range,inaccuracy,\
