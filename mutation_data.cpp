...
// Mutation-only traits start here
 ...
 MUTATION(PF_SKIN_ROUGH);
  CHANGES_TO (PF_SCALES, PF_FEATHERS, PF_FUR, PF_CHITIN, PF_PLANTSKIN);
...
std::vector<pl_flag> mutations_from_category(mutation_category cat)
{
 ...
 case MUTCAT_LIZARD:
  setvector(ret,
PF_THICKSKIN, PF_INFRARED, PF_FANGS, PF_MEMBRANE, PF_THICK_SCALES, PF_TALONS,
...
PF_CARNIVORE, PF_SNARL, PF_SHOUT3, NULL);
  break;
...
PF_ANTENNAE, PF_WINGS_INSECT, PF_TAIL_STING, PF_DEFORMED, PF_TROGLO,
PF_COLDBLOOD3, NULL);
  break;
