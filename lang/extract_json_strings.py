...
# list could be generated by bash command: (in data/mods directory)
# for i in $(ls -l1); do echo -n '    "'; echo -n $i; echo '",'; done
# and remove things like replacements.json manually
official_mods = {
    "Animatronics",
    "Arcana",
    "Boats",
