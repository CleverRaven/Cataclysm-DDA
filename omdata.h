...
extern oter_iid ot_null,
     ...
     ot_s_pharm_south,
     ot_s_pharm_west,
     ot_office_doctor_north,
     ot_office_doctor_east,
     ot_office_doctor_south,
     ot_office_doctor_west,
     ot_office_cubical_north,
     ot_office_cubical_east,
     ot_office_cubical_south,
     ot_office_cubical_west,
     ot_apartments_con_tower_1_entrance,
     ot_apartments_con_tower_1,
     ot_apartments_mod_tower_1_entrance,
     ot_apartments_mod_tower_1,
     ot_office_tower_1_entrance,
     ot_office_tower_1,
     ot_office_tower_b_entrance,
     ot_office_tower_b,
     ot_church_north,
     ot_church_east,
     ot_church_south,
     ...
     ot_s_electronics_east,
     ot_s_electronics_south,
     ...
     ot_s_restaurant_east,
     ot_s_restaurant_south,
     ot_s_restaurant_west,
     ot_s_restaurant_fast_north,
     ot_s_restaurant_fast_east,
     ot_s_restaurant_fast_south,
     ot_s_restaurant_fast_west,
     ot_s_restaurant_coffee_north,
     ot_s_restaurant_coffee_east,
     ot_s_restaurant_coffee_south,
     ...
     ot_mil_surplus_east,
     ot_mil_surplus_south,
     ot_mil_surplus_west,
     ot_furniture_north,
     ot_furniture_east,
     ot_furniture_south,
     ot_furniture_west,
     ot_abstorefront_north,
     ot_abstorefront_east,
     ot_abstorefront_south,
     ot_abstorefront_west,
     ot_megastore_entrance,
     ot_megastore,
     ot_hospital_entrance,
     ot_hospital,
     ot_public_works_entrance,
     ot_public_works,
     ot_school_1,
     ot_school_2,
     ot_school_3,
     ...
     ot_fema_entrance,
     ot_fema,
     ot_station_radio_north,
     ot_station_radio_east,
     ot_station_radio_south,
     ot_station_radio_west,
     ot_shelter,
     ot_shelter_under,
     ot_lmoe,
     ot_lmoe_under,
     ...
     ot_temple_finale,
     ot_sewage_treatment,
     ot_sewage_treatment_hub,
     ot_sewage_treatment_under,
     ot_mine_entrance,
     ot_mine_shaft,
     ot_mine,
     ot_mine_down,
