...
{
 monster newfung(GetMon("mon_fungaloid"));
...
void mdeath::worm(game *g, monster *z)
{
 ...
 int rn;
 monster worm(GetMon("mon_halfworm"));
...
void mdeath::blobsplit(game *g, monster *z)
{
 ...
 monster blob(GetMon((speed < 50 ? "mon_blob_small" : "mon_blob")));
 blob.speed = speed;
...
{
 monster thing(GetMon("mon_thing"));
...
void mdeath::ratking(game *g, monster *z)
{
    ...
    int rn;
    monster rat(GetMon("mon_sewer_rat"));
