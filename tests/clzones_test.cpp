    ...
    SECTION( "with perishable zones" ) {
        ...
        GIVEN( "a non-perishable food" ) {
            ...
            WHEN( "sorting within an unsealed container" ) {
                ...
                REQUIRE( container.get_sealed_summary() == item_contents::sealed_summary::unsealed );
            ...
            WHEN( "sorting within a sealed container" ) {
                ...
                REQUIRE( container.get_all_contained_pockets().value().front()->spoil_multiplier() ==
                         0.0f );
                REQUIRE( container.get_sealed_summary() == item_contents::sealed_summary::all_sealed );
