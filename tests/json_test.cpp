...
TEST_CASE( "Json float number save and load", "[json]" )
{
    ...
    json_float_save_load( {
        -2147483648., -2147483647., -65536, -65535, -32000, -100, -1, -0.5, 0, 0.5, 4, 127, 128,
            900, 3000, 4194410, 4294967295., 4294967296., 9999999999999998., 10000000000000000.,
        } );
#define make( val ) {#val, val}
    json_float_load( {
        ...
        make( 9999999999999997 ), make( 9999999999999998 ), make( 9999999999999999 ),
        make( 18014398509481979 ), make( 18014398509481980 ), make( 18014398509481981 ),
        make( 18014398509481982 ), make( 18014398509481983 ), make( 18014398509481984 ),
        make( 18014398509481985 ), make( 18014398509481986 ), make( 18014398509481987 ),
        make( 99999999999999997 ), make( 99999999999999998 ), make( 99999999999999999 ),
        make( 100000000000000000 ), make( 100000000000000001 ), make( 100000000000000002 ),
        make( 1000000000000000000 ), {"10000000000000000000", 1e19}
    } );
}
