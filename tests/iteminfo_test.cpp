...
TEST_CASE( "repairable_and_with_what_tools", "[iteminfo][repair]" )
{
    ...
    CHECK( item_info_str( hazmat, repaired ) ==
           "--\n"
           "<color_c_white>Repair</color> using integrated welder, gunsmith repair kit, firearm repair kit, soldering iron, portable soldering iron, integrated soldering iron, or TEST soldering iron.\n"
