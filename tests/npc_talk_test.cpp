...
TEST_CASE( "npc_talk_adjust_vars", "[npc_talk]" )
{
    ...
    CHECK( d.responses[0].text == "This is a basic test response." );
    CHECK( d.responses[1].text == "This is a math test response that increments by 1." );
    CHECK( d.responses[2].text == "This is a math test response that decrements by 1." );
    CHECK( d.responses[3].text == "This is a math test response that increments by 1." );
    CHECK( d.responses[4].text == "This is a math test response that decrements by 1." );
    CHECK( d.responses[5].text == "This is a math test response for == 0." );
    CHECK( d.responses[6].text == "This is a math test response for <= 0." );
    CHECK( d.responses[7].text == "This is a math test response for >= 0." );
    CHECK( d.responses[8].text == "This is a math test response for == 0." );
    CHECK( d.responses[9].text == "This is a math test response for <= 0." );
    CHECK( d.responses[10].text == "This is a math test response for >= 0." );
