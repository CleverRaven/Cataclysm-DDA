...
TEST_CASE( "battery tool mod test", "[battery][mod]" )
{
    ...
    SECTION( "battery mod properties" ) {
        ...
        CHECK_FALSE( med_mod.is_reloadable_with( item( itype_battery ) ) );
    ...
    GIVEN( "tool compatible with light batteries" ) {
        ...
        REQUIRE( flashlight.is_reloadable_with( item( itype_light_battery_cell ) ) );
        ...
        WHEN( "medium battery mod is installed" ) {
            ...
            THEN( "medium batteries can be installed" ) {
                ...
                CHECK( flashlight.is_reloadable_with( item( itype_medium_battery_cell ) ) );
                CHECK( flashlight.is_reloadable_with(item( itype_medium_battery_cell ) ) );
                CHECK( flashlight.is_reloadable_with(item( itype_medium_plus_battery_cell ) ) );
                CHECK( flashlight.is_reloadable_with(item( itype_medium_atomic_battery_cell ) ) );
                CHECK( flashlight.is_reloadable_with(item( itype_medium_disposable_cell ) ) );
            ...
            THEN( "light batteries no longer fit" ) {
                CHECK_FALSE( flashlight.is_reloadable_with( item( itype_light_battery_cell ) ) );
...
TEST_CASE( "battery and tool properties", "[battery][tool][properties]" )
{
    ...
    SECTION( "flashlight" ) {
        ...
        SECTION( "is reloadable with a magazine" ) {
            CHECK( flashlight.is_reloadable() );
            CHECK( flashlight.is_reloadable_with( item( itype_light_battery_cell ) ) );
            CHECK( flashlight.is_reloadable_with(item( itype_light_disposable_cell ) ) );
        }
