...
{
    test_vehicle( "beetle", 745101, 292300, 228600, 75730, 56370 );
    test_vehicle( "car", 1050050, 520800, 302500, 47060, 26470 );
    test_vehicle( "car_sports", 1083646, 456200, 312000, 38140, 22390 );
    test_vehicle( "electric_car", 1055519, 215469, 120379, 17211, 8898 );
    test_vehicle( "suv", 1249718, 987100, 483000, 69560, 33260 );
    ...
    test_vehicle( "ambulance", 1751089, 432000, 345500, 64010, 47220 );
    test_vehicle( "fire_engine", 2540401, 1169000, 960700, 244700, 215300 );
    test_vehicle( "fire_truck", 6226393, 308500, 199100, 19950, 4747 );
    ...
    test_vehicle( "road_roller", 8705726, 369800, 412000, 22990, 6996 );
