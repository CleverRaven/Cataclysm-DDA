...
void check_strip( std::vector<char> &buffer, const std::string &input_str,
...
TEST_CASE( "Test positional argument stripping" )
{
    ...
    check_strip( buffer, "A text that lacks positional arguments.",
                 "A text that lacks positional arguments." );
