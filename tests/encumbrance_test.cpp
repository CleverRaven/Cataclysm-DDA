...
{
    test_encumbrance( { "postman_shirt" }, "CHEST", postman_shirt_e );
    test_encumbrance( { "longshirt" }, "CHEST", longshirt_e );
    test_encumbrance( { "jacket_jean" }, "CHEST", jacket_jean_e );
}

TEST_CASE( "separate_layer_encumbrance", "[encumbrance]" )
{
    test_encumbrance( { "longshirt", "jacket_jean" }, "CHEST", longshirt_e + jacket_jean_e );
}

TEST_CASE( "out_of_order_encumbrance", "[encumbrance]" )
{
    test_encumbrance( { "jacket_jean", "longshirt" }, "CHEST", longshirt_e * 2 + jacket_jean_e );
}
...
TEST_CASE( "same_layer_encumbrance", "[encumbrance]" )
{
    ...
    // counted twice
    test_encumbrance( { "longshirt", "longshirt" }, "CHEST", longshirt_e * 2 + longshirt_e );
    // ... with a minimum of 2
    test_encumbrance( { "postman_shirt", "postman_shirt" }, "CHEST", postman_shirt_e * 2 + 2 );
    // ... and a maximum of 10
    test_encumbrance( { "jacket_jean", "jacket_jean" }, "CHEST", jacket_jean_e * 2 + 10 );
}
...
TEST_CASE( "tiny_clothing", "[encumbrance]" )
{
    ...
    test_encumbrance_items( { i }, "CHEST", longshirt_e * 3 );
}
...
TEST_CASE( "tiny_character", "[encumbrance]" )
{
    ...
    SECTION( "regular shirt" ) {
        test_encumbrance_items( { i }, "CHEST", longshirt_e * 2, add_trait( "SMALL2" ) );
    }
    SECTION( "undersize shrt" ) {
        i.set_flag( "UNDERSIZE" );
        test_encumbrance_items( { i }, "CHEST", longshirt_e, add_trait( "SMALL2" ) );
    }
}
