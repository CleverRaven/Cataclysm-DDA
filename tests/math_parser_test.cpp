...
TEST_CASE( "math_parser_dialogue_integration", "[math_parser]" )
{
    ...
    testexp.eval( d );
    CHECK( std::stoi( d.get_value( "npctalk_var_testvar" ) ) == 160 );
    CHECK( testexp.parse( "_testvar -= 1" ) );
    testexp.eval( d );
    CHECK( std::stoi( d.get_value( "npctalk_var_testvar" ) ) == 159 );
    CHECK( testexp.parse( "_testvar *= 2" ) );
    testexp.eval( d );
    CHECK( std::stoi( d.get_value( "npctalk_var_testvar" ) ) == 318 );
    CHECK( testexp.parse( "_testvar /= 2" ) );
    testexp.eval( d );
    CHECK( std::stoi( d.get_value( "npctalk_var_testvar" ) ) == 159 );
    CHECK( testexp.parse( "_testvar %= 2" ) );
    testexp.eval( d );
    CHECK( std::stoi( d.get_value( "npctalk_var_testvar" ) ) == 1 );
    ...
    testexp.eval( d );
    CHECK( std::stod( d.get_value( "npctalk_var_blorg" ) ) == 87139.7 );

    CHECK( testexp.parse( "_testvar ++" ) );
    testexp.eval( d );
    CHECK( std::stoi( d.get_value( "npctalk_var_testvar" ) ) == 2 );
    CHECK( testexp.parse( "_testvar --" ) );
    testexp.eval( d );
    CHECK( std::stoi( d.get_value( "npctalk_var_testvar" ) ) == 1 );
