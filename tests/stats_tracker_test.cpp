...
TEST_CASE( "stats_tracker_total_events", "[stats]" )
{
    ...
    b.send<event_type::character_takes_damage>( u_id, 5, body_part_bp_null );
...
TEST_CASE( "stats_tracker_with_event_statistics", "[stats]" )
{
    ...
    SECTION( "damage" ) {
        const cata::event avatar_2_damage =
            cata::event::make<event_type::character_takes_damage>( u_id, 2, body_part_bp_null );
