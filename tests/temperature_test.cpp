...
TEST_CASE( "Item spawns with right thermal attributes" )
{
    ...
    CHECK( D.temperature == Approx( 323.15 * 100000 ).margin( 0 ) );
}
...
TEST_CASE( "Rate of temperature change" )
{
    ...
    SECTION( "Water bottle test (ralisticity)" ) {
        ...
        // 55 C
        CHECK( water1.temperature == Approx( 328.15 * 100000 ).margin( 0 ) );
        ...
        // about 29.6 C
        CHECK( water1.temperature == Approx( 30271802 ).margin( 0 ) );
        CHECK( water1.temperature == Approx( water2.temperature ).margin( 0 ) );
    }
    ...
    SECTION( "Hot liquid to frozen" ) {
        ...
        // 50 C
        CHECK( meat1.temperature == Approx( 323.15 * 100000 ).margin( 0 ) );
        ...
        // about 34.6 C
        CHECK( meat1.temperature == Approx( 30778338 ).margin( 0 ) );
        CHECK( !meat1.has_own_flag( flag_HOT ) );
        ...
        CHECK( meat1.has_own_flag( flag_FROZEN ) );
        CHECK( meat2.has_own_flag( flag_FROZEN ) );
        CHECK( meat1.specific_energy == Approx( meat2.specific_energy ).margin( 0 ) );
        ...
        // frozen
        // same temp as meat 2
        CHECK( meat1.temperature == Approx( 26798050 ).margin( 0 ) );
        CHECK( meat1.has_own_flag( flag_FROZEN ) );
    ...
    SECTION( "Cold solid to liquid" ) {
        ...
        // -20 C
        CHECK( meat1.temperature == Approx( 253.15 * 100000 ).margin( 0 ) );
        CHECK( meat1.has_own_flag( flag_FROZEN ) );
        ...
        meat1.process_temperature_rot( 1, tripoint_zero, nullptr );
        // about -9.3 C
        CHECK( meat1.temperature == Approx( 26389390 ).margin( 0 ) );
