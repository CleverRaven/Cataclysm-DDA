...
TEST_CASE( "Item spawns with right thermal attributes" )
{
    ...
    D.process_temperature_rot( 1, false, false, tripoint_zero, nullptr );
...
TEST_CASE( "Rate of temperature change" )
{
    ...
    SECTION( "Water bottle test (ralisticity)" ) {
        ...
        water1.process_temperature_rot( 1, false, false, tripoint_zero, nullptr );
        water2.process_temperature_rot( 1, false, false, tripoint_zero, nullptr );
    ...
    SECTION( "Hot liquid to frozen" ) {
        ...
        meat1.process_temperature_rot( 1, false, false, tripoint_zero, nullptr );
        meat2.process_temperature_rot( 1, false, false, tripoint_zero, nullptr );
