...
static std::map<std::string, swim_result> expected_results = {
    ...
    {"move: crouch, stats: average, skills: none, gear: fins, traits: webbed hands", swim_result{366, 64}},
    {"move: crouch, stats: average, skills: none, gear: fins, traits: webbed hands and feet", swim_result{366, 64}},
    ...
    {"move: crouch, stats: average, skills: none, gear: none, traits: webbed hands", swim_result{360, 65}},
    {"move: crouch, stats: average, skills: none, gear: none, traits: webbed hands and feet", swim_result{310, 78}},
    ...
    {"move: crouch, stats: average, skills: professional, gear: fins, traits: webbed hands", swim_result{52, 9000}},
    {"move: crouch, stats: average, skills: professional, gear: fins, traits: webbed hands and feet", swim_result{52, 9000}},
    ...
    {"move: crouch, stats: average, skills: professional, gear: flotation vest, traits: webbed hands and feet", swim_result{427, 90}},
    ...
    {"move: crouch, stats: average, skills: professional, gear: none, traits: webbed hands", swim_result{110, 9000}},
    {"move: crouch, stats: average, skills: professional, gear: none, traits: webbed hands and feet", swim_result{60, 9000}},
    ...
    {"move: crouch, stats: maximum, skills: none, gear: none, traits: webbed hands", swim_result{210, 126}},
    {"move: crouch, stats: maximum, skills: none, gear: none, traits: webbed hands and feet", swim_result{130, 251}},
    ...
    {"move: crouch, stats: maximum, skills: professional, gear: flotation vest, traits: webbed hands", swim_result{327, 126}},
    ...
    {"move: crouch, stats: minimum, skills: none, gear: fins, traits: webbed hands", swim_result{480, 47}},
    {"move: crouch, stats: minimum, skills: none, gear: fins, traits: webbed hands and feet", swim_result{480, 47}},
    ...
    {"move: crouch, stats: minimum, skills: none, gear: none, traits: webbed hands", swim_result{410, 56}},
    {"move: crouch, stats: minimum, skills: none, gear: none, traits: webbed hands and feet", swim_result{370, 63}},
    ...
    {"move: crouch, stats: minimum, skills: professional, gear: fins, traits: webbed hands", swim_result{166, 363}},
    {"move: crouch, stats: minimum, skills: professional, gear: fins, traits: webbed hands and feet", swim_result{166, 363}},
    ...
    {"move: crouch, stats: minimum, skills: professional, gear: none, traits: webbed hands", swim_result{160, 391}},
    {"move: crouch, stats: minimum, skills: professional, gear: none, traits: webbed hands and feet", swim_result{120, 872}},
    ...
    {"move: prone, stats: average, skills: none, gear: fins, traits: webbed hands", swim_result{366, 214}},
    {"move: prone, stats: average, skills: none, gear: fins, traits: webbed hands and feet", swim_result{366, 214}},
    ...
    {"move: prone, stats: average, skills: none, gear: none, traits: webbed hands", swim_result{360, 219}},
    {"move: prone, stats: average, skills: none, gear: none, traits: webbed hands and feet", swim_result{310, 281}},
    ...
    {"move: prone, stats: average, skills: professional, gear: fins, traits: webbed hands", swim_result{52, 9000}},
    {"move: prone, stats: average, skills: professional, gear: fins, traits: webbed hands and feet", swim_result{52, 9000}},
    ...
    {"move: prone, stats: average, skills: professional, gear: flotation vest, traits: webbed hands and feet", swim_result{427, 353}},
    ...
    {"move: prone, stats: average, skills: professional, gear: none, traits: webbed hands", swim_result{110, 9000}},
    {"move: prone, stats: average, skills: professional, gear: none, traits: webbed hands and feet", swim_result{60, 9000}},
    ...
    {"move: prone, stats: maximum, skills: none, gear: none, traits: webbed hands", swim_result{210, 668}},
    {"move: prone, stats: maximum, skills: none, gear: none, traits: webbed hands and feet", swim_result{130, 9000}},
    ...
    {"move: prone, stats: maximum, skills: professional, gear: flotation vest, traits: webbed hands", swim_result{327, 683}},
    ...
    {"move: prone, stats: minimum, skills: none, gear: fins, traits: webbed hands", swim_result{480, 144}},
    {"move: prone, stats: minimum, skills: none, gear: fins, traits: webbed hands and feet", swim_result{480, 144}},
    ...
    {"move: prone, stats: minimum, skills: none, gear: none, traits: webbed hands", swim_result{410, 180}},
    {"move: prone, stats: minimum, skills: none, gear: none, traits: webbed hands and feet", swim_result{370, 210}},
    ...
    {"move: prone, stats: minimum, skills: professional, gear: fins, traits: webbed hands", swim_result{166, 9000}},
    {"move: prone, stats: minimum, skills: professional, gear: fins, traits: webbed hands and feet", swim_result{166, 9000}},
    ...
    {"move: prone, stats: minimum, skills: professional, gear: none, traits: webbed hands", swim_result{160, 9000}},
    {"move: prone, stats: minimum, skills: professional, gear: none, traits: webbed hands and feet", swim_result{120, 9000}},
    ...
    {"move: run, stats: average, skills: none, gear: fins, traits: webbed hands", swim_result{236, 3}},
    {"move: run, stats: average, skills: none, gear: fins, traits: webbed hands and feet", swim_result{236, 3}},
    ...
    {"move: run, stats: average, skills: none, gear: none, traits: webbed hands", swim_result{230, 3}},
    {"move: run, stats: average, skills: none, gear: none, traits: webbed hands and feet", swim_result{180, 4}},
    ...
    {"move: run, stats: average, skills: professional, gear: flotation vest, traits: webbed hands and feet", swim_result{297, 4}},
    ...
    {"move: run, stats: maximum, skills: none, gear: none, traits: webbed hands", swim_result{80, 9}},
    ...
    {"move: run, stats: maximum, skills: professional, gear: flotation vest, traits: webbed hands", swim_result{197, 6}},
    ...
    {"move: run, stats: minimum, skills: none, gear: fins, traits: webbed hands", swim_result{350, 2}},
    {"move: run, stats: minimum, skills: none, gear: fins, traits: webbed hands and feet", swim_result{350, 2}},
    ...
    {"move: run, stats: minimum, skills: none, gear: none, traits: webbed hands", swim_result{280, 3}},
    {"move: run, stats: minimum, skills: none, gear: none, traits: webbed hands and feet", swim_result{240, 3}},
    ...
    {"move: run, stats: minimum, skills: professional, gear: fins, traits: webbed hands", swim_result{36, 29}},
    {"move: run, stats: minimum, skills: professional, gear: fins, traits: webbed hands and feet", swim_result{36, 29}},
    ...
    {"move: run, stats: minimum, skills: professional, gear: none, traits: webbed hands", swim_result{30, 34}},
    ...
    {"move: walk, stats: average, skills: none, gear: fins, traits: webbed hands", swim_result{316, 35}},
    {"move: walk, stats: average, skills: none, gear: fins, traits: webbed hands and feet", swim_result{316, 35}},
    ...
    {"move: walk, stats: average, skills: none, gear: none, traits: webbed hands", swim_result{310, 36}},
    {"move: walk, stats: average, skills: none, gear: none, traits: webbed hands and feet", swim_result{260, 43}},
    ...
    {"move: walk, stats: average, skills: professional, gear: flotation vest, traits: webbed hands and feet", swim_result{377, 46}},
    ...
    {"move: walk, stats: average, skills: professional, gear: none, traits: webbed hands", swim_result{60, 423}},
    ...
    {"move: walk, stats: maximum, skills: none, gear: none, traits: webbed hands", swim_result{160, 74}},
    {"move: walk, stats: maximum, skills: none, gear: none, traits: webbed hands and feet", swim_result{80, 164}},
    ...
    {"move: walk, stats: maximum, skills: professional, gear: flotation vest, traits: webbed hands", swim_result{277, 65}},
    ...
    {"move: walk, stats: minimum, skills: none, gear: fins, traits: webbed hands", swim_result{430, 25}},
    {"move: walk, stats: minimum, skills: none, gear: fins, traits: webbed hands and feet", swim_result{430, 25}},
    ...
    {"move: walk, stats: minimum, skills: none, gear: none, traits: webbed hands", swim_result{360, 30}},
    {"move: walk, stats: minimum, skills: none, gear: none, traits: webbed hands and feet", swim_result{320, 34}},
    ...
    {"move: walk, stats: minimum, skills: professional, gear: fins, traits: webbed hands", swim_result{116, 199}},
    {"move: walk, stats: minimum, skills: professional, gear: fins, traits: webbed hands and feet", swim_result{116, 199}},
    ...
    {"move: walk, stats: minimum, skills: professional, gear: none, traits: webbed hands", swim_result{110, 215}},
    {"move: walk, stats: minimum, skills: professional, gear: none, traits: webbed hands and feet", swim_result{70, 364}},
};
