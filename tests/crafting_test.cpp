...
TEST_CASE( "charge_handling", "[crafting]" )
{
    SECTION( "carver" ) {
        ...
        tools.push_back( tool_with_battery( "hotplate", 40 ) );
    ...
    SECTION( "carver_split_charges" ) {
        std::vector<item> tools;
        tools.insert( tools.end(), 2, tool_with_battery( "hotplate", 15 ) );
    ...
    SECTION( "UPS_modded_carver" ) {
        ...
        hotplate.contents.push_back( item( "battery_ups" ) );
        tools.push_back( hotplate );
        item soldering_iron( "soldering_iron" );
        tools.insert( tools.end(), 10, item( "solder_wire" ) );
        soldering_iron.contents.push_back( item( "battery_ups" ) );
