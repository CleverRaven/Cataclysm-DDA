...
TEST_CASE( "squares_closer_to_test", "[line]" )
{
    ...
    std::vector<tripoint_bub_ms> actual = squares_closer_to( tripoint_bub_ms::zero, tripoint_bub_ms( 10,
                                          0, 0 ) );
    std::vector<tripoint_bub_ms> expected = {tripoint_bub_ms::east, tripoint_bub_ms::south_east, tripoint_bub_ms::north_east};
    CHECK( actual == expected );

    actual = squares_closer_to( tripoint_bub_ms::zero, tripoint_bub_ms( -10, -10, 0 ) );
    expected = {tripoint_bub_ms::north_west, tripoint_bub_ms::west, tripoint_bub_ms::north};
    CHECK( actual == expected );

    actual = squares_closer_to( tripoint_bub_ms::zero, tripoint_bub_ms( 10, 10, 0 ) );
    expected = {tripoint_bub_ms::south_east, tripoint_bub_ms::east, tripoint_bub_ms::south};
    CHECK( actual == expected );

    actual = squares_closer_to( tripoint_bub_ms::zero, tripoint_bub_ms( 10, 9, 0 ) );
    expected = {tripoint_bub_ms::east, tripoint_bub_ms::south_east, tripoint_bub_ms::north_east, tripoint_bub_ms::south};
    CHECK( actual == expected );
    ...
    actual = squares_closer_to( tripoint_bub_ms::zero, tripoint_bub_ms( -10, -9, 0 ) );
    expected = {tripoint_bub_ms::west, tripoint_bub_ms::south_west, tripoint_bub_ms::north_west, tripoint_bub_ms::north};
    CHECK( actual == expected );
