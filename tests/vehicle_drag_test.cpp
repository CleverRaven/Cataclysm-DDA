...
TEST_CASE( "vehicle_drag", "[vehicle] [engine]" )
{
    ...
    test_vehicle_drag( "electric_car", 0.304763, 2.093451, 987.961458, 16337, 16954 );
    ...
    test_vehicle_drag( "suv_electric", 0.304763, 2.244087, 907.758036, 16288, 16904 );
    ...
    test_vehicle_drag( "pickup_technical", 0.838097, 2.631835, 1064.606250, 10223, 12217 );
    ...
    test_vehicle_drag( "humvee", 0.616298, 7.938499, 5352.017857, 12830, 15073 );
    test_vehicle_drag( "military_cargo_truck", 0.840758, 10.682064, 4929.155556, 11411, 13443 );
    ...
    test_vehicle_drag( "armored_car", 0.844627, 7.682788, 5179.621429, 11764, 13781 );
