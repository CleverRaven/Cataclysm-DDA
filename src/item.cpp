...
int item::gun_dispersion( bool with_ammo ) const
{
    ...
    // Dispersion adjustment for shotguns bacause of their close range behavior
    // Needed to be adjusted in jsons later
...
int item::sight_dispersion() const
{
    ...
    int res = has_flag( "DISABLE_SIGHTS" ) ? 125 : type->gun->sight_dispersion;
