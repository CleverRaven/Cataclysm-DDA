...
double item::effective_dps( const Character &guy, Creature &mon ) const
{
    ...
    const bool crit, const Character & guy, Creature & mon ) {
        ...
        guy.roll_all_damage( crit, base_damage, true, *this, false, &mon, bp );
        ...
        if( has_technique( RAPID ) ) {
            ...
            guy.roll_all_damage( crit, rs_base_damage, true, *this, false, &mon, bp );
                        ...
                        bool /*debug*/ ) const
{
    ...
    if( ( player_character.get_skill_level( skill_melee ) > 2 &&
        ...
        player_character.roll_all_damage( false, non_crit, true, *this, false, nullptr, bp );
        damage_instance crit;
        player_character.roll_all_damage( true, crit, true, *this, false, nullptr, bp );
