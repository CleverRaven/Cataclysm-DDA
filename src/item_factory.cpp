...
void Item_factory::load_basic_info( const JsonObject &jo, itype &def, const std::string &src )
{
    ...
    optional( jo, false, "fall_damage_reduction_multiplicative", def.fall_damage_reduction_multiplicative, 1.0f );
    optional( jo, false, "fall_damage_reduction_on_breaking", def.fall_damage_reduction_on_breaking, 0 );
