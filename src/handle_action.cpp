...
#include "sounds.h"
#include "veh_type.h"#include "game.h" // IWYU pragma: associated
...
static void open_movement_mode_menu()
{
    ...
    as_m.entries.emplace_back( 2, true, 'c', _( "Sprint" ) );
    as_m.entries.emplace_back( 3, true, 'c', _( "Crouch" ) );
    as_m.query();
