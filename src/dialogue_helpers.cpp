...
template<>
time_duration _evaluate_func<time_duration>( const_dialogue const &d, eoc_math const &arg )
{
...
{
    if( deserialize_variant<decltype( *this ), funcT..., var_info, valueT>( *this, jsin ) ) {
