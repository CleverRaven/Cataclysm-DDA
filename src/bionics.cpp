...
std::vector<item *> Character::get_cable_ups()
{
    ...
    const std::vector<item *> cables = items_with( []( const item & it ) {
        return it.link.state == item::cable_link::UPS_bionic_link;
    } );
    int n = cables.size();
    if( n == 0 ) {
        return stored_fuels;
...
std::vector<item *> Character::get_cable_solar()
{
    ...
    const std::vector<item *> cables = items_with( []( const item & it ) {
        return it.link.state == item::cable_link::solarpack_bionic_link;
    } );
    int n = cables.size();
    if( n == 0 ) {
...
std::vector<vehicle *> Character::get_cable_vehicle()
{
    ...
    const std::vector<item *> cables = items_with( []( const item & it ) {
        return it.link.state == item::cable_link::vehicle_bionic_link;
    } );
    int n = cables.size();
    if( n == 0 ) {
