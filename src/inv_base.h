...
class inv_base
{
    ...
    public:
        ...
        inv_base();
        inv_base(inv_base &&) = default;
        inv_base(const inv_base &) = default;
        inv_base &operator=(inv_base &&) = default;
        inv_base &operator=(const inv_base &) = default;

        inv_base &operator+= (const inv_base &rhs);
        inv_base &operator+= (const item &rhs);
        inv_base &operator+= (const std::list<item> &rhs);
        inv_base &operator+= (const std::vector<item> &rhs);
        inv_base  operator+  (const inv_base &rhs);
        inv_base  operator+  (const item &rhs);
        inv_base  operator+  (const std::list<item> &rhs);
