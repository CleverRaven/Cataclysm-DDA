...
class talker_character_const: public talker_cloner<talker_character_const>
{
    public:
        ...
        int get_total_in_category(const mutation_category_id& categ, mut_count_type count_type) const override;
        int get_total_in_category_char_has(const mutation_category_id& categ, mut_count_type count_type) const override;
