...
class item_contents
{
    public:
        ...
        int can_contain( const item &it, int copies, bool ignore_pkt_settings = true,
                         units::volume remaining_parent_volume = 10000000_ml ) const;
        ret_val<void> can_contain_rigid( const item &it, bool ignore_pkt_settings = true ) const;
        int can_contain_rigid( const item &it, int copies, bool ignore_pkt_settings = true ) const;
