...
void body_part_type::load( const JsonObject &jo, const std::string & )
{
    ...
    optional( jo, was_loaded, "encumbrance_effects", encumbrance_effects );
...
void encumbrance_effects_t::load( const JsonObject &jsobj )
{
    ...
    optional( jsobj, was_loaded, "hit_roll_perc", hit_roll_mod, 0.0f );
    optional( jsobj, was_loaded, "melee_thrown_attack_cost", melee_thrown_attack_cost, 0.0f );
    optional( jsobj, was_loaded, "trap_detection_mod", trap_detection_mod, 0.0f );
    ...
    optional( jsobj, was_loaded, "item_handling_cost", item_handling_cost, 0.0f );
