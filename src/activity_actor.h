...
class install_software_activity_actor : public activity_actor
{
	private:
		...
		int install_time_left = 0;


	public:
		install_software_activity_actor( item_location comp, item_location soft, int install_time ) :
	      computer( comp ), software_source( soft ), install_time_left( install_time ) {} 
