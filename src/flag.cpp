...
const flag_id _flag EXO_ARM_PLATE( "EXO_ARM_PLATE" );
const flag_id _flag EXO_BOOT_PLATE( "EXO_BOOT_PLATE" );
const flag_id _flag EXO_GLOVE_PLATE( "EXO_GLOVE_PLATE" );
const flag_id _flag EXO_HELMET_GADGET( "EXO_HELMET_GADGET" );
const flag_id _flag EXO_HELMET_PLATE( "EXO_HELMET_PLATE" );
const flag_id _flag EXO_LARGE_GADGET( "EXO_LARGE_GADGET" );
const flag_id _flag EXO_LARGE( "EXO_LARGE" );
const flag_id _flag EXO_LEG_PLATE( "EXO_LEG_PLATE" );
const flag_id _flag EXO_MEDIUM_GADGET( "EXO_MEDIUM_GADGET" );
const flag_id _flag EXO_PSU_PLATE( "EXO_PSU_PLATE" );
const flag_id _flag EXO_PSU( "EXO_PSU" );
const flag_id _flag EXO_SMALL_GADGET( "EXO_SMALL_GADGET" );
const flag_id _flag EXO_SMALL( "EXO_SMALL" );
const flag_id _flag EXO_TORSO_PLATE( "EXO_TORSO_PLATE" );
