...
character_modifier_melee_thrown_move_balance_arm_mod( "melee_thrown_move_balance_arm_mod" );
static const character_modifier_id
character_modifier_melee_thrown_move_lift_arm_mod( "melee_thrown_move_lift_arm_mod" );
static const character_modifier_id
...
int throw_cost( const Character &c, const item &to_throw )
{
    ...
    move_cost *= c.get_modifier( character_modifier_melee_thrown_move_lift_arm_mod );
    move_cost *= c.get_modifier( character_modifier_melee_thrown_move_balance_arm_mod );
