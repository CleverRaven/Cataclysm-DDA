...
{
    return string_format( ngettext( "Walking or running costs %+d movement point. ",
...
{
    return string_format( ngettext( "Melee attacks cost %+d movement point. ",
...
{
    return string_format( ngettext( "Throwing costs %+d movement point. ",
