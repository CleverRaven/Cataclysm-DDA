...
static const mon_flag_id mon_flag_CONVERSATION( "CONVERSATION" );
static const mon_flag_id mon_flag_FISHABLE( "FISHABLE" );
static const mon_flag_id mon_flag_PAY_BOT( "PAY_BOT" );
