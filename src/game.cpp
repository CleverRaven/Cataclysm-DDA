...
int game::get_temperature( const tripoint &location )
{
    ...
    if( !new_game ) {
        ...
        // Heat from hot air generated by fires/lava
        ...
        tile_strength = g->m.get_field_strength( location, fd_hot_air1 );
        ...
        tile_strength = g->m.get_field_strength( location, fd_hot_air2 );
        switch( tile_strength ) {
            case 3:
                temp_mod += 20;
                break;
        ...
        tile_strength = g->m.get_field_strength( location, fd_hot_air3 );
        switch( tile_strength ) {
            case 3:
                temp_mod += 70;
                break;
        ...
        tile_strength = g->m.get_field_strength( location, fd_hot_air4 );
        switch( tile_strength ) {
            case 3:
                temp_mod += 160;
                break;
