...
void game::on_move_effects()
{
    ...
    if ((moveCount % 2 == 0) && (u.has_active_mutation("SPRINT")) && (u.disease_duration("winded") <= 20 * u.get_str() + 6)) {
                ...
                u.add_disease("asthma", rng(400, 800));
                  ...
                  if (one_in(6)){
                    ...
                    if ((!u.has_trait("NOPAIN"))  && (u.disease_duration("winded") >= 15 * u.get_str())) {
                        ...
                        if ((one_in(5)) && (u.pain < 20)) {
                        u.mod_pain(rng(0,1));
                        }
                      }
                }
                if ((!u.has_trait("NOPAIN")) && (u.disease_duration("winded") >= 20 * u.get_str())) {
