...
repeat_type repeat_menu( const std::string &title, repeat_type last_selection )
{
    ...
    rmenu.addentry( REPEAT_FOREVER, true, '3', _("Repeat as long as you can") );
    rmenu.addentry( REPEAT_FULL, true, '4', _("Repeat until fully repaired, but don't reinforce") );
    rmenu.addentry( REPEAT_EVENT, true, '5', _("Repeat until success/failure/level up") );
