...
namespace music {
    std::vector<std::pair<music_id, bool>> music_id_list { 
        std::make_pair(mp3, false), std::make_pair(instrument, false), std::make_pair(sound, false), std::make_pair(title, true)
    };
