...
std::string format_pad(const std::string &str, unsigned int length, bool right_align = false);
std::string format_pad(const char *str, unsigned int length, bool right_align = false);
// int version of above, does maths to determine how much to pad instead of string length
std::string format_pad(int number, unsigned int length, bool right_align = false);
