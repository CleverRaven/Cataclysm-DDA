    ...
    for( item &i : items ) {
        ...
        if( creature_below ) {
            ...
            if( creature_hit_chance < 15 ) {
                add_msg_if_player_sees( _( "Falling %s hits %s in the head!" ), i.tname(),
