...
{
    const int min = supported ? str_min_supported : blocked ? str_min_blocked : str_min;
...
{
    if( supported ) {
        return str_max_supported - str_min_supported;
    }
    if( blocked ) {
        return str_max_blocked - str_min_blocked;
    }
