...
static const itype_id itype_HEW_printout_data_barricaded_church( "HEW_printout_data_barricaded_church" );
        ...
        if( mws_finished ) {
            ...
            if( vpi.has_flag( VPFLAG_ADVANCED_MWS ) ) {
                ...
                if( trig_dist( veh_position, closest_cabin_reverb ) <= 10 ) {
                    cur_veh.add_item( here, vp, item( itype_HEW_printout_data_cabin_reverb_dimension, calendar::turn_zero ) );
                }
