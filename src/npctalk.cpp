...
std::string dialogue::dynamic_line( const talk_topic topic ) const
{
    ...
    static const std::set<talk_topic> mission_topics = { {
...
int topic_category(talk_topic topic)
{
    ...
    static const std::set<talk_topic> topic_1 = { {
