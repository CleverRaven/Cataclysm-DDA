...
extern template struct value_or_var<diag_value, string_mutator<translation>>;
using diag_value_or_var = value_or_var<diag_value, string_mutator<translation>>;
        ...
        std::string_view, bool is_npc )
{
    ...
    optional( jo, false, member, dov_quantity );
                                      ...
                                      std::string_view src, bool is_npc )
{
    ...
    return [is_npc, id, hit_self, dov_max_level, trigger_once_in, level, trigger_message,
        ...
        fake.trigger_message = no_translation( trigger_message.evaluate( d ).translated() );
        fake.npc_trigger_message = no_translation( npc_trigger_message.evaluate( d ).translated() );
