                                        ...
                                        std::string_view member, std::string_view src, bool is_npc )
{
    ...
    if( local ) {
        return [eocs, unique_ids, npc_must_see, npc_range, z_min, z_max, is_npc, &here]( dialogue const & d ) {
            ...
            const std::vector<npc *> available = g->get_npcs_if( [npc_must_see, npc_range, z_min, z_max, actor_pos,
        ...
        std::string_view member, std::string_view src, bool is_npc )
{
    ...
    return [eocs, mtype_ids, monster_must_see, monster_range, z_min, z_max, is_npc, &here]( dialogue const & d ) {
