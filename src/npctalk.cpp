...
talk_effect_fun_t::func f_hp( const JsonObject &jo, std::string_view member,
                              bool is_npc )
{
    ...
    return [only_increase, new_hp, target_part, is_npc, main_only, minor_only,
                   max]( dialogue & d ) {
        talker *target = d.actor( is_npc );
...
talk_effect_fun_t::func f_queue_eocs( const JsonObject &jo, std::string_view member )
{
    ...
    return [dov_time_in_future, eocs_entries, process_eoc]( dialogue & d ) {
...
parsers = {
    ...
    { "u_set_hp", "npc_set_hp", jarg::member | jarg::array, &talk_effect_fun::f_hp },
