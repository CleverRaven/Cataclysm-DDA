...
class fault_fix
{
    public:
        ...
        std::map<std::string, double> adjust_variables_multiply; // item vars adjustment(s) applied to item via multiplication; // item vars adjustment(s) applied to item via multiplication
