...
const morale_type MORALE_FASTING( "morale_fasting" );
const morale_type MORALE_FASTING_BROKE( "morale_fasting_broke" );
...
static const morale_type morale_fasting( "morale_fasting" );
static const morale_type morale_fasting_broke( "morale_fasting_broke" );
