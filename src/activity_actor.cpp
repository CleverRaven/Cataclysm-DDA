...
static const item_group_id Item_spawn_data_SUS_trash_forest_no_manmade( "SUS_trash_forest_no_manmade" );
...
void forage_activity_actor::finish( player_activity &act, Character &who )
{
    ...
    if( one_in( 10 ) ) {
        const std::vector<item *> dropped =
            here.put_items_from_loc( Item_spawn_data_SUS_trash_forest_no_manmade, who.pos_bub(), calendar::turn );
        // same as above
        std::vector<item *> handled;
