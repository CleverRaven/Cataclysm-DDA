...
furn_id f_null,
    ...
    f_safe_c, f_safe_l, f_safe_o, f_gunsafe_ml, f_gunsafe_mj, f_gun_safe_el,
...
void set_furn_ids() {
    ...
    f_gunsafe_ml=furnfind("f_gunsafe_ml");
    f_gunsafe_mj=furnfind("f_gunsafe_mj");
    f_gun_safe_el=furnfind("f_gun_safe_el");
