...
void set_ter_ids()
{
    ...
    t_window_bars_domestic_with_curtain_open_window_open = ter_id( "t_window_bars_domestic_with_curtain_open_window_open" );
    ...
    t_window_plastic_bars_with_curtain_open_window_open = ter_id( "t_window_plastic_bars_with_curtain_open_window_open" );
    ...
    t_window_tempered_bars_with_curtain_open_window_open = ter_id( "t_window_tempered_bars_with_curtain_open_window_open" );
