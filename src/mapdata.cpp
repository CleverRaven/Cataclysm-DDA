...
ter_id t_null,
       ...
       t_portcullis,
       t_recycler, t_window, t_window_taped, t_window_plastic_taped, t_window_tempered_taped,
       t_window_domestic, t_window_no_curtains, t_window_no_curtains_open, t_window_no_curtains_taped,
       t_window_domestic_taped, t_window_open, t_curtains, t_window_alarm, t_window_alarm_taped,
       t_window_empty, t_window_frame, t_window_boarded, t_window_tempered_boarded,
       t_window_plastic_boarded, t_window_boarded_noglass, t_window_reinforced,
       t_window_tempered_reinforced, t_window_plastic_reinforced, t_window_reinforced_noglass,
       t_window_enhanced, t_window_tempered_enhanced, t_window_plastic_enhanced, t_window_enhanced_noglass,
       t_window_bars, t_window_bars_noglass, t_window_bars_alarm, t_window_bars_curtains,
       t_window_bars_domestic, t_window_stained_green, t_window_stained_red, t_window_stained_blue,
       t_window_reinforced_barred, t_window_reinforced_barred_noglass, t_window_plastic_reinforced_barred,
       t_window_tempered_reinforced_barred, t_window_plastic, t_window_plastic_open,
       t_window_plastic_with_curtain, t_window_plastic_with_curtain_open_window_closed,
       t_window_plastic_with_curtain_open, t_window_tempered, t_window_tempered_open,
       t_window_tempered_with_curtain, t_window_tempered_with_curtain_open_window_closed,
       t_window_tempered_with_curtain_open, t_m_frame, t_window_bars_curtain_open,
       t_window_bars_domestic_open, t_window_bars_domestic_with_curtain_open,
       t_window_bars_domestic_with_curtain, t_window_bars_domestic_with_curtain_open_window_open,
       t_window_plastic_bars, t_window_plastic_bars_open, t_window_plastic_bars_with_curtain_open,
       t_window_plastic_bars_with_curtain, t_window_plastic_bars_with_curtain_open_window_open,
       t_window_tempered_bars, t_window_tempered_bars_open, t_window_tempered_bars_with_curtain_open,
       t_window_tempered_bars_with_curtain, t_window_tempered_bars_with_curtain_open_window_open, t_rock,
       t_fault,
       t_paper,
...
void set_ter_ids()
{
    ...
    t_window_plastic_with_curtain_open_window_closed =
        ter_id( "t_window_plastic_with_curtain_open_window_closed" );
    ...
    t_window_tempered_with_curtain_open_window_closed =
        ter_id( "t_window_tempered_with_curtain_open_window_closed" );
    t_window_tempered_with_curtain_open = ter_id( "t_window_tempered_with_curtain_open" );
    t_window_bars_curtain_open = ter_id( "t_window_bars_curtain_open" );
    t_window_bars_domestic_open = ter_id( "t_window_bars_domestic_open" );
    t_window_bars_domestic_with_curtain_open = ter_id( "t_window_bars_domestic_with_curtain_open" );
    t_window_bars_domestic_with_curtain = ter_id( "t_window_bars_domestic_with_curtain" );
    t_window_bars_domestic_with_curtain_open_window_open =
        ter_id( "t_window_bars_domestic_with_curtain_open_window_open" );
    t_window_plastic_bars = ter_id( "t_window_plastic_bars" );
    t_window_plastic_bars_open = ter_id( "t_window_plastic_bars_open" );
    t_window_plastic_bars_with_curtain_open = ter_id( "t_window_plastic_bars_with_curtain_open" );
    t_window_plastic_bars_with_curtain = ter_id( "t_window_plastic_bars_with_curtain" );
    t_window_plastic_bars_with_curtain_open_window_open =
        ter_id( "t_window_plastic_bars_with_curtain_open_window_open" );
    t_window_tempered_bars = ter_id( "t_window_tempered_bars" );
    t_window_tempered_bars_open = ter_id( "t_window_tempered_bars_open" );
    t_window_tempered_bars_with_curtain_open = ter_id( "t_window_tempered_bars_with_curtain_open" );
    t_window_tempered_bars_with_curtain = ter_id( "t_window_tempered_bars_with_curtain" );
    t_window_tempered_bars_with_curtain_open_window_open =
        ter_id( "t_window_tempered_bars_with_curtain_open_window_open" );
