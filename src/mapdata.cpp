...
ter_id t_null,
    ...
    t_railroad_track, t_railroad_track_h, t_railroad_track_v, t_railroad_track_d, t_railroad_track_d_corner_filler,
...
void set_ter_ids() {
    ...
    t_railroad_track_d_corner_filler = ter_id( "t_railroad_track_d_corner_filler" );
