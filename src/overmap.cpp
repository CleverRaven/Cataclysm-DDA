...
void overmap::open()
{
    ...
    if( read_from_file_optional_istream( terfilename, std::bind( &overmap::unserialize, this, _1 ) ) ) {
        read_from_file_optional_istream( plrfilename, std::bind( &overmap::unserialize_view, this, _1 ) );
