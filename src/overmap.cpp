...
static const std::map<std::string, oter_flags> oter_flags_map = {
    ...
    { "RISK_HIGH",      risk_high },
    { "RISK_LOW",       risk_low },
    { "SOURCE_OF_AMMO", source_of_ammo },
    { "SOURCE_OF_ANIMALS", source_of_animals },
    { "SOURCE_OF_BOOKS", source_of_books },
    { "SOURCE_OF_CHEMISTRY", source_of_chemistry },
    { "SOURCE_OF_CLOTHING", source_of_clothing },
    { "SOURCE_OF_CONSTRUCTION", source_of_construction },
    { "SOURCE_OF_COOKING", source_of_cooking },
    { "SOURCE_OF_DRINK", source_of_drink },
    { "SOURCE_OF_ELECTRONICS", source_of_electronics },
    { "SOURCE_OF_FABRICATION", source_of_fabrication },
    { "SOURCE_OF_FARMING", source_of_farming },
    { "SOURCE_OF_FOOD", source_of_food },
    { "SOURCE_OF_FORAGE", source_of_forage },
    { "SOURCE_OF_FUEL", source_of_fuel },
    { "SOURCE_OF_GUN", source_of_gun },
    { "SOURCE_OF_LUXURY", source_of_luxury },
    { "SOURCE_OF_MEDICINE", source_of_medicine },
    { "SOURCE_OF_PEOPLE", source_of_people },
    { "SOURCE_OF_SAFETY", source_of_safety },
    { "SOURCE_OF_TAILORING", source_of_tailoring },
    { "SOURCE_OF_VEHICLES", source_of_vehicles },
    { "SOURCE_OF_WEAPON", source_of_weapon }
};
