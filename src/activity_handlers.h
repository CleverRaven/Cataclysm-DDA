...
void activity_on_turn_fetch_tools( player_activity &, player *p );
void activity_on_turn_fetch_seeds( player_activity &, player *p );
...
void fetch_tools_do_turn( player_activity *act, player *p );
void fetch_seeds_do_turn( player_activity *act, player *p );
