...
void hand_pump_integral_do_turn( player_activity *act, player *p );
void equalize_do_turn( player_activity *act, player *p );
...
void hand_pump_integral_finish( player_activity *act, player *p );
void equalize_finish( player_activity *act, player *p );
