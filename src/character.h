...
class Character : public Creature, public visitable
{
    ...
    public:
        ...
        */
        ...
        void roll_all_damage( bool crit, damage_instance &di, bool average, const item &weap, bool unarmed,
                              const Creature *target, const bodypart_id &bp ) const;
        /** Adds player's total bash damage to the damage instance */
        void roll_bash_damage( bool crit, damage_instance &di, bool average, const item &weap, bool unarmed,
                               float crit_mod ) const;
        /** Adds player's total cut damage to the damage instance */
        void roll_cut_damage( bool crit, damage_instance &di, bool average, const item &weap, bool unarmed,
                              float crit_mod ) const;
        /** Adds player's total stab damage to the damage instance */
        void roll_stab_damage( bool crit, damage_instance &di, bool average, const item &weap, bool unarmed,
                               float crit_mod ) const;
        /** Adds player's total non-bash, non-cut, non-stab damage to the damage instance */
        void roll_other_damage( bool crit, damage_instance &di, bool average, const item &weap, bool unarmed,
                                float crit_mod ) const;
