...
class Creature : public viewer
{
    public:
        ...
        */
         ...
         * by waterproof gear. Each point of penetration ignores 1% of waterproofing and should be used 
         * only for attacks which can get through things like hermetically sealed power armor, IE magic. */
        bool add_liquid_effect( const efftype_id &eff_id, const bodypart_id &vector,
                             const time_duration &dur, const bodypart_id &bp, bool permanent = false, int intensity = 1,
                             bool force = false );
        bool add_liquid_effect( const efftype_id &eff_id, const bodypart_id &vector,
                             const time_duration &dur, bool permanent = false, int intensity = 1, bool force = false );
