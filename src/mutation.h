...
struct mutation_branch {
    ...
    public:
        ...
        std::set<flag_id> flags; // Mutation flags
        std::set<flag_id> active_flags; // Mutation flags only when active
        std::set<flag_id> inactive_flags; // Mutation flags only when inactive
