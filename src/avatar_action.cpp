...
void avatar_action::autoattack( avatar &you, map &m )
{
    ...
    int reach = weapon ? weapon->reach_range( you ) : std::max( 1, static_cast<int>( you.calculate_by_enchantment( 1, enchant_vals::mod::MELEE_RANGE_MODIFIER ) ) );
    add_msg("avatar_action: reach:%d", reach );
