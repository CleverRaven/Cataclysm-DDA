...
void options_manager::add_options_interface()
{
    ...
    add_option_group( "interface", Group( "veh_intf_opts", to_translation( "Vehicle Interface Options" ),
...
void options_manager::add_options_graphics()
{
    ...
    add_option_group( "graphics", Group( "graph_display_opts", to_translation( "Graphical Display Options" ),
...
void options_manager::add_options_world_default()
{
    ...
    add_option_group( "world_default", Group( "monster_props_opts", to_translation( "Monster Properties Options" ),
...
void options_manager::add_options_debug()
{
    ...
    add_option_group( "debug", Group( "chargen_point_opts", to_translation( "Character Generation Points Options" ),
...
void options_manager::add_options_android()
{
    ...
    add_option_group( "android", Group( "android_keyboard_opts", to_translation( "Android Keyboard Options" ),
    ...
    add_option_group( "android", Group( "joystick_android_opts", to_translation( "Android Joystick Options" ),
    ...
    add_option_group( "android", Group( "shortcut_android_opts", to_translation( "Android Shortcut Options" ),
    ...
    add_option_group( "android", Group( "gestures_android_opts", to_translation( "Android Gestures Options" ),
    ...
    add_option_group( "android", Group( "shortc_screen_opts", to_translation( "Shortcut Screen Options" ),
