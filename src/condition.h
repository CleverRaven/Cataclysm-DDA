...
const std::unordered_set<std::string> complex_conds = { {
        ...
        "u_has_flag", "npc_has_flag", "u_has_species", "npc_has_species", "u_bodytype", "npc_bodytype", "npc_has_class", "u_has_mission", "u_monsters_in_direction", "u_safe_mode_trigger", "u_has_threshold",
