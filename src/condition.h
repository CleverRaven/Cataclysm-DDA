...
const std::unordered_set<std::string> complex_conds = { {
        ...
        "u_compare_time_since_var", "npc_compare_time_since_var", "is_weather", "map_terrain_with_flag", "mod_is_loaded", "one_in_chance", "x_in_y_chance",
...
struct conditional_t {
    ...
    public:
        ...
        void set_map_terrain_with_flag( const JsonObject &jo, std::string_view member );
