...
class worldfactory
{
    ...
    private:
        ...
        std::unordered_map<std::string, options_manager::cOpt> get_default_world_options();
        std::unordered_map<std::string, options_manager::cOpt> get_world_options(std::string path);
