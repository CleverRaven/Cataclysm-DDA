...
weather_datum const& weather_data(weather_type const type)
{
    ...
    static std::array<weather_datum, NUM_WEATHER_TYPES> const data {{
        weather_datum {
            ...
            0, 0.f, 0, 0, 0.0f, false,
            &weather_effect::none
        },
        weather_datum {
            _("Clear"), c_cyan, 0, 1.f, 0, 0, 0.0f, false,
            &weather_effect::none
        },
        weather_datum {
            _("Sunny"), c_ltcyan, 0, 1.f, 2, 0, 0.0f, false,
            &weather_effect::glare
        },
        weather_datum {
            _("Cloudy"), c_ltgray, 0, 1.f, -20, 0, 0.0f, false,
            &weather_effect::none
        },
        weather_datum {
            _("Drizzle"), c_ltblue, 1, 1.03f, -20, 1, 0.1f, false,
            &weather_effect::wet
        },
        weather_datum {
            _("Rain"), c_blue, 3, 1.1f, -30, 4, 0.2f, false,
            &weather_effect::very_wet
        },
        weather_datum {
            _("Thunder Storm"), c_dkgray, 4, 1.2f, -40, 8, 0.2f, false,
            &weather_effect::thunder
        },
        weather_datum {
            _("Lightning Storm"), c_yellow, 4, 1.25f, -45, 8, 0.2f, false,
            &weather_effect::lightning
        },
        weather_datum {
            _("Acidic Drizzle"), c_ltgreen, 2, 1.03f, -20, 1, 0.1f, true,
            &weather_effect::light_acid
        },
        weather_datum {
            _("Acid Rain"), c_green, 4, 1.1f, -30, 4, 0.2f, true,
            &weather_effect::acid
        },
        weather_datum {
            _("Flurries"), c_white, 2, 1.12f, -15, 2, 0.3f, false,
            &weather_effect::flurry
        },
        weather_datum {
            _("Snowing"), c_white, 4, 1.13f, -20, 4, 0.2f, false,
            &weather_effect::snow
        },
        weather_datum {
            _("Snowstorm"), c_white, 6, 1.2f, -30, 6, 0.3f, false,
