    ...
    while( SDL_PollEvent( &ev ) ) {
        ...
        switch( ev.type ) {
            ...
            case SDL_FINGERMOTION:
                ...
                dbg( D_INFO ) << "ev.tfinger.fingerId: " << ev.tfinger.fingerId;
                dbg( D_INFO ) << "ev.tfinger.touchId: " << ev.tfinger.touchId;
                numfingers = SDL_GetNumTouchFingers( ev.tfinger.touchId );
                dbg( D_INFO ) << "numfingers: " << numfingers;
                if( numfingers == 1 && static_cast<int>(ev.tfinger.fingerId) > 0 ) {
                ...
                } else if( numfingers == 2 && static_cast<int>(ev.tfinger.fingerId) > 0 ) {
                    second_finger_curr_x = ev.tfinger.x * WindowWidth;
                    second_finger_curr_y = ev.tfinger.y * WindowHeight;
                } else if( numfingers == 3 && static_cast<int>(ev.tfinger.fingerId) > 0 ) {
            ...
            case SDL_FINGERDOWN:
                ...
                if( numfingers == 1 && static_cast<int>(ev.tfinger.fingerId) > 0 ) {
                    ...
                    ui_manager::redraw_invalidated();
                    needupdate = true; // ensure virtual joystick and quick shortcuts redraw as we interact
                } else if( numfingers == 2 && static_cast<int>(ev.tfinger.fingerId) > 0 && !is_quick_shortcut_touch ) {
                ...
                } else if( numfingers == 3 && static_cast<int>(ev.tfinger.fingerId) > 0 && !is_quick_shortcut_touch ) {
