    ...
    while( SDL_PollEvent( &ev ) ) {
        ...
        switch( ev.type ) {
            ...
            case SDL_FINGERMOTION:
                ...
                if( numfingers == 1 && ev.tfinger.fingerId != NULL ) {
            ...
            case SDL_FINGERDOWN:
                ...
                if( numfingers == 1 && ev.tfinger.fingerId != NULL ) {
                    ...
                    ui_manager::redraw_invalidated();
                    needupdate = true; // ensure virtual joystick and quick shortcuts redraw as we interact
                } else if( numfingers == 2 && ev.tfinger.fingerId != NULL && !is_quick_shortcut_touch ) {
                ...
                } else if( numfingers == 3 && ev.tfinger.fingerId != NULL && !is_quick_shortcut_touch ) {
