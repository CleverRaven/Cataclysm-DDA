                                        ...
                                        tripoint_abs_omt omt_point )
{
    ...
    for( const auto &gen : gen ) {
        switch( gen.type ) {
            case map_generator::bash_damage:
                gen.bash_damage( md, all_points_in_map );
                break;
            case map_generator::move_items:
                gen.move_items( md, all_points_in_map );
                break;
            case map_generator::add_fire:
                gen.add_fire( md, all_points_in_map );
                break;
            case map_generator::pre_burn:
                gen.pre_burn( md, all_points_in_map );
                break;
            case map_generator::place_blood:
                gen.place_blood( md, all_points_in_map );
                break;
            case map_generator::afs_ruin:
                gen.aftershock_ruin( md, all_points_in_map, omt_point );
                break;
            default:
