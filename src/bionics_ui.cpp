                                   ...
                                   bionic_menu_mode mode )
{
    ...
    std::string desc_append = string_format(
                                  _( "[<color_yellow>%s</color>] Reassign, [<color_yellow>%s</color>] Switch tabs, [<color_yellow>%s</color>] Toggle fuel saving mode, [<color_yellow>%s</color>] Toggle auto start mode." ),
