...
static const mon_flag_id mon_flag_ACIDPROOF( "ACIDPROOF" );
static const mon_flag_id mon_flag_ACIDTRAIL( "ACIDTRAIL" );
static const mon_flag_id mon_flag_AQUATIC( "AQUATIC" );
static const mon_flag_id mon_flag_ATTACKMON( "ATTACKMON" );
static const mon_flag_id mon_flag_AVOID_DANGER_1( "AVOID_DANGER_1" );
static const mon_flag_id mon_flag_AVOID_DANGER_2( "AVOID_DANGER_2" );
static const mon_flag_id mon_flag_AVOID_FALL( "AVOID_FALL" );
static const mon_flag_id mon_flag_AVOID_FIRE( "AVOID_FIRE" );
static const mon_flag_id mon_flag_CAN_OPEN_DOORS( "CAN_OPEN_DOORS" );
static const mon_flag_id mon_flag_DRIPS_GASOLINE( "DRIPS_GASOLINE" );
static const mon_flag_id mon_flag_DRIPS_NAPALM( "DRIPS_NAPALM" );
...
static const mon_flag_id mon_flag_PACIFIST( "PACIFIST" );
static const mon_flag_id mon_flag_PET_WONT_FOLLOW( "PET_WONT_FOLLOW" );
static const mon_flag_id mon_flag_PRIORITIZE_TARGETS( "PRIORITIZE_TARGETS" );
static const mon_flag_id mon_flag_PUSH_MON( "PUSH_MON" );
...
static const mon_flag_id mon_flag_SHORTACIDTRAIL( "SHORTACIDTRAIL" );
static const mon_flag_id mon_flag_SLUDGETRAIL( "SLUDGETRAIL" );
static const mon_flag_id mon_flag_SMALLSLUDGETRAIL( "SMALLSLUDGETRAIL" );
static const mon_flag_id mon_flag_SMELLS( "SMELLS" );
static const mon_flag_id mon_flag_STUMBLES( "STUMBLES" );
static const mon_flag_id mon_flag_SUNDEATH( "SUNDEATH" );
static const mon_flag_id mon_flag_SWARMS( "SWARMS" );
static const mon_flag_id mon_flag_WEBWALK( "WEBWALK" );
...
bool monster::will_move_to( const tripoint &p ) const
{
    ...
    bool avoid_fire = has_flag( mon_flag_AVOID_FIRE );
    bool avoid_fall = has_flag( mon_flag_AVOID_FALL );
    bool avoid_simple = has_flag( mon_flag_AVOID_DANGER_1 );
    bool avoid_complex = has_flag( mon_flag_AVOID_DANGER_2 );
    /*
