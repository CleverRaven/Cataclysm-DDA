...
void vehicle::use_autoclave( int p )
{
    ...
    if( parts[p].enabled ) {
        ...
        add_msg( m_bad, _( "You need 8 charges of water in tanks of the %s for the autodoc to run." ),
                 name );
...
void vehicle::interact_with( const tripoint &pos, int interact_part )
{
    ...
    enum {
        ...
        USE_HOTPLATE, FILL_CONTAINER, DRINK, USE_WELDER, USE_PURIFIER, PURIFY_TANK, USE_AUTOCLAVE, USE_WASHMACHINE, USE_MONSTER_CAPTURE,
