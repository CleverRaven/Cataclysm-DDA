...
void dis_msg(dis_type type_string) {
    ...
    switch (type) {
    case DI_COMMON_COLD:
        Messages::add_msg(_("You feel a cold coming on..."));
        g->u.add_memorial_log(pgettext("memorial_male", "Caught a cold."),
                              pgettext("memorial_female", "Caught a cold."));
        break;
    case DI_FLU:
        Messages::add_msg(_("You feel a flu coming on..."));
        g->u.add_memorial_log(pgettext("memorial_male", "Caught the flu."),
                              pgettext("memorial_female", "Caught the flu."));
        break;
    case DI_CRUSHED:
        Messages::add_msg(_("The ceiling collapses on you!"));
        break;
    case DI_BOULDERING:
        Messages::add_msg(_("You are slowed by the rubble."));
        break;
    case DI_BOOMERED:
        Messages::add_msg(_("You're covered in bile!"));
        break;
    case DI_SAP:
        Messages::add_msg(_("You're coated in sap!"));
        break;
    case DI_SLIMED:
        Messages::add_msg(_("You're covered in thick goo!"));
        break;
    case DI_LYING_DOWN:
        Messages::add_msg(_("You lie down to go to sleep..."));
        break;
    case DI_FORMICATION:
        Messages::add_msg(_("Your skin feels extremely itchy!"));
        break;
    case DI_WEBBED:
        Messages::add_msg(_("You're covered in webs!"));
        break;
    case DI_DRUNK:
    case DI_HIGH:
    case DI_WEED_HIGH:
        Messages::add_msg(_("You feel lightheaded."));
        break;
    case DI_ADRENALINE:
        Messages::add_msg(_("You feel a surge of adrenaline!"));
        break;
    case DI_JETINJECTOR:
        Messages::add_msg(_("You feel a rush as the chemicals flow through your body!"));
        break;
    case DI_ASTHMA:
        Messages::add_msg(_("You can't breathe... asthma attack!"));
        break;
    case DI_DEAF:
        Messages::add_msg(_("You're deafened!"));
        break;
    case DI_STUNNED:
        Messages::add_msg(_("You're stunned!"));
        break;
    case DI_DOWNED:
        Messages::add_msg(_("You're knocked to the floor!"));
        break;
    case DI_AMIGARA:
        Messages::add_msg(_("You can't look away from the faultline..."));
        break;
    case DI_STEMCELL_TREATMENT:
        Messages::add_msg(_("You receive a pureed bone & enamel injection into your eyeball."));
        if (!(g->u.has_trait("NOPAIN"))) {
            Messages::add_msg(_("It is excruciating."));
        }
        break;
    case DI_BITE:
        Messages::add_msg(_("The bite wound feels really deep..."));
        ...
        break;
    case DI_INFECTED:
        Messages::add_msg(_("Your bite wound feels infected."));
        g->u.add_memorial_log(pgettext("memorial_male", "Contracted an infection."),
                              pgettext("memorial_female", "Contracted an infection."));
        break;
    case DI_LIGHTSNARE:
        Messages::add_msg(_("You are snared."));
        break;
    case DI_HEAVYSNARE:
        Messages::add_msg(_("You are snared."));
        break;
    case DI_CONTACTS:
        Messages::add_msg(_("You can see more clearly."));
        break;
    case DI_LACKSLEEP:
        Messages::add_msg(_("You are too tired to function well."));
        break;
    case DI_GRABBED:
        Messages::add_msg(_("You have been grabbed."));
        break;
    default:
        break;
    }
    ...
    switch(disType) {
                    ...
                    switch(dis.intensity) {
                        case 3:
                            ...
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your thoughts are unclear."));
                            }
                        case 2:
                            p.mod_int_bonus(-1);
                        default:
                ...
                case bp_mouth:
                    switch(dis.intensity) {
                        ...
                        case 2:
                            p.mod_per_bonus(-1);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your face is stiff from the cold."));
                            }
                        default:
                            break;
                    }
                ...
                case bp_torso:
                    switch(dis.intensity) {
                        case 3:
                            ...
                            p.mod_dex_bonus(-2);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your torso is freezing cold. \
                ...
                case bp_arms:
                    switch(dis.intensity) {
                        ...
                        case 2:
                            p.mod_dex_bonus(-1);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your arms are shivering."));
                            }
                        default:
                            break;
                    }
                ...
                case bp_hands:
                    switch(dis.intensity) {
                        ...
                        case 2:
                            p.mod_dex_bonus(-1);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your hands feel like ice."));
                            }
                        default:
                            break;
                    }
                ...
                case bp_legs:
                    switch(dis.intensity) {
                        case 3:
                            ...
                            p.mod_str_bonus(-1);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your legs tremble against the relentless cold."));
                            }
                        case 2:
                            p.mod_dex_bonus(-1);
                            p.mod_str_bonus(-1);
                ...
                case bp_feet:
                    switch(dis.intensity) {
                        ...
                        case 2:
                            p.mod_dex_bonus(-1);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your feet feel frigid."));
                            }
                        default:
                            break;
                    }
            ...
            switch(dis.bp) {
                case bp_hands:
                    switch(dis.intensity) {
                        ...
                        case 1:
                            ...
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your fingers itch."));
                            }
                        default:
                            break;
                    }
                ...
                case bp_feet:
                    switch(dis.intensity) {
                        ...
                        case 1:
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your toes itch."));
                            }
                        default:
                            break;
                    }
                ...
                case bp_mouth:
                    switch(dis.intensity) {
                        ...
                        case 1:
                            p.mod_per_bonus(-1);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your face feels numb."));
                            }
                        default:
                            break;
                    }
                ...
                case bp_head:
                    switch(dis.intensity) {
                        case 3:
                            ...
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your head is pounding from the heat."));
                            }
                        case 2:
                            ...
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("The heat is making you see things."));
                            }
                    }
                    break;
                case bp_mouth:
                ...
                case bp_torso:
                    switch(dis.intensity) {
                        case 3:
                            ...
                            p.mod_str_bonus(-1);
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("You are sweating profusely."));
                            }
                        case 2:
                            if (int(calendar::turn) % 300 == 0) {
                                p.thirst++;
                ...
                case bp_legs:
                    switch (dis.intensity) {
                        case 3 :
                            ...
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your legs are cramping up."));
                            }
                        case 2:
                            if (int(calendar::turn) % 300 == 0) {
                                p.thirst++;
                ...
                case bp_feet:
                    switch (dis.intensity) {
                        case 3 :
                            ...
                            if (!sleeping && tempMsgTrigger) {
                                Messages::add_msg(_("Your feet are swelling in the heat."));
                            }
                    }
                    break;
                case bp_eyes:// Eyes are not susceptible by this disease.
        ...
        case DI_LYING_DOWN:
            ...
            if (p.can_sleep()) {
                ...
                if (item_name == "many") {
                    if (one_in(15) ) {
                        Messages::add_msg(_("You nestle your pile of clothes for warmth."));
                    } else {
                        Messages::add_msg(_("You use your pile of clothes for warmth."));
                    }
                } else if (item_name != "nothing") {
                    if (one_in(15)) {
                        Messages::add_msg(_("You snuggle your %s to keep warm."), item_name.c_str());
                    } else {
                        Messages::add_msg(_("You use your %s to keep warm."), item_name.c_str());
                    }
                }
                ...
                if (p.has_disease("sleep")) {
                    if (dis.duration == 1) {
                        if(!g->sound(p.posx, p.posy, 12, _("beep-beep-beep!"))) {
                            ...
                            Messages::add_msg(_("You turn off your alarm-clock."));
                        }
                    }
            ...
            for (int i = 0; i < num_hp_parts; i++) {
                if (one_in(6)) {
                    if (p.hp_cur[i] < rng(0, 40)) {
                        Messages::add_msg(_("Your bones feel like rubber as they melt and remend."));
                        p.hp_cur[i]+= rng(1,8);
                    } else if (p.hp_cur[i] > rng(10, 2000)) {
                        Messages::add_msg(_("Your bones feel like they're crumbling."));
                        p.hp_cur[i] -= rng(0,8);
                    }
                }
            }
            ...
            if (p.has_trait("PARAIMMUNE")) {
               p.rem_disease("brainworm");
                ...
                if((one_in(512)) && (!p.has_trait("NOPAIN"))) {
                    Messages::add_msg(_("Your head hurts."));
                    p.mod_pain(rng(2, 8));
                }
                if(one_in(1024)) {
                    p.health--;
                    ...
                    Messages::add_msg(_("Your vision is getting fuzzy."));
            ...
            if (p.has_trait("PARAIMMUNE")) {
               p.rem_disease("paincysts");
                ...
                if((one_in(256)) && (!p.has_trait("NOPAIN"))) {
                    Messages::add_msg(_("Your joints ache."));
                    p.mod_pain(rng(1, 4));
                }
                if(one_in(256)) {
                    p.fatigue++;
        ...
        case DI_RAT:
            ...
            if (rng(0, 100) < dis.duration / 10) {
                ...
                if (one_in(3)) {
                    ...
                    Messages::add_msg(_("You feel nauseous!"));
                    dis.duration += 3;
                }
            }
            break;
        ...
        case DI_FORMICATION:
            ...
            if (x_in_y(dis.intensity, 100 + 50 * p.get_int())) {
                if (!p.is_npc()) {
                     Messages::add_msg(_("You start scratching your %s!"),
                                              body_part_name(dis.bp, dis.side).c_str());
                     g->cancel_activity();
                } else if (g->u_see(p.posx, p.posy)) {
                    Messages::add_msg(_("%s starts scratching their %s!"), p.name.c_str(),
                                       body_part_name(dis.bp, dis.side).c_str());
                }
                p.moves -= 150;
        ...
        case DI_TELEGLOW:
            ...
            if (dis.duration > 6000) {
                ...
                if (one_in(1000 - ((dis.duration - 6000) / 10))) {
                    if (!p.is_npc()) {
                        Messages::add_msg(_("Glowing lights surround you, and you teleport."));
                ...
                if (one_in(1200 - ((dis.duration - 6000) / 5)) && one_in(20)) {
                    if (!p.is_npc()) {
                        Messages::add_msg(_("You pass out."));
                    }
                    p.fall_asleep(1200);
                    if (one_in(6)) {
                        p.rem_disease("teleglow");
                ...
                if (one_in(4000 - int(.25 * (dis.duration - 3600)))) {
                    ...
                    if (tries < 10) {
                        ...
                        if (g->u_see(x, y)) {
                            ...
                            Messages::add_msg(_("A portal opens nearby, and a monster crawls through!"));
                        }
                        if (one_in(2)) {
                            p.rem_disease("teleglow");
                        }
        ...
        case DI_LIGHTSNARE:
            p.moves = -500;
            if(one_in(10)) {
                Messages::add_msg(_("You attempt to free yourself from the snare."));
            }
            break;
...
void manage_sleep(player& p, disease& dis)
{
    ...
    if((int(calendar::turn) % 350 == 0) && p.has_trait("HIBERNATE") && (p.hunger < -60) && !(p.thirst >= 80)) {
        ...
        if (p.fatigue <= 0 && p.fatigue > -20) {
            p.fatigue = -25;
            Messages::add_msg(_("You feel well rested."));
    ...
    if (strength != 0) {
        ...
        if ((int(calendar::turn) % (3600 / strength) == 0) && one_in(3)) {
            ...
            Messages::add_msg("%s",dream.c_str());
        }
    }
    ...
    if (p.has_trait("HEAVYSLEEPER2") && !p.has_trait("HIBERNATE")) {
        ...
        Messages::add_msg(_("The light wakes you up."));
        dis.duration = 1;
        }
        return;}
...
static void handle_infected_wound(player& p, disease& dis)
{
    ...
    if (dis.duration > 8401) {
        ...
        Messages::add_msg(_("You succumb to the infection."));
