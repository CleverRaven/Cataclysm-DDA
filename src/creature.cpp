...
static const mon_flag_id mon_flag_ALL_SEEING( "ALL_SEEING" );
static const mon_flag_id mon_flag_ALWAYS_SEES_YOU( "ALWAYS_SEES_YOU" );
static const mon_flag_id mon_flag_ALWAYS_VISIBLE( "ALWAYS_VISIBLE" );
static const mon_flag_id mon_flag_AQUATIC( "AQUATIC" );
static const mon_flag_id mon_flag_CAMOUFLAGE( "CAMOUFLAGE" );
static const mon_flag_id mon_flag_IMMOBILE( "IMMOBILE" );
static const mon_flag_id mon_flag_MECH_DEFENSIVE( "MECH_DEFENSIVE" );
static const mon_flag_id mon_flag_NIGHT_INVISIBILITY( "NIGHT_INVISIBILITY" );
static const mon_flag_id mon_flag_RANGED_ATTACKER( "RANGED_ATTACKER" );
