...
long air_gear_actor::use( player &p, item &it, bool t, const tripoint & ) const
{
    ...
    if( it.active ) {
        if( activate_msg.empty() ) {
            p.add_msg_if_player( m_info, _( "You turn the valve, switching to your air supply." ),
                                 it.tname().c_str() );
        ...
        if( deactive_msg.empty() ) {
            p.add_msg_if_player( m_info, _( "You turn the valve, switching off your air supply." ),
                                 it.tname().c_str() );
