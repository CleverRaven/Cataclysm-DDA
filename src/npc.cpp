...
{
    return set_companion_mission( p.global_omt_location(), p.companion_mission_role_id, id );
}
void npc::set_companion_mission( const tripoint &omt_pos, const std::string &cmri, const std::string &id )
{
    comp_mission.position = omt_pos;
    comp_mission.mission_id =  id;
    comp_mission.role_id = cmri;
}
