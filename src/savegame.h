...
const std::string legacy_mon_id[126] = {"mon_null", "mon_squirrel", "mon_rabbit", "mon_deer",
    ...
    "mon_zombie_smoker", "mon_zombie_swimmer", "mon_zombie_dog", "mon_zombie_brute",
...
const std::string legacy_furn_id[54] = {"f_null", "f_hay", "f_bulletin", "f_indoor_plant", "f_bed",
    ...
    "f_crate_o", "f_canvas_wall", "f_canvas_door", "f_canvas_door_o", "f_groundsheet", "f_large_groundsheet",
    "f_center_groundsheet", "f_fema_groundsheet", "f_skin_wall", "f_skin_door", "f_skin_door_o", "f_skin_groundsheet",
