...
class field
{
    public:
        ...
        const field_entry *findFieldc(const field_id
                                      field_to_find); //for when you want a const field_entry.
        ...
        field_list; //A pointer lookup table of all field effects on the current tile.
    private:
