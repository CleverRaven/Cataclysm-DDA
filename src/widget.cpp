                            ...
                            bool skip_pad )
{
    ...
    if( _style == "layout" ) {
        ...
        bool change_label_color = ( label_color != c_light_gray ) && !_label.empty() &&
                                  !has_flag( "W_LABEL_NONE" );
        std::string colored_label = ( change_label_color ? colorize( _label,
                                      get_label_color() ) : _label.translated() );
