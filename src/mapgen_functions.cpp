...
*/
   ...
   |--|--ww---ww-|--|w-G\n\
        ...
        if (density > 1) {
            m->place_spawns("GROUP_ZOMBIE", 2, 0, 0, 23, 23, density);
        } else {
            m->add_spawn("mon_zombie", rng(1, 8), 15, 10);
        }
        if (dat.north() == "apartments_con_tower_1" && dat.west() == "apartments_con_tower_1") {
            m->rotate(3);
        } else if (dat.north() == "apartments_con_tower_1" && dat.east() == "apartments_con_tower_1") {
            m->rotate(0);
        } else if (dat.south() == "apartments_con_tower_1" && dat.east() == "apartments_con_tower_1") {
            m->rotate(1);
        } else if (dat.west() == "apartments_con_tower_1" && dat.south() == "apartments_con_tower_1") {
            m->rotate(2);
        }
...
*/
        ...
        // Init to grass & dirt;
        dat.fill_groundcover();
        if ((dat.south() == "apartments_con_tower_1_entrance" && dat.east() == "apartments_con_tower_1") ||
            (dat.north() == "apartments_con_tower_1" && dat.east() == "apartments_con_tower_1_entrance")
            || (dat.west() == "apartments_con_tower_1" && dat.north() == "apartments_con_tower_1_entrance") ||
            (dat.south() == "apartments_con_tower_1" && dat.west() == "apartments_con_tower_1_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
                        \n\
   |------|-|-|ww---|   \n\
   ...
   |############|EEx=...\n",
            ...
            if (dat.west() == "apartments_con_tower_1_entrance") {
                m->rotate(1);
            }
            if (dat.north() == "apartments_con_tower_1_entrance") {
                m->rotate(2);
            }
            if (dat.east() == "apartments_con_tower_1_entrance") {
                m->rotate(3);
            }
        }

        else if ((dat.west() == "apartments_con_tower_1_entrance" && dat.north() == "apartments_con_tower_1") ||
                 (dat.north() == "apartments_con_tower_1_entrance" && dat.east() == "apartments_con_tower_1")
                 || (dat.west() == "apartments_con_tower_1" && dat.south() == "apartments_con_tower_1_entrance") ||
                 (dat.south() == "apartments_con_tower_1" && dat.east() == "apartments_con_tower_1_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
...|---|-|-|-|------|   \n\
...|cSe..+u|r+.dBBd.|   \n\
...
ss                      \n",
            ...
            if (dat.south() == "apartments_con_tower_1_entrance") {
                m->rotate(3);
            }
        } else {
            mapf::formatted_set_simple(m, 0, 0,
...
...=EEE|############|   \n",
            ...
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_locker) {
                        m->place_items("office", 70,  i,  j, i,  j, false, 0);
                    }
                    if (m->furn(i, j) == f_dresser) {
                        m->place_items("dresser", 70,  i,  j, i,  j, false, 0);
                    }
            ...
            if (dat.west() == "apartments_con_tower_1" && dat.north() == "apartments_con_tower_1") {
                m->rotate(1);
            } else if (dat.east() == "apartments_con_tower_1" && dat.north() == "apartments_con_tower_1") {
                m->rotate(2);
            } else if (dat.east() == "apartments_con_tower_1" && dat.south() == "apartments_con_tower_1") {
                m->rotate(3);
            }
        }
...
*/
        ...
        // Init to grass & dirt;
        dat.fill_groundcover();
        if ((dat.south() == "apartments_mod_tower_1_entrance" && dat.east() == "apartments_mod_tower_1") ||
            (dat.north() == "apartments_mod_tower_1" && dat.east() == "apartments_mod_tower_1_entrance")
            || (dat.west() == "apartments_mod_tower_1" && dat.north() == "apartments_mod_tower_1_entrance") ||
            (dat.south() == "apartments_mod_tower_1" && dat.west() == "apartments_mod_tower_1_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
                        \n\
       |----ww----|     \n\
 ...
 R|-|--------------|....\n",
            ...
            if (dat.west() == "apartments_mod_tower_1_entrance") {
                m->rotate(1);
            }
            if (dat.north() == "apartments_mod_tower_1_entrance") {
                m->rotate(2);
            }
            if (dat.east() == "apartments_mod_tower_1_entrance") {
                m->rotate(3);
            }
        }

        else if ((dat.west() == "apartments_mod_tower_1_entrance" && dat.north() == "apartments_mod_tower_1") ||
                 (dat.north() == "apartments_mod_tower_1_entrance" && dat.east() == "apartments_mod_tower_1")
                 || (dat.west() == "apartments_mod_tower_1" && dat.south() == "apartments_mod_tower_1_entrance") ||
                 (dat.south() == "apartments_mod_tower_1" && dat.east() == "apartments_mod_tower_1_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
....|cSe.u.htth...oo.w  \n\
....|O.....htth......w  \n\
...
ss                      \n",
            ...
            if (dat.south() == "apartments_mod_tower_1_entrance") {
                m->rotate(3);
            }
        }
...
....|--------------|-|R \n",
            ...
            if (dat.west() == "apartments_mod_tower_1" && dat.north() == "apartments_mod_tower_1") {
                m->rotate(1);
            } else if (dat.east() == "apartments_mod_tower_1" && dat.north() == "apartments_mod_tower_1") {
                m->rotate(2);
            } else if (dat.east() == "apartments_mod_tower_1" && dat.south() == "apartments_mod_tower_1") {
                m->rotate(3);
            }
        }
...
ssssss______ss______ssss\n",
                                   ...
                                   mapf::basic_bind("E > < R # X G C , _ r V H 6 x % ^ . - | t + = D w T S e o h c d l s", f_null,
                                           ...
                                           f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
        m->place_items("office", 75, 4, 2, 6, 2, false, 0);
        m->place_items("office", 75, 19, 6, 19, 6, false, 0);
        m->place_items("office", 75, 12, 8, 14, 8, false, 0);
        if (density > 1) {
            m->place_spawns("GROUP_ZOMBIE", 2, 0, 0, 12, 3, density);
        } else {
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_zombie", 2, 15, 7);
            }
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_zombie", rng(1, 8), 22, 1);
            }
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_zombie_cop", 1, 22, 4);
            }
        }
        {
            int num_chairs = rng(0, 6);
...
ss%|rrrr|...|.R.|EEED...\n",
                                       ...
                                       mapf::basic_bind("E > R # X G C , _ r V H 6 x % ^ . - | t + = D w T S e o h c d l s", f_null,
                                               ...
                                               f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
            if (density > 1) {
                m->place_spawns("GROUP_ZOMBIE", 2, 0, 0, 2, 8, density);
            } else {
                m->add_spawn("mon_zombie", rng(0, 5), 15, 7);
                if (x_in_y(1, 1)) {
                    m->add_spawn("mon_zombie", 2, 5, 20);
                }
            }
            m->place_items("office", 75, 4, 23, 7, 23, false, 0);
            m->place_items("office", 75, 4, 19, 7, 19, false, 0);
            m->place_items("office", 75, 4, 14, 7, 14, false, 0);
            m->place_items("office", 75, 5, 16, 7, 16, false, 0);
            m->place_items("fridge", 80, 14, 17, 14, 17, false, 0);
            m->place_items("cleaning", 75, 19, 17, 20, 17, false, 0);
            m->place_items("cubical_office", 75, 6, 12, 7, 12, false, 0);
            m->place_items("cubical_office", 75, 12, 11, 12, 12, false, 0);
            m->place_items("cubical_office", 75, 16, 11, 17, 12, false, 0);
            m->place_items("cubical_office", 75, 4, 5, 5, 5, false, 0);
            m->place_items("cubical_office", 75, 11, 5, 12, 5, false, 0);
            m->place_items("cubical_office", 75, 14, 5, 16, 5, false, 0);
            {
                int num_chairs = rng(0, 6);
                for( int i = 0; i < num_chairs; i++ ) {
                    m->add_vehicle ("swivel_chair", rng(6, 16), rng(6, 16), 0, -1, -1, false);
...
ssssssssssssssssssssssss\n",
                                       ...
                                       mapf::basic_bind("E > < R # X G C , _ r V H 6 x % ^ . - | t + = D w T S e o h c d l s", f_null,
                                               ...
                                               f_null,  f_indoor_plant, f_null,  f_null,   f_null,   f_table, f_null,   f_null,        f_null,
                                               f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
            m->place_items("office", 75, 19, 1, 19, 3, false, 0);
            m->place_items("office", 75, 17, 3, 18, 3, false, 0);
            m->place_items("office", 90, 8, 7, 9, 7, false, 0);
            m->place_items("cubical_office", 75, 19, 5, 19, 7, false, 0);
            m->place_items("cleaning", 80, 1, 7, 2, 7, false, 0);
            if (density > 1) {
                m->place_spawns("GROUP_ZOMBIE", 2, 0, 0, 14, 10, density);
            } else {
                m->add_spawn("mon_zombie", rng(0, 15), 14, 10);
                if (x_in_y(1, 2)) {
                    m->add_spawn("mon_zombie_cop", 2, 10, 10);
                }
            }
            {
                int num_chairs = rng(0, 6);
...
...DEEE|.R.|..|.....V%ss\n",
                                       ...
                                       mapf::basic_bind("E > R # X G C , _ r V H 6 x % ^ . - | t + = D w T S e o h c d l s", f_null,
                                               ...
                                               f_indoor_plant, f_null,  f_null,   f_null,   f_table, f_null,   f_null,        f_null,
                                               f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
            m->spawn_item(18, 15, "record_accounting");
            m->place_items("cleaning", 75, 3, 5, 5, 5, false, 0);
            m->place_items("office", 75, 10, 7, 16, 8, false, 0);
            m->place_items("cubical_office", 75, 15, 15, 19, 15, false, 0);
            m->place_items("cubical_office", 75, 16, 12, 16, 13, false, 0);
            m->place_items("cubical_office", 75, 17, 19, 19, 19, false, 0);
            m->place_items("office", 75, 17, 21, 19, 21, false, 0);
            m->place_items("office", 75, 16, 11, 17, 12, false, 0);
            m->place_items("cleaning", 75, 8, 20, 10, 20, false, 0);
            if (density > 1) {
                m->place_spawns("GROUP_ZOMBIE", 2, 0, 0, 9, 15, density);
            } else {
                m->add_spawn("mon_zombie", rng(0, 5), 9, 15);
            }
            {
                int num_chairs = rng(0, 6);
                for( int i = 0; i < num_chairs; i++ ) {
...
ssssssssssssssssssssssss\n",
        ...
        if (density > 1) {
            ...
            m->add_spawn("mon_zombie", rng(0, 5), SEEX * 2 - 1, SEEX * 2 - 1);
        }
...
sss|........|.R.|EEED___\n",
            ...
            if (dat.west() == "office_tower_b_entrance") {
                m->rotate(1);
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 17, 7, 180);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("motorcycle", 17, 13, 180);
                }
                if (x_in_y(1, 5)) {
                    if (one_in(3)) {
                        m->add_vehicle ("fire_truck", 6, 13, 0);
                        }
                    else
                    m->add_vehicle ("pickup", 17, 19, 180);
                }
            } else if (dat.north() == "office_tower_b_entrance") {
                m->rotate(2);
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 10, 17, 270);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("motorcycle", 4, 18, 270);
                }
                if (x_in_y(1, 5)) {
                    if (one_in(3)) {
                        m->add_vehicle ("fire_truck", 6, 13, 0);
                    ...
                    m->add_vehicle ("pickup", 16, 17, 270);
                }
            } else if (dat.east() == "office_tower_b_entrance") {
                m->rotate(3);
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 6, 4, 0);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("motorcycle", 6, 10, 180);
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("pickup", 6, 16, 0);
                }

            } else {
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("pickup", 7, 6, 90);
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 14, 6, 90);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("motorcycle", 19, 6, 90);
                }
            }
        }
...
ssssssssssssssssssssssss\n",
            ...
            if (dat.north() == "office_tower_b_entrance") {
                m->rotate(1);
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 8, 15, 0);
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("pickup", 7, 10, 180);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("beetle", 7, 3, 0);
                }
            } else if (dat.east() == "office_tower_b_entrance") {
                m->rotate(2);
                if (x_in_y(1, 5)) {
                    ...
                    m->add_vehicle ("pickup", 7, 7, 270);
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 13, 8, 90);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("beetle", 20, 7, 90);
                }
            } else if (dat.south() == "office_tower_b_entrance") {
                m->rotate(3);
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("pickup", 16, 7, 0);
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 15, 13, 180);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("beetle", 15, 20, 180);
                }
            } else {
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("pickup", 16, 16, 90);
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("car", 9, 15, 270);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("beetle", 4, 16, 270);
                }
            }
        }
...
___DEEE|.R.|...,,...|sss\n",
            ...
            if (dat.west() == "office_tower_b" && dat.north() == "office_tower_b") {
                ...
                if (x_in_y(1, 5)) {
                    if (one_in(3)) {
                        m->add_vehicle ("cube_van", 17, 4, 180);
                    } else {
                        m->add_vehicle ("cube_van_cheap", 17, 4, 180);
                    }
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("pickup", 17, 10, 180);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("car", 17, 17, 180);
                }
            } else if (dat.east() == "office_tower_b" && dat.north() == "office_tower_b") {
                m->rotate(2);
                if (x_in_y(1, 5)) {
                    if (one_in(3)) {
                        m->add_vehicle ("cube_van", 6, 17, 270);
                    } else {
                        m->add_vehicle ("cube_van_cheap", 6, 17, 270);
                    }
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("pickup", 12, 17, 270);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("fire_truck", 18, 17, 270);
                }
            } else if (dat.east() == "office_tower_b" && dat.south() == "office_tower_b") {
                m->rotate(3);
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("cube_van_cheap", 6, 6, 0);
                }
                if (x_in_y(1, 5)) {
                    if (one_in(3)) {
                        m->add_vehicle ("fire_truck", 6, 13, 0);
                    } else {
                        m->add_vehicle ("pickup", 6, 13, 0);
                    }
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("car", 5, 19, 180);
                }
            } else {
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("flatbed_truck", 16, 6, 90);
                }
                if (x_in_y(1, 5)) {
                    m->add_vehicle ("cube_van_cheap", 10, 6, 90);
                }
                if (x_in_y(1, 3)) {
                    m->add_vehicle ("car", 4, 6, 90);
                }
            }
        }
}
...
ssssssssssssssssssssssss\n",
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_bench) {
                    m->place_items("church", 10,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_locker) {
                    m->place_items("jackets", 60,  i,  j, i,  j, false, 0);
                }
                if (m->ter(i, j) == t_window_stained_red) {
                    if (one_in(3)) {
                        m->ter_set(i, j, t_window_stained_blue);
                    } else if (one_in(3)) {
                        m->ter_set(i, j, t_window_stained_green);
                    }
                }
            }
        }
        if (density > 1) {
            ...
            m->place_spawns("GROUP_ZOMBIE", 2, 0, 0, 23, 23, .20);
        }
        if (dat.north() == "cathedral_1" && dat.west() == "cathedral_1") {
            m->rotate(3);
        } else if (dat.north() == "cathedral_1" && dat.east() == "cathedral_1") {
            m->rotate(0);
        } else if (dat.south() == "cathedral_1" && dat.east() == "cathedral_1") {
            m->rotate(1);
        } else if (dat.west() == "cathedral_1" && dat.south() == "cathedral_1") {
            m->rotate(2);
        }
...
*/
        ...
        // Init to grass & dirt;
        dat.fill_groundcover();
        if ((dat.south() == "cathedral_1_entrance" && dat.east() == "cathedral_1") || (dat.north() == "cathedral_1" &&
                dat.east() == "cathedral_1_entrance") || (dat.west() == "cathedral_1" &&
                        dat.north() == "cathedral_1_entrance") ||
            (dat.south() == "cathedral_1" && dat.west() == "cathedral_1_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
                  ##    \n\
                 ###wwww\n\
...
ss          #bbbb...bbbb\n",
            ...
            if (dat.west() == "cathedral_1_entrance") {
                m->rotate(1);
            }
            if (dat.north() == "cathedral_1_entrance") {
                m->rotate(2);
            }
            if (dat.east() == "cathedral_1_entrance") {
                m->rotate(3);
            }
        }

        else if ((dat.west() == "cathedral_1_entrance" && dat.north() == "cathedral_1") ||
                 (dat.north() == "cathedral_1_entrance" && dat.east() == "cathedral_1") || (dat.west() == "cathedral_1" &&
                         dat.south() == "cathedral_1_entrance") ||
                 (dat.south() == "cathedral_1" && dat.east() == "cathedral_1_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
..........##          ss\n\
bbb...bbbb##          ss\n\
...
ssssssssssssssssssssssss\n",
            ...
            if (dat.south() == "cathedral_1_entrance") {
                m->rotate(3);
            }
        }
...
bbb...bbbb#           ss\n",
            ...
            if (dat.west() == "cathedral_1" && dat.north() == "cathedral_1") {
                m->rotate(1);
            } else if (dat.east() == "cathedral_1" && dat.north() == "cathedral_1") {
                m->rotate(2);
            } else if (dat.east() == "cathedral_1" && dat.south() == "cathedral_1") {
                m->rotate(3);
            }
        }
...
########################\n",
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_desk) {
                    m->place_items("school", 50,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_rack) {
                    m->place_items("cleaning", 70,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_rack) {
                    m->place_items("cleaning", 50,  i,  j, i,  j, false, 0);
                }
        ...
        if (dat.north() == "cathedral_b" && dat.west() == "cathedral_b") {
            m->rotate(3);
        } else if (dat.north() == "cathedral_b" && dat.east() == "cathedral_b") {
            m->rotate(0);
        } else if (dat.south() == "cathedral_b" && dat.east() == "cathedral_b") {
            m->rotate(1);
        } else if (dat.west() == "cathedral_b" && dat.south() == "cathedral_b") {
            m->rotate(2);
        }
...
*/
        ...
        // Init to grass & dirt;
        dat.fill_groundcover();
        if ((dat.south() == "cathedral_b_entrance" && dat.east() == "cathedral_b") || (dat.north() == "cathedral_b" &&
                dat.east() == "cathedral_b_entrance") || (dat.west() == "cathedral_b" &&
                        dat.north() == "cathedral_b_entrance") ||
            (dat.south() == "cathedral_b" && dat.west() == "cathedral_b_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
########################\n\
########################\n\
            ...
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_fridge) {
                        ...
                        m->place_items("oven", 70,  i,  j, i,  j, false, 0);
                    } else if (m->furn(i, j) == f_table) {
                        m->place_items("fridgesnacks", 40,  i,  j, i,  j, false, 0);
                    } else if (m->furn(i, j) == f_rack) {
                        m->place_items("cannedfood", 40,  i,  j, i,  j, false, 0);
                    }
                }
            }
            m->add_spawn("mon_blank", rng(1, 3), 23, 5);
            if (dat.west() == "cathedral_b_entrance") {
                m->rotate(1);
            } else if (dat.north() == "cathedral_b_entrance") {
                m->rotate(2);
            } else if (dat.east() == "cathedral_b_entrance") {
                m->rotate(3);
            }
        }

        else if ((dat.west() == "cathedral_b_entrance" && dat.north() == "cathedral_b") ||
                 (dat.north() == "cathedral_b_entrance" && dat.east() == "cathedral_b") || (dat.west() == "cathedral_b" &&
                         dat.south() == "cathedral_b_entrance") ||
                 (dat.south() == "cathedral_b" && dat.east() == "cathedral_b_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
.|..|+|D|+|#############\n\
.|..|T|T|T|#############\n\
...
########################\n",
            ...
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    ...
                    if (m->furn(i, j) == f_table) {
                        m->place_items("office", 30,  i,  j, i,  j, false, 0);
                    }
                }
            }
            if (density > 1) {
            ...
            if (dat.north() == "cathedral_b_entrance") {
                m->rotate(1);
            } else if (dat.east() == "cathedral_b_entrance") {
                m->rotate(2);
            } else if (dat.south() == "cathedral_b_entrance") {
                m->rotate(3);
            }
        }
...
.+........|#############\n",
                                       ...
                                       mapf::basic_bind("O E > < # X G C , _ r V H 6 x ^ . - | t + = D w T S e o h c d l s", f_oven,
                                               ...
                                               f_null,                 f_null,               f_toilet, f_sink,  f_fridge, f_null,   f_chair,
                                               f_counter, f_desk,  f_locker, f_null));
            m->spawn_item(0, 3, "small_relic");
            m->add_spawn("mon_blank", rng(1, 3), 0, 5);
            if (dat.west() == "cathedral_b" && dat.north() == "cathedral_b") {
                m->rotate(1);
            } else if (dat.east() == "cathedral_b" && dat.north() == "cathedral_b") {
                m->rotate(2);
            } else if (dat.east() == "cathedral_b" && dat.south() == "cathedral_b") {
                m->rotate(3);
            }
        }
}
 ...
 fFFF_________FFF|----|.\n\
    ...
    ____________________\n",
                                   ...
                                   mapf::basic_bind("P C G , _ r f F 6 x $ ^ . - | t + = D w T S e o h c d l s", f_pool_table,
                                           ...
                                           f_null,              f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,
                                           f_locker, f_null));
        m->place_items("bigtools", 80,  18, 7, 21,  7, false, 0);
        m->place_items("office", 80,  18,  11, 20,  11, false, 0);
        m->place_items("office", 60,  18,  13, 18,  13, false, 0);
        m->place_spawns("GROUP_PUBLICWORKERS", 1, 0, 0, SEEX * 2 - 1, SEEX * 2 - 1, 0.2);
        if (dat.north() == "public_works" && dat.west() == "public_works") {
            m->rotate(3);
        } else if (dat.north() == "public_works" && dat.east() == "public_works") {
            m->rotate(0);
        } else if (dat.south() == "public_works" && dat.east() == "public_works") {
            m->rotate(1);
        } else if (dat.west() == "public_works" && dat.south() == "public_works") {
            m->rotate(2);
        }
...
*/
        ...
        // Init to grass & dirt;
        dat.fill_groundcover();
        if ((dat.south() == "public_works_entrance" && dat.east() == "public_works") ||
            (dat.north() == "public_works" && dat.east() == "public_works_entrance") || (dat.west() == "public_works" &&
                    dat.north() == "public_works_entrance") ||
            (dat.south() == "public_works" && dat.west() == "public_works_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
                        \n\
 |---------------|FFFFFF\n\
 ...
 f  ____________________\n",
                                       ...
                                       mapf::basic_bind("P C G , _ r f F 6 x $ ^ . - | t + = D w T S e o h c d l s", f_pool_table,
                                               ...
                                               f_null,              f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,
                                               f_locker, f_null));
            m->place_items("hardware", 85,  2, 3, 2,  8, false, 0);
            m->place_items("hardware", 85,  6,  2, 13,  2, false, 0);
            m->spawn_item(21, 2, "log", rng(1, 3));
            m->spawn_item(15, 2, "pipe", rng(1, 10));
            m->spawn_item(4, 2, "glass_sheet", rng(1, 7));
            m->spawn_item(16, 5, "2x4", rng(1, 20));
            m->spawn_item(16, 7, "2x4", rng(1, 20));
            m->spawn_item(12, 2, "nail");
            m->spawn_item(13, 2, "nail");
            m->spawn_item(14, 2, "material_sand", rng(1, 10));
            m->place_spawns("GROUP_PUBLICWORKERS", 1, 0, 0, SEEX * 2 - 1, SEEX * 2 - 1, 0.1);
            if (dat.west() == "public_works_entrance") {
                m->rotate(1);
            }
            if (dat.north() == "public_works_entrance") {
                m->rotate(2);
            }
            if (dat.east() == "public_works_entrance") {
                m->rotate(3);
            }
        }

        else if ((dat.west() == "public_works_entrance" && dat.north() == "public_works") ||
                 (dat.north() == "public_works_entrance" && dat.east() == "public_works") || (dat.west() == "public_works" &&
                         dat.south() == "public_works_entrance") ||
                 (dat.south() == "public_works" && dat.east() == "public_works_entrance")) {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
__________           f  \n\
__________           f  \n\
...
____sss                 \n",
                                       ...
                                       mapf::basic_bind("P C G , _ r f F 6 x $ ^ . - | t + = D w T S e o h c d l s", f_pool_table,
                                               ...
                                               f_null,              f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,
                                               f_locker, f_null));
            m->place_items("fridge", 80,  5, 8, 5,  8, false, 0);
            m->place_items("pool_table", 80,  13,  6, 15,  7, false, 0);
            m->place_items("construction_worker", 90,  3, 10, 10,  10, false, 0);
            m->place_items("office", 80,  15,  19, 17,  19, false, 0);
            m->place_items("cleaning", 80,  17,  16, 17,  16, false, 0);
            m->place_spawns("GROUP_PUBLICWORKERS", 1, 0, 0, SEEX * 2 - 1, SEEX * 2 - 1, 0.3);
            if (dat.north() == "public_works_entrance") {
                m->rotate(1);
            }
            if (dat.east() == "public_works_entrance") {
            ...
            if (dat.south() == "public_works_entrance") {
                m->rotate(3);
            }
        }
...
__________           f  \n",
                                       ...
                                       mapf::basic_bind("O P C G , _ r f F 6 x $ ^ . - | t + = D w T S e o h c d l s", f_null,
                                               ...
                                               f_counter, f_desk,  f_locker, f_null));
            m->place_items("tools", 85,  14, 18, 17,  18, false, 0);
            m->place_items("tools", 85,  17,  20, 17,  21, false, 0);
            m->place_items("tools", 85,  12,  20, 12,  21, false, 0);
            m->place_items("mechanics", 85,  21, 12, 21,  15, false, 0);
            m->place_items("mechanics", 85,  21,  4, 21,  7, false, 0);
            m->place_items("mechanics", 85,  14,  9, 16,  9, false, 0);
            m->place_items("electronics", 80,  16,  2, 18,  2, false, 0);
            m->place_items("cleaning", 85,  12,  2, 13,  2, false, 0);
            m->spawn_item(3, 2, "log", rng(1, 3));
            m->place_spawns("GROUP_PUBLICWORKERS", 1, 0, 0, SEEX * 2 - 1, SEEX * 2 - 1, 0.1);
            if (dat.west() == "public_works" && dat.north() == "public_works") {
                m->rotate(1);
                if (x_in_y(2, 3)) {
                int roller_check=rng(0,100);
                    if (roller_check < 75) {
                        m->add_vehicle ("flatbed_truck", 2, 0, 90);
                    } else {
                        m->add_vehicle ("road_roller", 2, 0, 90);
                    }
                }
            } else if (dat.east() == "public_works" && dat.north() == "public_works") {
                m->rotate(2);
                if (x_in_y(2, 3)) {
                int roller_check=rng(0,100);
                    if (roller_check < 75) {
                        m->add_vehicle ("flatbed_truck", 23, 10, 270);
                    } else {
                        m->add_vehicle ("road_roller", 23, 10, 270);
                    }
                }
            } else if (dat.east() == "public_works" && dat.south() == "public_works") {
                m->rotate(3);
                if (x_in_y(2, 3)) {
                int roller_check=rng(0,100);
                    if (roller_check < 75) {
                        m->add_vehicle ("flatbed_truck", 10, 23, 0);
                    } else {
                        m->add_vehicle ("road_roller", 10, 23, 0);
                    }
                }
            } else {
                if (x_in_y(2, 3)) {
                int roller_check=rng(0,100);
                  if (roller_check < 75) {
                        m->add_vehicle ("flatbed_truck", 0, 10, 90);
                    } else {
                        m->add_vehicle ("road_roller", 0, 10, 90);
                    }
                }
            }
        }
...
ssssssssssssssssssssssss\n",
        ...
        m->add_spawn("mon_zombie_child", rng(20, 60), SEEX, SEEY);
        if (dat.north() == "school_2") {
            m->rotate(3);
        } else if (dat.east() == "school_2") {
            m->rotate(0);
        } else if (dat.south() == "school_2") {
            m->rotate(1);
        } else if (dat.west() == "school_2") {
            m->rotate(2);
        }
...
ssssssssssssssssssssssss\n",
                                   ...
                                   mapf::basic_bind("_ L O f G x $ ^ . - | # t + = D w T S e o h c d l s", f_null,     f_null,
                                           ...
                                           f_null,   f_bench, f_table, f_null,   f_null,              f_null,        f_null,   f_toilet,
                                           f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
        m->add_spawn("mon_zombie_child", rng(5, 20), SEEX, SEEY);
        m->add_spawn("mon_zombie", rng(0, 8), SEEX, SEEY);
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_desk) {
                    m->place_items("office", 50,  i,  j, i,  j, false, 0);
                } else if (m->furn(i, j) == f_locker) {
                    m->place_items("school", 60,  i,  j, i,  j, false, 0);
                }
            }
        }
        if (dat.north() == "school_5") {
            m->rotate(0);
        } else if (dat.east() == "school_5") {
            m->rotate(1);
        } else if (dat.south() == "school_5") {
            m->rotate(2);
        } else if (dat.west() == "school_5") {
            m->rotate(3);
        }
...
sssssssss_______ssssssss\n",
                                   ...
                                   mapf::basic_bind("_ L O f G x $ ^ . - | # t + = D w T S e o h c d l s", f_null,     f_null,
                                           ...
                                           f_null,   f_bench, f_table, f_null,   f_null,              f_null,        f_null,   f_toilet,
                                           f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
        m->add_spawn("mon_zombie_child", rng(0, 8), SEEX, SEEY);
        if (dat.north() == "school_2") {
            m->rotate(1);
            if (x_in_y(1, 7)) {
                m->add_vehicle ("schoolbus", 19, 10, 0);
            }
            else if (one_in(5)) {
                m->add_vehicle ("fire_truck", 19, 10, 0);
                }
        } else if (dat.east() == "school_2") {
            m->rotate(2);
            if (x_in_y(1, 7)) {
                m->add_vehicle ("schoolbus", 9, 7, 0);
            }
            else if (one_in(5)) {
                m->add_vehicle ("fire_truck", 9, 7, 0);
                }
        } else if (dat.south() == "school_2") {
            m->rotate(3);
            if (x_in_y(1, 7)) {
                m->add_vehicle ("schoolbus", 12, 18, 180);
            }
            else if (one_in(5)) {
                m->add_vehicle ("fire_truck", 12, 18, 180);
                }
        } else if (dat.west() == "school_2") {
            m->rotate(0);
            if (x_in_y(1, 7)) {
                m->add_vehicle ("schoolbus", 17, 7, 0);
            }
            else if (one_in(5)) {
                m->add_vehicle ("fire_truck", 17, 7, 0);
                }
        }
...
*/
 ...
 |l..ttt..|.............\n",
                                   ...
                                   mapf::basic_bind("_ L O f G x $ ^ . - | # t + = D w T S e o h c d l s", f_null,     f_null,
                                           ...
                                           f_null,   f_bench, f_table, f_null,   f_null,              f_null,        f_null,   f_toilet,
                                           f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
        m->add_spawn("mon_zombie_child", rng(0, 20), SEEX, SEEY);
        m->add_spawn("mon_zombie", rng(0, 4), SEEX, SEEY);
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_desk) {
                    m->place_items("school", 50,  i,  j, i,  j, false, 0);
...
........l|l.l|^...ccl|$ \n",
                                   ...
                                   mapf::basic_bind("_ L O f G x $ ^ . - | # t + = D w T S e o h c d l s", f_null,     f_null,
                                           ...
                                           f_null,   f_bench, f_table, f_null,   f_null,              f_null,        f_null,   f_toilet,
                                           f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
        m->add_spawn("mon_zombie_child", rng(0, 15), SEEX, SEEY);
        m->add_spawn("mon_zombie", rng(0, 4), SEEX, SEEY);
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_desk) {
                    ...
                    m->place_items("novels", 50,  i,  j, i,  j, false, 0);
                    m->place_items("manuals", 40,  i,  j, i,  j, false, 0);
                    m->place_items("textbooks", 30,  i,  j, i,  j, false, 0);
                }
            }
        }
        if (dat.north() == "school_2") {
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_desk) {
                    ...
                    m->place_items("chem_school", 60,  i,  j, i,  j, false, 0);
                }
            }
        }
        if (dat.north() == "school_8") {
            m->rotate(3);
        } else if (dat.east() == "school_8") {
            m->rotate(0);
        } else if (dat.south() == "school_8") {
            m->rotate(1);
        } else if (dat.west() == "school_8") {
            m->rotate(2);
        }
...
|....................+.l\n",
                                   ...
                                   mapf::basic_bind("_ L O f G x $ ^ . - | # t + = D w T S e o h c d l s", f_null,     f_null,
                                           ...
                                           f_null,   f_bench, f_table, f_null,   f_null,              f_null,        f_null,   f_toilet,
                                           f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
        m->add_spawn("mon_zombie_child", rng(0, 4), SEEX, SEEY);
        m->add_spawn("mon_zombie", rng(0, 1), SEEX, SEEY);
        m->place_items("cleaning", 80,  22, 23, 23,  23, false, 0);
        m->spawn_item(12, 15, "american_flag");
        if (dat.north() == "school_5") {
            m->rotate(2);
        } else if (dat.east() == "school_5") {
            m->rotate(3);
...
|h.h.h.h.|....|.h.h.h.hw\n",
                                   ...
                                   mapf::basic_bind("e r _ L O f G x $ ^ . - | # t + = D w T S e o h c d l s", f_fridge, f_rack,
                                           ...
                                           f_locker, f_null));
        m->add_spawn("mon_zombie_child", rng(0, 20), SEEX, SEEY);
        m->add_spawn("mon_zombie", rng(3, 10), SEEX, SEEY);
        m->place_items("cleaning", 80,  15,  15, 15,  15, false, 0);
        m->place_items("cannedfood", 95,  17,  15, 17,  15, false, 0);
        m->place_items("fast_food", 95,  18,  11, 19,  12, false, 0);
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_desk) {
                    m->place_items("school", 50,  i,  j, i,  j, false, 0);
                    ...
                    m->place_items("fridge", 90,  i,  j, i,  j, false, 0);
                }
            }
        }
        if (dat.north() == "school_8") {
...
*/
 ...
 %%%%%%%%%%%%%%%%%%%%%%%\n\
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_bed) {
                    m->place_items("novels", 30,  i,  j, i,  j, false, 0);
                    m->place_items("contraband", 10,  i,  j, i,  j, false, 0);
                    m->place_items("bed", 50,  i,  j, i,  j, false, 0);
                    if (!one_in(3)) {
                        m->add_spawn("mon_zombie", rng(0, 1), i, j);
                    } else {
                        m->add_spawn("mon_zombie_brute", rng(0, 1), i, j);
                    }
                }
            }
        }
        if (dat.north() == "prison_2") {
            m->rotate(3);
        } else if (dat.east() == "prison_2") {
            m->rotate(0);
        } else if (dat.south() == "prison_2") {
            m->rotate(1);
        } else if (dat.west() == "prison_2") {
            m->rotate(2);
        }
...
%%%%%%%%%______%%%%%%%%%\n\
    ...
    |www|______         \n\
        ...
        m->add_spawn("mon_eyebot", 1, rng(5, 18), rng(12, 18));
        if (dat.north() == "prison_5") {
            m->rotate(0);
        } else if (dat.east() == "prison_5") {
            m->rotate(1);
        } else if (dat.south() == "prison_5") {
            m->rotate(2);
        } else if (dat.west() == "prison_5") {
            m->rotate(3);
        }
...
,,|ss______________ss|,,\n",
                                   ...
                                   mapf::basic_bind("< # E g r + = h c l w s _ o d x T b G , B - | % f F S", f_null,        f_bench,
                                           ...
                                           f_null,            f_null,  f_null, f_null,       f_null,       f_null,         f_null,
                                           f_null,         f_sink));
        m->add_spawn("mon_secubot", rng(1, 2), 11, 7);
        m->add_spawn("mon_zombie_cop", rng(0, 3), rng(12, 18), rng(4, 19));
        m->place_items("prison_weapons", 30,  11,  1, 12,  1, false, 0);
        m->place_items("prison_armor", 50,  11,  1, 12,  1, false, 0);
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_bed) {
                    m->place_items("novels", 30,  i,  j, i,  j, false, 0);
                ...
                if (m->furn(i, j) == f_desk) {
                    m->place_items("magazines", 40,  i,  j, i,  j, false, 0);
                    m->place_items("office", 40,  i,  j, i,  j, false, 0);
                }
            }
        }
        if (dat.north() == "prison_2") {
...
*/
 ...
 %  F    |T,,,B,,,,,,B,,\n",
        ...
        if (dat.north() == "prison_8") {
            m->rotate(3);
        } else if (dat.east() == "prison_8") {
            m->rotate(0);
        } else if (dat.south() == "prison_8") {
            m->rotate(1);
        } else if (dat.west() == "prison_8") {
            m->rotate(2);
        }
...
bb|o,,,,|,,,,,l|,,,,,|bb\n",
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                ...
                if (m->ter(i, j) == t_sidewalk) {
                    if (one_in(200)) {
                        if (!one_in(3)) {
                            m->add_spawn("mon_zombie", 1, i, j);
                        } else {
                            m->add_spawn("mon_zombie_brute", 1, i, j);
                        }
                    }
                }
                if (m->furn(i, j) == f_locker) {
                    m->place_items("softdrugs", 40,  i,  j, i,  j, false, 0);
                    m->place_items("harddrugs", 40,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_bookcase) {
                    m->place_items("novels", 70,  i,  j, i,  j, false, 0);
                }
            }
        }
        if (dat.north() == "prison_5") {
...
########################\n",
            ...
            if (dat.south() == "prison_b_entrance") {
                m->rotate(1);
            } else if (dat.west() == "prison_b_entrance") {
                m->rotate(2);
            } else if (dat.north() == "prison_b_entrance") {
                m->rotate(3);
            }
        }

        if (dat.t_above == "prison_3") {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
####|,,|################\n\
####|,,|################\n\
...
########################\n",
                                       ...
                                       mapf::basic_bind("# E g r + = h c l w s _ o d x T b G . , B - | % f F S", f_null, f_exercise,
                                               ...
                                               f_null,  f_null,  f_null, f_null,       f_null,       f_null,         f_null,         f_null,
                                               f_sink));
            if (dat.north() == "prison_b_entrance") {
                m->rotate(1);
            } else if (dat.east() == "prison_b_entrance") {
                m->rotate(2);
            } else if (dat.south() == "prison_b_entrance") {
                m->rotate(3);
            }
        }

        if (dat.t_above == "prison_4") {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
############|,,,+,,|#|--\n\
############|---|,,|#|,,\n\
...
#########|,,,,G,,,,,,G,,\n",
            ...
            if (dat.north() != "prison_b") {
                m->rotate(1);
            } else if (dat.east() != "prison_b") {
                m->rotate(2);
            } else if (dat.south() != "prison_b") {
                m->rotate(3);
            }
        }

        if (dat.t_above == "prison_5") {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
--|t,,,,|------|c,,,,|--\n\
,>|h,,,,G,,rr,cB,,,,,|>,\n\
...
,,|,,,,,,,,,,,,,,,,,,|##\n",
            ...
            m->add_spawn("mon_zombie_cop", rng(0, 2), 2, 0);
            m->add_spawn("mon_zombie_cop", rng(0, 2), 2, 23);
            m->place_items("prison_weapons", 30,  11,  1, 12,  1, false, 0);
            m->place_items("prison_armor", 40,  11,  1, 12,  1, false, 0);
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_chair) {
                        if (one_in(4)) {
                            if (!one_in(3)) {
                                m->add_spawn("mon_zombie", 1, i, j);
                            } else if (one_in(10)) {
                                m->add_spawn("mon_zombie_cop", 1, i, j);
                            } else {
                                m->add_spawn("mon_zombie_brute", 1, i, j);
                            }
                        }
...
####|,,|################\n",
                                       ...
                                       mapf::basic_bind("D W # t g r + = h c l w s _ o d x T b G . , B - | % f F S", f_dryer, f_washer,
                                               ...
                                               f_toilet, f_bed,   f_null,            f_null,  f_null,  f_null, f_null,       f_null,       f_null,
                                               f_null,         f_null,         f_sink));
            m->spawn_item(7, 11, "visions_solitude");
            m->add_spawn("mon_zombie_brute", 1, 6, 13);
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_locker || m->furn(i, j) == f_rack ) {
                        m->place_items("science", 30,  i,  j, i,  j, false, 0);
                        m->place_items("cleaning", 30,  i,  j, i,  j, false, 0);
                    }
                }
            }
            if (dat.south() != "prison_b") {
                m->rotate(1);
            } else if (dat.west() != "prison_b") {
                m->rotate(2);
            } else if (dat.north() != "prison_b") {
                m->rotate(3);
            }
        }

        else if (dat.t_above == "prison_7") {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
########################\n\
########################\n\
...
############|rrr|,,|####\n",
            ...
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_locker || m->furn(i, j) == f_rack ) {
                        m->place_items("cleaning", 60,  i,  j, i,  j, false, 0);
                    }
                }
            }
            if (dat.west() == "prison_b" && dat.south() == "prison_b") {
                m->rotate(1);
            } else if (dat.north() == "prison_b" && dat.west() == "prison_b") {
                m->rotate(2);
            } else if (dat.north() == "prison_b" && dat.east() == "prison_b") {
                m->rotate(3);
            }
        } else if (dat.t_above == "prison_8") {
            mapf::formatted_set_simple(m, 0, 0,
                                       "\
########################\n\
########################\n\
...
##|t,,,,|cScScc|o,,,,,,,\n",
                                       ...
                                       mapf::basic_bind("t e o > O # E g r + = h c l w s _ d x T b G . , B - | % f F S", f_table, f_fridge,
                                               ...
                                               f_toilet, f_bed,   f_null,            f_null,  f_null,  f_null, f_null,       f_null,       f_null,
                                               f_null,         f_null,         f_sink));
            m->add_spawn("mon_zombie_cop", rng(0, 2), 12, 19);
            if (dat.east() != "prison_b") {
                m->rotate(1);
            } else if (dat.south() != "prison_b") {
                m->rotate(2);
            } else if (dat.west() != "prison_b") {
...
,,|-------|#############\n",
            ...
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_rack) {
                        m->place_items("cannedfood", 40,  i,  j, i,  j, false, 0);
                        m->place_items("pasta", 40,  i,  j, i,  j, false, 0);
                    }
                }
            }
            if (dat.north() == "prison_b" && dat.west() == "prison_b") {
                m->rotate(1);
            } else if (dat.north() == "prison_b" && dat.east() == "prison_b") {
                m->rotate(2);
            } else if (dat.south() == "prison_b" && dat.east() == "prison_b") {
                m->rotate(3);
            }
        }
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_toilet) {
                    if (one_in(3)) {
                        m->add_spawn("mon_zombie_brute", rng(0, 1), i, j);
                    } else if (one_in(3)) {
                        m->add_spawn("mon_zombie_grabber", rng(0, 1), i, j);
                    } else if (one_in(3)) {
                        m->add_spawn("mon_zombie_electric", rng(0, 1), i, j);
                    } else {
                        m->add_spawn("mon_zombie", rng(0, 1), i, j);
                    }
                }
                ...
                if (m->furn(i, j) == f_fridge) {
                    m->place_items("fridge", 60,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_locker) {
                    m->place_items("prison_weapons", 30,  i,  j, i,  j, false, 0);
                    m->place_items("prison_armor", 30,  i,  j, i,  j, false, 0);
                    m->place_items("cop_torso", 20,  i,  j, i,  j, false, 0);
                    m->place_items("cop_pants", 20,  i,  j, i,  j, false, 0);
                    m->place_items("cop_shoes", 20,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_washer || m->furn(i, j) == f_dryer) {
                    if (one_in(4)) {
                        m->spawn_item(i, j, "blanket", 3);
                    } else if (one_in(3)) {
                        m->spawn_item(i, j, "jumpsuit", 3);
                    }
                }
            }
        }
...
ssssssssssssssssssssssss\n",
        ...
        m->place_spawns("GROUP_ZOMBIE", 2, 6, 6, 18, 18, density);
        if (dat.north() == "hotel_tower_1_2") {
            m->rotate(3);
        } else if (dat.east() == "hotel_tower_1_2") {
            m->rotate(0);
        } else if (dat.south() == "hotel_tower_1_2") {
            m->rotate(1);
        } else if (dat.west() == "hotel_tower_1_2") {
            m->rotate(2);
        }
...
s________sssss________ss\n",
                                   ...
                                   mapf::basic_bind("_ , C x $ ^ . - | # t + = D w T S e o h c d l s", f_null,     f_null,
                                           ...
                                           f_chair, f_counter, f_dresser, f_locker, f_null));
        m->place_spawns("GROUP_ZOMBIE", 2, 0, 0, 23, 23, density);
        if (dat.north() == "hotel_tower_1_5") {
            m->rotate(0);
        } else if (dat.east() == "hotel_tower_1_5") {
            m->rotate(1);
        } else if (dat.south() == "hotel_tower_1_5") {
            m->rotate(2);
        } else if (dat.west() == "hotel_tower_1_5") {
            m->rotate(3);
        }
...
sssssssssssssssssssssss\n",
        ...
        if (dat.north() == "hotel_tower_1_2") {
            ...
            m->rotate(0);
            if (x_in_y(1, 12)) {
                m->add_vehicle ("car", 17, 7, 0);
            }
            else if (x_in_y(2, 9)) {
                m->add_vehicle ("fire_truck", 17, 7, 180);
                }
        }
...
s_____,_____,_____,_____\n",
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_dresser && x_in_y(1, 2)) {
                    m->place_items("dresser", 70,  i,  j, i,  j, false, 0);
                } else if (m->furn(i, j) == f_counter && x_in_y(1, 5)) {
                    m->place_items("magazines", 30,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_bed) {
                    m->place_items("bed", 60, i, j, i, j, false, 0);
...
,_____________________,_\n",
        ...
        if (density > 1) {
            ...
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_zombie", rng(1, 8), 12, 11);
            }
        }
        {
            int num_carts = rng(1, 3);
            for( int i = 0; i < num_carts; i++ ) {
                m->add_vehicle ("luggage_cart", rng(5, 18), rng(2, 12), 90, -1, -1, false);
            }
        }
        if (dat.north() == "hotel_tower_1_2") {
            m->rotate(2);
...
s    |c....|c....|c....|\n",
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_dresser && x_in_y(1, 2)) {
                    m->place_items("dresser", 70,  i,  j, i,  j, false, 0);
                } else if (m->furn(i, j) == f_counter) {
                    if (one_in(5)){
                        m->place_items("magazines", 30,  i,  j, i,  j, false, 0);
                    }
                    if (one_in(8)){
                        m->spawn_item(i, j, "coffee_raw", 2);
                        m->spawn_item(i, j, "coffeemaker", 1);
                    }
                } else if (m->furn(i, j) == f_sink && x_in_y(2, 5)) {
                    m->spawn_item(i, j, "towel", 3);
                }
                if (m->furn(i, j) == f_bed) {
                    m->place_items("bed", 60, i, j, i, j, false, 0);
                }
        ...
        if (density > 1) {
            ...
            m->add_spawn("mon_zombie", rng(0, 12), 14, 11);
        }
        if (dat.north() == "hotel_tower_1_8") {
            m->rotate(3);
        } else if (dat.east() == "hotel_tower_1_8") {
            m->rotate(0);
        } else if (dat.south() == "hotel_tower_1_8") {
            m->rotate(1);
        } else if (dat.west() == "hotel_tower_1_8") {
            m->rotate(2);
        }
...
c...d|t.........t|....c|\n",
        ...
        if (density > 1) {
            m->place_spawns("GROUP_ZOMBIE", 2, 0, 23, 23, 3, density);
        } else {
            m->add_spawn("mon_zombie", rng(1, 18), 12, 12);
        }
        if (dat.north() == "hotel_tower_1_5") {
            m->rotate(2);
        } else if (dat.east() == "hotel_tower_1_5") {
...
....c|....c|....c|    s \n",
        ...
        if (density > 1) {
            ...
            m->add_spawn("mon_zombie", rng(1, 8), 12, 12);
        }
        if (dat.north() == "hotel_tower_1_8") {
            m->rotate(1);
        } else if (dat.east() == "hotel_tower_1_8") {
...
#######################|\n",
        ...
        m->place_items("snacks", 60,  15,  2, 16,  2, false, 0);
        m->add_spawn("mon_sewer_snake", rng(0, 3), SEEX, SEEY);
        if (dat.north() == "hotel_tower_b_2") {
            m->rotate(3);
        } else if (dat.east() == "hotel_tower_b_2") {
            m->rotate(0);
        } else if (dat.south() == "hotel_tower_b_2") {
            m->rotate(1);
        } else if (dat.west() == "hotel_tower_b_2") {
            m->rotate(2);
        }
...
-----|-----------|-----|\n",
        ...
        m->add_spawn("mon_sewer_snake", rng(0, 10), SEEX, SEEY);
        if (dat.north() == "hotel_tower_b_1") {
            m->rotate(1);
        } else if (dat.east() == "hotel_tower_b_1") {
            m->rotate(2);
        } else if (dat.south() == "hotel_tower_b_1") {
            m->rotate(3);
        } else if (dat.west() == "hotel_tower_b_1") {
            m->rotate(0);
        }
...
########################\n",
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->furn(i, j) == f_rack) {
                    m->place_items("home_hw", 80,  i,  j, i,  j, false, 0);
                }
                if (m->furn(i, j) == f_washer || m->furn(i, j) == f_dryer) {
                    if (x_in_y(1, 2)) {
                        m->spawn_item(i, j, "blanket", 3);
                    } else if (x_in_y(1, 3)) {
                        m->place_items("dresser", 80,  i,  j, i,  j, false, 0);
                    }
                }
            }
        }
...
*/
        ...
        if (dat.zlevel == 0) { // We're on ground level
            ...
            line(m, t_chainfence_v, 1, 1, 1, SEEY * 2 - 1);
            line(m, t_chainfence_v, SEEX * 2 - 1, 1, SEEX * 2 - 1, SEEY * 2 - 1);
            line(m, t_chainfence_h, 1, SEEY * 2 - 1, SEEX * 2 - 1, SEEY * 2 - 1);
            line(m, t_chainfence_h, 1, 1, SEEX * 2 - 1, 1);
            line(m, t_chaingate_l, SEEX - 3, SEEY * 2 - 1, SEEX + 2, SEEY * 2 - 1);
            line(m, t_chaingate_l, 1, SEEY * 2 - 2, 1, SEEY * 2 - 7);
            line(m, t_chaingate_l, SEEX * 2 - 1, SEEY * 2 - 2, SEEX * 2 - 1, SEEY * 2 - 7);
            //watch cabin
            //line(m, t_concrete_h, SEEX-6, SEEY*2-4, SEEX-4, SEEY*2-4);
            m->ter_set(2, 13, t_concrete_h);
            m->ter_set(4, 13, t_concrete_h);
            m->ter_set(3, 13, t_door_c);
            m->ter_set(4, 14, t_concrete_v);
            m->ter_set(4, 15, t_concrete_v);
            m->ter_set(1, 13, t_concrete_h);
            m->ter_set(3, 15, t_window);
            m->ter_set(2, 15, t_window);
            m->ter_set(1, 14, t_reinforced_glass_v);
            m->ter_set(1, 15, t_reinforced_glass_v);
            m->ter_set(2, 14, t_floor);
            m->ter_set(3, 14, t_floor);
            m->furn_set(2, 14, f_table);
            //watch cabin 2
            m->ter_set(SEEX * 2 - 2, 13, t_concrete_h);
            m->ter_set(SEEX * 2 - 4, 13, t_concrete_h);
            m->ter_set(SEEX * 2 - 3, 13, t_door_c);
            m->ter_set(SEEX * 2 - 4, 14, t_concrete_v);
            m->ter_set(SEEX * 2 - 4, 15, t_concrete_v);
            m->ter_set(SEEX * 2 - 1, 13, t_concrete_h);
            m->ter_set(SEEX * 2 - 3, 15, t_window);
            m->ter_set(SEEX * 2 - 2, 15, t_window);
            m->ter_set(SEEX * 2 - 1, 14, t_reinforced_glass_v);
            m->ter_set(SEEX * 2 - 1, 15, t_reinforced_glass_v);
            m->ter_set(SEEX * 2 - 2, 14, t_floor);
            m->ter_set(SEEX * 2 - 3, 14, t_floor);
            m->furn_set(SEEX * 2 - 2, 14, f_table);
            line(m, t_wall_metal_h,  7,  7, 16,  7);
            line(m, t_wall_metal_h,  8,  8, 15,  8);
            line(m, t_wall_metal_h,  8, 15, 15, 15);
            line(m, t_wall_metal_h,  7, 16, 10, 16);
            line(m, t_wall_metal_h, 14, 16, 16, 16);
            line(m, t_wall_metal_v,  7,  8,  7, 15);
            line(m, t_wall_metal_v, 16,  8, 16, 15);
            line(m, t_wall_metal_v,  8,  9,  8, 14);
            line(m, t_wall_metal_v, 15,  9, 15, 14);
            square(m, t_floor, 9, 10, 14, 14);
            line(m, t_stairs_down,  11,  9, 12,  9);
            line(m, t_door_metal_locked, 11, 15, 12, 15);
            for (int i = 9; i <= 13; i += 2) {
                line(m, t_wall_metal_h,  9, i, 10, i);
                line(m, t_wall_metal_h, 13, i, 14, i);
                m->add_spawn("mon_turret_rifle", 1, 9, i + 1);
                m->add_spawn("mon_turret_rifle", 1, 14, i + 1);
            }
            m->ter_set(13, 16, t_card_military);

            if (is_ot_type("road", dat.west())) {
                m->rotate(1);
            } else if (is_ot_type("road", dat.north())) {
                m->rotate(2);
            } else if (is_ot_type("road", dat.east())) {
                m->rotate(3);
            }
        } else { // Below ground!

            fill_background(m, t_rock);
            square(m, t_floor, 1, 1, SEEX * 2 - 2, SEEY * 2 - 2);
            line(m, t_wall_metal_h,  2,  8,  8,  8);
            line(m, t_wall_metal_h, 15,  8, 21,  8);
            line(m, t_wall_metal_h,  2, 15,  8, 15);
            line(m, t_wall_metal_h, 15, 15, 21, 15);
            for (int j = 2; j <= 16; j += 7) {
                m->ter_set( 9, j    , t_card_military);
                m->ter_set(14, j    , t_card_military);
                m->ter_set( 9, j + 1, t_door_metal_locked);
                m->ter_set(14, j + 1, t_door_metal_locked);
                line(m, t_reinforced_glass_v,  9, j + 2,  9, j + 4);
                line(m, t_reinforced_glass_v, 14, j + 2, 14, j + 4);
                line(m, t_wall_metal_v,  9, j + 5,  9, j + 6);
                line(m, t_wall_metal_v, 14, j + 5, 14, j + 6);
                ...
                for (int i = 2; i <= 15; i += 13) {
                    ...
                    m->place_items(goods, size, i, j, i + 6, j + 5, false, 0);
                      if (HW == 1) {
                        if (one_in(2)) {
                        m->spawn_item(i + 2, j + 1, "556", 2);
                        }
                        if (one_in(4)) {
                        m->spawn_item(i + 2, j + 1, "8mm_fmj", 2);
                        }
                        if (one_in(4)) {
                        m->spawn_item(i + 2, j + 1, "8mm_inc", 2);
                        }
                        if (one_in(5)) {
                        m->spawn_item(i + 2, j + 1, "20x66_flechette", 2);
                        }
                        if (one_in(5)) {
                        m->spawn_item(i + 2, j + 1, "40mm_concussive", 2);
                        }
                      }
                }
            }
            line(m, t_wall_metal_h, 1, 1, SEEX * 2 - 2, 1);
            line(m, t_wall_metal_h, 1, SEEY * 2 - 2, SEEX * 2 - 2, SEEY * 2 - 2);
            line(m, t_wall_metal_v, 1, 2, 1, SEEY * 2 - 3);
            line(m, t_wall_metal_v, SEEX * 2 - 2, 2, SEEX * 2 - 2, SEEY * 2 - 3);
            m->ter_set(SEEX - 1, 21, t_stairs_up);
            m->ter_set(SEEX,     21, t_stairs_up);
        }
...
*/
        ...
        line(m, t_chainfence_h,            0,            0, SEEX * 2 - 1,            0);
        line(m, t_chaingate_l,            11,            0,           12,            0);
        line(m, t_chainfence_h,            0, SEEY * 2 - 1, SEEX * 2 - 1, SEEY * 2 - 1);
        line(m, t_chaingate_l,            11, SEEY * 2 - 1,           12, SEEY * 2 - 1);
        line(m, t_chainfence_v,            0,            0,            0, SEEX * 2 - 1);
        line(m, t_chaingate_l,             0,           11,            0,           12);
        line(m, t_chainfence_v, SEEX * 2 - 1,            0, SEEX * 2 - 1, SEEY * 2 - 1);
        line(m, t_chaingate_l,  SEEX * 2 - 1,           11, SEEX * 2 - 1,           12);
        ...
        while (okay) {
            ...
            if( !dat.is_groundcover( m->ter( buildx, buildy ) ) ) {
                okay = false;
            } else {
                ...
                for(int x = bx1; x <= bx2 && !overlap; x++) {
                    for(int y = by1; y <= by2 && !overlap; y++) {
                        if( !dat.is_groundcover( m->ter( x, y ) ) ) {
                            overlap = true;
                        }
                    }
                }
                ...
                square(m, t_floor, bx1, by1, bx2, by2);
                line(m, t_concrete_h, bx1, by1, bx2, by1);
                line(m, t_concrete_h, bx1, by2, bx2, by2);
                line(m, t_concrete_v, bx1, by1, bx1, by2);
                line(m, t_concrete_v, bx2, by1, bx2, by2);
                switch (rng(1, 3)) {  // What type of building?
                case 1: // Barracks
                    for (int i = by1 + 1; i <= by2 - 1; i += 2) {
                        line_furn(m, f_bed, bx1 + 1, i, bx1 + 2, i);
                        line_furn(m, f_bed, bx2 - 2, i, bx2 - 1, i);
                        m->place_items("bed", 50, bx1 + 1, i, bx1 + 2, i, false, 0);
                        m->place_items("bed", 50, bx2 - 2, i, bx2 - 1, i, false, 0);
                    }
                    m->place_items("bedroom", 84, bx1 + 1, by1 + 1, bx2 - 1, by2 - 1, false, 0);
                    m->place_items("mil_books", 45, bx1 + 1, by1 + 1, bx2 - 1, by2 - 1, false, 0);
                    break;
                case 2: // Armory
                    line_furn(m, f_counter, bx1 + 1, by1 + 1, bx2 - 1, by1 + 1);
                    line_furn(m, f_counter, bx1 + 1, by2 - 1, bx2 - 1, by2 - 1);
                    line_furn(m, f_counter, bx1 + 1, by1 + 2, bx1 + 1, by2 - 2);
                    line_furn(m, f_counter, bx2 - 1, by1 + 2, bx2 - 1, by2 - 2);
                    m->place_items("mil_rifles", 40, bx1 + 1, by1 + 1, bx2 - 1, by1 + 1, false, 0);
                    m->place_items("launchers",  40, bx1 + 1, by2 - 1, bx2 - 1, by2 - 1, false, 0);
                    m->place_items("grenades",   40, bx1 + 1, by1 + 2, bx1 + 1, by2 - 2, false, 0);
                    m->place_items("mil_armor",  40, bx2 - 1, by1 + 2, bx2 - 1, by2 - 2, false, 0);
                    break;
                case 3: // Supplies
                    for (int i = by1 + 1; i <= by2 - 1; i += 3) {
                        line_furn(m, f_rack, bx1 + 2, i, bx2 - 2, i);
                        m->place_items("mil_food", 78, bx1 + 2, i, bx2 - 2, i, false, 0);
                    }
                    break;
                }
                ...
                for (int i = doorx - 1; i <= doorx + 1; i++) {
                    for (int j = doory - 1; j <= doory + 1; j++) {
                        m->i_clear(i, j);
                        if (m->furn(i, j) == f_bed || m->furn(i, j) == f_rack || m->furn(i, j) == f_counter) {
                            m->furn_set(i, j, f_null);
                        }
                    }
                }
                for( int i = -1; i <= +1; i += 2 ) {
                    ...
                    // -+- ==> -+-
                    // ...     ...
                    if( ( m->ter( doorx + i, doory ) == t_concrete_h || m->ter( doorx + i, doory ) == t_concrete_v ) &&
                        m->ter( doorx - i, doory ) == t_floor ) {
                        m->ter_set( doorx + i, doory, t_door_c );
                    }
                    if( ( m->ter( doorx, doory + i ) == t_concrete_h || m->ter( doorx, doory + i ) == t_concrete_v ) &&
                        m->ter( doorx, doory - i ) == t_floor ) {
                        m->ter_set( doorx, doory + i, t_door_c );
                    }
                }
                m->ter_set(doorx, doory, t_door_c);
            }
        }

        // Place turrets by (possible) entrances
        m->add_spawn("mon_turret_rifle", 1,  1, 11);
        m->add_spawn("mon_turret_rifle", 1,  1, 12);
        m->add_spawn("mon_turret_rifle", 1, SEEX * 2 - 2, 11);
        m->add_spawn("mon_turret_rifle", 1, SEEX * 2 - 2, 12);
        m->add_spawn("mon_turret_rifle", 1, 11,  1);
        m->add_spawn("mon_turret_rifle", 1, 12,  1);
        m->add_spawn("mon_turret_rifle", 1, 11, SEEY * 2 - 2);
        m->add_spawn("mon_turret_rifle", 1, 12, SEEY * 2 - 2);
        ...
        if (one_in(3)) {
            ...
            for (int i = 0; i < 20; i++){
                int rnx = rng(3, 20), rny = rng(3, 20);
                 if (m->move_cost(rnx, rny) != 0) {
                    generator_ok = true;
                    m->ter_set(rnx, rny, t_plut_generator);
                    break;
                 }
            }

            if (generator_ok){
                m->add_spawn("mon_turret_searchlight", 1, 1, 1);
                m->add_spawn("mon_turret_searchlight", 1, SEEX * 2 - 2, 1);
                m->add_spawn("mon_turret_searchlight", 1, 1, SEEY * 2 - 2);
                m->add_spawn("mon_turret_searchlight", 1, SEEX * 2 - 2, SEEY * 2 - 2);
            }
        }
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (m->move_cost(rnx, rny) != 0) {
                if (one_in(5)) { // Military zombie
                    m->add_spawn("mon_zombie_soldier", 1, rnx, rny);
                } else if (one_in(2)) {
                    item body;
                    body.make_corpse();
                    m->add_item(rnx, rny, body);
                    m->place_items("launchers",  10, rnx, rny, rnx, rny, true, 0);
                    m->place_items("mil_rifles", 30, rnx, rny, rnx, rny, true, 0);
                    m->place_items("mil_armor",  70, rnx, rny, rnx, rny, true, 0);
                    m->place_items("mil_food",   40, rnx, rny, rnx, rny, true, 0);
                    m->spawn_item(rnx, rny, "id_military");
                } else if (one_in(4)) { // Bionic Op zombie!
                    m->add_spawn("mon_zombie_bio_op", 1, rnx, rny);
                } else if (one_in(20)) {
                    rough_circle_furn(m, f_rubble, rnx, rny, rng(3, 6));
                }
            }
        }
        ...
        for (int i = 0; i < SEEX * 2; i++) {
            for (int j = 0; j < SEEY * 2; j++) {
                ...
                m->adjust_radiation(i, j, extra_radiation);
                if (m->furn(i, j) == f_rubble) {
                    m->adjust_radiation(i, j, rng(1, 3));
                }
            }
        }
...
*/
		int tw; int lw; int mw;
        if (dat.zlevel == 0) { // We're on ground level
            for (int i = 0; i < SEEX * 2; i++) {
                for (int j = 0; j < SEEY * 2; j++) {
                    if (trig_dist(i, j, SEEX, SEEY) <= 6) {
                        m->ter_set(i, j, t_metal_floor);
                    } else {
                        m->ter_set(i, j, dat.groundcover());
                    }
                }
            ...
            for (int i = lw; i <= lw + 2; i++) {
                m->ter_set(i, tw    , t_wall_metal_h);
                m->ter_set(i, tw + 2, t_wall_metal_h);
            }
            m->ter_set(lw    , tw + 1, t_wall_metal_v);
            m->ter_set(lw + 1, tw + 1, t_stairs_down);
            m->ter_set(lw + 2, tw + 1, t_wall_metal_v);
            m->ter_set(mw    , tw + 1, t_door_metal_locked);
            m->ter_set(mw    , tw + 2, t_card_military);
            ...
            for (int i = 0; i < SEEX * 2; i++) {
                for (int j = 0; j < SEEY * 2; j++) {
                    if (trig_dist(i, j, SEEX, SEEY) > 7) {
                        ...
                        m->ter_set(i, j, t_metal_floor);
                        if (one_in(30)) {
                            m->add_field(i, j, fd_nuke_gas, 2);    // NULL game; no messages
                        }
                    } else if (trig_dist(i, j, SEEX, SEEY) == 5) {
                        m->ter_set(i, j, t_hole);
                        m->add_trap(i, j, tr_ledge);
                    } else {
                        m->ter_set(i, j, t_missile);
                    }
                }
            }
            silo_rooms(m);
...
*/
        ...
        for (int i = 0; i < SEEX * 2; i++) {
            for (int j = 0; j < SEEY * 2; j++) {
                if (i == 5) {
                    if (j > 4 && j < SEEY) {
                        m->ter_set(i, j, t_reinforced_glass_v);
                    } else if (j == SEEY * 2 - 4) {
                        m->ter_set(i, j, t_door_metal_c);
                    } else {
                        m->ter_set(i, j, t_rock);
                    }
                } else {
        ...
        m->ter_set(0, 0, t_stairs_up);
		computer* tmpcomp;
        tmpcomp = m->add_computer(4, 5, _("Missile Controls"), 8);
...
*/
        ...
        fill_background(m, t_rock);
        square(m, t_rock_floor, SEEX - 1, 1, SEEX + 2, 4);
        square(m, t_rock_floor, SEEX, 5, SEEX + 1, SEEY * 2 - 1);
        line(m, t_stairs_up, SEEX, SEEY * 2 - 1, SEEX + 1, SEEY * 2 - 1);
        m->spawn_artifact(rng(SEEX, SEEX + 1), rng(2, 3));
        m->spawn_artifact(rng(SEEX, SEEX + 1), rng(2, 3));
        return;
...
*/
        ...
        fill_background(m, t_floor); // Set all to floor
        line(m, t_wall_h,  0,  0, 23,  0); // Top wall
        line(m, t_window,  1,  0,  6,  0); // Its windows
        line(m, t_wall_h,  0, 23, 23, 23); // Bottom wall
        line(m, t_wall_h,  1,  5,  6,  5); // Interior wall (front office)
        line(m, t_wall_h,  1, 14,  6, 14); // Interior wall (equipment)
        line(m, t_wall_h,  1, 20,  7, 20); // Interior wall (stairs)
        line(m, t_wall_h, 14, 15, 22, 15); // Interior wall (tank)
        line(m, t_wall_v,  0,  1,  0, 22); // Left wall
        line(m, t_wall_v, 23,  1, 23, 22); // Right wall
        line(m, t_wall_v,  7,  1,  7,  5); // Interior wall (front office)
        line(m, t_wall_v,  7, 14,  7, 19); // Interior wall (stairs)
        line(m, t_wall_v,  4, 15,  4, 19); // Interior wall (mid-stairs)
        line(m, t_wall_v, 14, 15, 14, 20); // Interior wall (tank)
        line(m, t_wall_glass_v,  7,  6,  7, 13); // Interior glass (equipment)
        line(m, t_wall_glass_h,  8, 20, 13, 20); // Interior glass (flow)
        line_furn(m, f_counter,  1,  3,  3,  3); // Desk (front office);
        line_furn(m, f_counter,  1,  6,  1, 13); // Counter (equipment);
        // Central tanks:
        square(m, t_sewage, 10,  3, 13,  6);
        square(m, t_sewage, 17,  3, 20,  6);
        square(m, t_sewage, 10, 10, 13, 13);
        square(m, t_sewage, 17, 10, 20, 13);
        // Drainage tank
        square(m, t_sewage, 16, 16, 21, 18);
        square(m, t_grate,  18, 16, 19, 17);
        line(m, t_sewage, 17, 19, 20, 19);
        line(m, t_sewage, 18, 20, 19, 20);
        line(m, t_sewage,  2, 21, 19, 21);
        line(m, t_sewage,  2, 22, 19, 22);
        // Pipes and pumps
        line(m, t_sewage_pipe,  1, 15,  1, 19);
        line(m, t_sewage_pump,  1, 21,  1, 22);
        // Stairs down
        m->ter_set(2, 15, t_stairs_down);
        // Now place doors
        m->ter_set(rng(2, 5), 0, t_door_c);
        m->ter_set(rng(3, 5), 5, t_door_c);
        m->ter_set(5, 14, t_door_c);
        m->ter_set(7, rng(15, 17), t_door_c);
        m->ter_set(14, rng(17, 19), t_door_c);
        if (one_in(3)) { // back door
            m->ter_set(23, rng(19, 22), t_door_locked);
        }
        m->ter_set(4, 19, t_door_metal_locked);
        m->ter_set(2, 19, t_console);
        m->ter_set(6, 19, t_console);
        // Computers to unlock stair room, and items
		computer *tmpcomp;
        tmpcomp = m->add_computer(2, 19, _("EnviroCom OS v2.03"), 1);
        tmpcomp->add_option(_("Unlock stairs"), COMPACT_OPEN, 0);
        tmpcomp->add_failure(COMPFAIL_SHUTDOWN);

        tmpcomp = m->add_computer(6, 19, _("EnviroCom OS v2.03"), 1);
        tmpcomp->add_option(_("Unlock stairs"), COMPACT_OPEN, 0);
        tmpcomp->add_failure(COMPFAIL_SHUTDOWN);
        m->place_items("sewage_plant", 80, 1, 6, 1, 13, false, 0);
...
*/
        ...
        fill_background(m, t_rock_floor);
        // Top & left walls; right & bottom are handled by adjacent terrain
        line(m, t_wall_h,  0,  0, 23,  0);
        line(m, t_wall_v,  0,  1,  0, 23);
        // Top-left room
        line(m, t_wall_v,  8,  1,  8,  8);
        line(m, t_wall_h,  1,  9,  9,  9);
        line(m, t_wall_glass_h, rng(1, 3), 9, rng(4, 7), 9);
        m->ter_set(2, 15, t_stairs_up);
        m->ter_set(8, 8, t_door_c);
        m->ter_set(3, 0, t_door_c);

        // Bottom-left room - stairs and equipment
        line(m, t_wall_h,  1, 14,  8, 14);
        line(m, t_wall_glass_h, rng(1, 3), 14, rng(5, 8), 14);
        line(m, t_wall_v,  9, 14,  9, 23);
        line(m, t_wall_glass_v, 9, 16, 9, 19);
        square_furn(m, f_counter, 5, 16, 6, 20);
        m->place_items("sewage_plant", 80, 5, 16, 6, 20, false, 0);
        m->ter_set(0, 20, t_door_c);
        m->ter_set(9, 20, t_door_c);

        // Bottom-right room
        line(m, t_wall_v, 14, 19, 14, 23);
        line(m, t_wall_h, 14, 18, 19, 18);
        line(m, t_wall_h, 21, 14, 23, 14);
        m->ter_set(14, 18, t_wall_h);
        m->ter_set(14, 20, t_door_c);
        m->ter_set(15, 18, t_door_c);
        line(m, t_wall_v, 20, 15, 20, 18);

        // Tanks and their content
        for (int i = 9; i <= 16; i += 7) {
            for (int j = 2; j <= 9; j += 7) {
                square(m, t_rock, i, j, i + 5, j + 5);
                square(m, t_sewage, i + 1, j + 1, i + 4, j + 4);
            }
        }
        square(m, t_rock, 16, 15, 19, 17); // Wall around sewage from above
        square(m, t_rock, 10, 15, 14, 17); // Extra walls for southward flow
        // Flow in from north, east, and west always connects to the corresponding tank
        square(m, t_sewage, 10,  0, 13,  2); // North -> NE tank
        square(m, t_sewage, 21, 10, 23, 13); // East  -> SE tank
        square(m, t_sewage,  0, 10,  9, 13); // West  -> SW tank
        // Flow from south may go to SW tank or SE tank
        square(m, t_sewage, 10, 16, 13, 23);
        if (one_in(2)) { // To SW tank
            square(m, t_sewage, 10, 14, 13, 17);
            // Then, flow from above may be either to flow from south, to SE tank, or both
            switch (rng(1, 5)) {
            case 1:
            case 2: // To flow from south
                square(m, t_sewage, 14, 16, 19, 17);
                line(m, t_bridge, 15, 16, 15, 17);
                if (!one_in(4)) {
                    line(m, t_wall_glass_h, 16, 18, 19, 18);    // Viewing window
                }
                break;
            case 3:
            case 4: // To SE tank
                square(m, t_sewage, 18, 14, 19, 17);
                if (!one_in(4)) {
                    line(m, t_wall_glass_v, 20, 15, 20, 17);    // Viewing window
                }
                break;
            case 5: // Both!
                square(m, t_sewage, 14, 16, 19, 17);
        ...
        if (rn != 1) {
            line(m, t_sewage, 14,  4, 14,  5);
            line(m, t_bridge, 15,  4, 15,  5);
            line(m, t_sewage, 16,  4, 16,  5);
        }
        if (rn != 2) {
            line(m, t_sewage, 18,  7, 19,  7);
            line(m, t_bridge, 18,  8, 19,  8);
            line(m, t_sewage, 18,  9, 19,  9);
        }
        if (rn != 3) {
            line(m, t_sewage, 14, 11, 14, 12);
            line(m, t_bridge, 15, 11, 15, 12);
            line(m, t_sewage, 16, 11, 16, 12);
        }
        if (rn != 4) {
            line(m, t_sewage, 11,  7, 12,  7);
            line(m, t_bridge, 11,  8, 12,  8);
            line(m, t_sewage, 11,  9, 12,  9);
        }
        // Bridge connecting bottom two rooms
        line(m, t_bridge, 10, 20, 13, 20);
        // Possibility of extra equipment shelves
        if (!one_in(3)) {
            line_furn(m, f_rack, 23, 1, 23, 4);
            m->place_items("sewage_plant", 60, 23, 1, 23, 4, false, 0);
        }
        ...
        if (one_in(2)) { // Upper left is sampling, lower right valuable finds
            // Upper left...
            line(m, t_wall_h, 1, 3, 2, 3);
            line(m, t_wall_h, 1, 5, 2, 5);
            line(m, t_wall_h, 1, 7, 2, 7);
            m->ter_set(1, 4, t_sewage_pump);
            m->furn_set(2, 4, f_counter);
            m->ter_set(1, 6, t_sewage_pump);
            m->furn_set(2, 6, f_counter);
            m->ter_set(1, 2, t_console);
			computer *tmpcomp;
            tmpcomp = m->add_computer(1, 2, _("EnviroCom OS v2.03"), 0);
            ...
            // Lower right...
            line_furn(m, f_counter, 15, 23, 22, 23);
            m->place_items("sewer", 65, 15, 23, 22, 23, false, 0);
            line_furn(m, f_counter, 23, 15, 23, 19);
            m->place_items("sewer", 65, 23, 15, 23, 19, false, 0);
        } else { // Upper left is valuable finds, lower right is sampling
            // Upper left...
            line_furn(m, f_counter,     1, 1, 1, 7);
            m->place_items("sewer", 65, 1, 1, 1, 7, false, 0);
            line_furn(m, f_counter,     7, 1, 7, 7);
            m->place_items("sewer", 65, 7, 1, 7, 7, false, 0);
            // Lower right...
            line(m, t_wall_v, 17, 22, 17, 23);
            line(m, t_wall_v, 19, 22, 19, 23);
            line(m, t_wall_v, 21, 22, 21, 23);
            m->ter_set(18, 23, t_sewage_pump);
            m->furn_set(18, 22, f_counter);
            m->ter_set(20, 23, t_sewage_pump);
            m->furn_set(20, 22, f_counter);
            m->ter_set(16, 23, t_console);
			computer *tmpcomp;
            tmpcomp = m->add_computer(16, 23, _("EnviroCom OS v2.03"), 0);
            tmpcomp->add_option(_("Download Sewer Maps"), COMPACT_MAP_SEWER, 0);
            tmpcomp->add_option(_("Divert sample"), COMPACT_SAMPLE, 3);
            tmpcomp->add_failure(COMPFAIL_PUMP_EXPLODE);
            tmpcomp->add_failure(COMPFAIL_PUMP_LEAK);
...
*/
        ...
        do {
            ...
            if (build_shaft) {
                build_mine_room(m, room_mine_shaft, x1, y1, x2, y2, dat);
                build_shaft = false;
            } else {
                bool okay = true;
                for (int x = x1 - 1; x <= x2 + 1 && okay; x++) {
                    for (int y = y1 - 1; y <= y2 + 1 && okay; y++) {
                        okay = dat.is_groundcover( m->ter(x, y) );
                    }
                }
                if (okay) {
                    room_type type = room_type( rng(room_mine_office, room_mine_housing) );
                    build_mine_room(m, type, x1, y1, x2, y2, dat);
                    tries = 0;
                } else {
                    tries++;
                }
        ...
        while( !dat.is_groundcover( m->ter(ladderx, laddery) ) ) {
            ladderx = rng(0, SEEX * 2 - 1);
            laddery = rng(0, SEEY * 2 - 1);
        }
        m->ter_set(ladderx, laddery, t_manhole_cover);
...
*/
        ...
        fill_background(m, t_rock);
        square(m, t_hole, SEEX - 3, SEEY - 3, SEEX + 2, SEEY + 2);
        line(m, t_grate, SEEX - 3, SEEY - 4, SEEX + 2, SEEY - 4);
        m->ter_set(SEEX - 3, SEEY - 5, t_ladder_up);
        m->ter_set(SEEX + 2, SEEY - 5, t_ladder_down);
        m->rotate(rng(0, 3));
...
*/
        ...
        if (dat.north() == "mine") {
            square(m, t_rock_floor, SEEX, 0, SEEX + 1, 3);
        } else {
            face.push_back(NORTH);
        }

        if (dat.east()  == "mine") {
            square(m, t_rock_floor, SEEX * 2 - 4, SEEY, SEEX * 2 - 1, SEEY + 1);
        } else {
            face.push_back(EAST);
        }

        if (dat.south() == "mine") {
            square(m, t_rock_floor, SEEX, SEEY * 2 - 4, SEEX + 1, SEEY * 2 - 1);
        } else {
            face.push_back(SOUTH);
        }

        if (dat.west()  == "mine") {
            square(m, t_rock_floor, 0, SEEY, 3, SEEY + 1);
        } else {
            face.push_back(WEST);
        }
        ...
        case 1: { // Wyrms
            ...
            m->ter_set(x, y, t_pedestal_wyrm);
            m->spawn_item(x, y, "petrified_eye");
        }
        ...
        case 2: { // The Thing dog
            ...
            for (int i = 0; i < num_bodies; i++) {
                ...
                m->add_item(x, y, miner);
                m->place_items("mine_equipment", 60, x, y, x, y, false, 0);
            }
            m->add_spawn("mon_dog_thing", 1, rng(SEEX, SEEX + 1), rng(SEEX, SEEX + 1), true);
            m->spawn_artifact(rng(SEEX, SEEX + 1), rng(SEEY, SEEY + 1));
        }
        break;

        case 3: { // Spiral down
            line(m, t_rock,  5,  5,  5, 18);
            line(m, t_rock,  5,  5, 18,  5);
            line(m, t_rock, 18,  5, 18, 18);
            line(m, t_rock,  8, 18, 18, 18);
            line(m, t_rock,  8,  8,  8, 18);
            line(m, t_rock,  8,  8, 15,  8);
            line(m, t_rock, 15,  8, 15, 15);
            line(m, t_rock, 10, 15, 15, 15);
            line(m, t_rock, 10, 10, 10, 15);
            line(m, t_rock, 10, 10, 13, 10);
            line(m, t_rock, 13, 10, 13, 13);
            m->ter_set(12, 13, t_rock);
            m->ter_set(12, 12, t_slope_down);
            m->ter_set(12, 11, t_slope_down);
        }
        break;
        ...
        case 4: { // Amigara fault
            ...
            switch (fault) {
            case NORTH:
                square(m, t_rock, 0, 0, SEEX * 2 - 1, 4);
                line(m, t_fault, 4, 4, SEEX * 2 - 5, 4);
                break;
            case EAST:
                square(m, t_rock, SEEX * 2 - 5, 0, SEEY * 2 - 1, SEEX * 2 - 1);
                line(m, t_fault, SEEX * 2 - 5, 4, SEEX * 2 - 5, SEEY * 2 - 5);
                break;
            case SOUTH:
                square(m, t_rock, 0, SEEY * 2 - 5, SEEX * 2 - 1, SEEY * 2 - 1);
                line(m, t_fault, 4, SEEY * 2 - 5, SEEX * 2 - 5, SEEY * 2 - 5);
                break;
            case WEST:
                square(m, t_rock, 0, 0, 4, SEEY * 2 - 1);
                line(m, t_fault, 4, 4, 4, SEEY * 2 - 5);
                break;
            default:
                break;
            }

            m->ter_set(SEEX, SEEY, t_console);
			computer *tmpcomp;
            tmpcomp = m->add_computer(SEEX, SEEY, _("NEPowerOS"), 0);
...
*/
        ...
        fill_background(m, t_rock_floor);
        line(m, t_rock, 23,  0, 23, 23);
        line(m, t_rock,  2, 23, 23, 23);
        line(m, t_rock,  2,  4,  2, 23);
        line(m, t_rock,  2,  4, 18,  4);
        line(m, t_rock, 18,  4, 18, 18); // bad
        line(m, t_rock,  6, 18, 18, 18);
        line(m, t_rock,  6,  7,  6, 18);
        line(m, t_rock,  6,  7, 15,  7);
        line(m, t_rock, 15,  7, 15, 15);
        line(m, t_rock,  8, 15, 15, 15);
        line(m, t_rock,  8,  9,  8, 15);
        line(m, t_rock,  8,  9, 13,  9);
        line(m, t_rock, 13,  9, 13, 13);
        line(m, t_rock, 10, 13, 13, 13);
        line(m, t_rock, 10, 11, 10, 13);
        square(m, t_slope_up, 11, 11, 12, 12);
        m->rotate(rng(0, 3));
...
*/
        ...
        for (int i = 0; i < num_spiral; i++) {
            ...
            line(m, t_rock, orx    , ory    , orx + 5, ory    );
            line(m, t_rock, orx + 5, ory    , orx + 5, ory + 5);
            line(m, t_rock, orx + 1, ory + 5, orx + 5, ory + 5);
            line(m, t_rock, orx + 1, ory + 2, orx + 1, ory + 4);
            line(m, t_rock, orx + 1, ory + 2, orx + 3, ory + 2);
            m->ter_set(orx + 3, ory + 3, t_rock);
            m->ter_set(orx + 2, ory + 3, t_rock_floor);
            m->place_items("spiral", 60, orx + 2, ory + 3, orx + 2, ory + 3, false, 0);
        }
...
*/
		int lw; int tw; int bw; int rw; int cw;
        dat.fill_groundcover();
        lw = rng(1, SEEX * 2 - 2);
        tw = rng(1, SEEY * 2 - 2);
        for (int i = lw; i < lw + 4; i++) {
            for (int j = tw; j < tw + 4; j++) {
                m->ter_set(i, j, t_radio_tower);
            }
        }
        rw = -1;
        bw = -1;
        ...
        if (rw != -1 && bw != -1) {
            ...
            cw = rng(rw + 2, rw + 8);
            m->ter_set(cw, bw + 5, t_window);
            m->ter_set(cw + 1, bw + 5, t_window);
            m->ter_set(rng(rw + 2, rw + 8), bw + 5, t_door_c);
            m->set(rng(rw + 2, rw + 8), bw + 1, t_radio_controls, f_null);
            m->place_items("radio", 60, rw + 1, bw + 2, rw + 10, bw + 4, true, 0);
        } else { // No control room... simple controls near the tower
            m->ter_set(rng(lw, lw + 3), tw + 4, t_radio_controls);
        }
            ...
            for (int i = poolx - 3; i <= poolx + 3; i++) {
                for (int j = pooly - 3; j <= pooly + 3; j++) {
                    if (rng(2, 5) > rl_dist(poolx, pooly, i, j)) {
                        m->ter_set(i, j, t_sewage);
                        m->adjust_radiation(i, j, rng(20, 60));
                    }
                }
            }
        }
        int buildx = rng(6, SEEX * 2 - 7), buildy = rng(6, SEEY * 2 - 7);
        square(m, t_floor, buildx - 3, buildy - 3, buildx + 3, buildy + 3);
        line(m, t_wall_h, buildx - 4, buildy - 4, buildx + 4, buildy - 4);
        line(m, t_wall_h, buildx - 4, buildy + 4, buildx + 4, buildy + 4);
        line(m, t_wall_v, buildx - 4, buildy - 4, buildx - 4, buildy + 4);
        line(m, t_wall_v, buildx + 4, buildy - 4, buildx + 4, buildy + 4);
        line_furn(m, f_counter, buildx - 3, buildy - 3, buildx + 3, buildy - 3);
        m->place_items("toxic_dump_equipment", 80,
                    buildx - 3, buildy - 3, buildx + 3, buildy - 3, false, 0);
        m->spawn_item(buildx, buildy, "id_military");
        m->ter_set(buildx, buildy + 4, t_door_locked);
   ...
   |www|_______fFFFFFFFF\n\
        ...
        _______         \n",
                                   ...
                                   mapf::basic_bind("1 & V C G 5 % Q E , _ r X f F 6 x $ ^ . - | # t + = D w T S e o h c d l s",
                                           ...
                                           f_counter, f_desk,  f_locker, f_null));
        m->spawn_item(19, 3, "cleansuit");
        m->place_items("office", 80,  4, 19, 6, 19, false, 0);
        m->place_items("cleaning", 90,  7,  3, 7,  5, false, 0);
        m->place_items("toxic_dump_equipment", 85,  19,  1, 19,  3, false, 0);
        m->place_items("toxic_dump_equipment", 85,  19,  5, 19,  7, false, 0);
        if (x_in_y(1, 2)) {
            m->add_spawn("mon_hazmatbot", 1, 10, 5);
        }
        //lazy radiation mapping
        for (int x = 0; x <= 23; x++) {
            for (int y = 0; y <= 23; y++) {
                m->adjust_radiation(x, y, rng(10, 30));
            }
        }
...
*/
        ...
        dat.fill_groundcover();
        if ((dat.south() == "haz_sar_entrance" && dat.east() == "haz_sar") || (dat.north() == "haz_sar" &&
                dat.east() == "haz_sar_entrance") || (dat.west() == "haz_sar" && dat.north() == "haz_sar_entrance") ||
 ...
 f    |_________%..r| |^\n",
                                       ...
                                       mapf::basic_bind("1 & V C G 5 % Q E , _ r X f F 6 x $ ^ . - | # t + = D w T S e o h c d l s",
                                               ...
                                               f_null,   f_null,         f_null,        f_null,   f_toilet, f_sink,  f_fridge, f_bookcase, f_chair,
                                               f_counter, f_desk,  f_locker, f_null));
            m->spawn_item(19, 22, "cleansuit");
            m->place_items("cleaning", 85,  6,  11, 6,  14, false, 0);
            m->place_items("tools", 85,  10,  6, 13,  6, false, 0);
            m->place_items("toxic_dump_equipment", 85,  22,  14, 23,  15, false, 0);
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_hazmatbot", 1, 22, 12);
            }
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_hazmatbot", 1, 23, 18);
            }
            //lazy radiation mapping
            for (int x = 0; x <= 23; x++) {
                for (int y = 0; y <= 23; y++) {
            ...
            if (dat.west() == "haz_sar_entrance") {
                m->rotate(1);
                if (x_in_y(1, 4)) {
                    m->add_vehicle ("military_cargo_truck", 10, 11, 0);
                }
            } else if (dat.north() == "haz_sar_entrance") {
                m->rotate(2);
                if (x_in_y(1, 4)) {
                    m->add_vehicle ("military_cargo_truck", 12, 10, 90);
                }
            } else if (dat.east() == "haz_sar_entrance") {
                m->rotate(3);
                if (x_in_y(1, 4)) {
                    m->add_vehicle ("military_cargo_truck", 13, 12, 180);
                }
            } else if (x_in_y(1, 4)) {
                m->add_vehicle ("military_cargo_truck", 11, 13, 270);
            }

        }

        else if ((dat.west() == "haz_sar_entrance" && dat.north() == "haz_sar") || (dat.north() == "haz_sar_entrance" &&
...
FFFFFFFFFFFFFFFFFFFFFFf \n\
                        ...
                        \n",
                                       ...
                                       mapf::basic_bind("1 & V C G 5 % Q E , _ r X f F V H 6 x $ ^ . - | # t + = D w T S e o h c d l s",
                                               ...
                                               f_null,   f_null,   f_null, f_table, f_null,   f_null,              f_null,        f_null,
                                               f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
            m->spawn_item(1, 2, "id_military");
            m->place_items("office", 85,  1,  1, 1,  3, false, 0);
            m->place_items("office", 85,  11,  3, 13,  3, false, 0);
            m->place_items("office", 85,  17,  3, 19,  3, false, 0);
            //lazy radiation mapping
            for (int x = 0; x <= 23; x++) {
                for (int y = 0; y <= 23; y++) {
                    m->adjust_radiation(x, y, rng(10, 30));
...
.x6x..|S.T|l.|^.ddd.| f \n",
                                       ...
                                       mapf::basic_bind("R 1 & V C G 5 % Q E , _ r X f F 6 x $ ^ . - | # t + = D w T S e o h c d l s",
                                               ...
                                               f_null,   f_null,   f_null, f_table, f_null,   f_null,              f_null,        f_null,
                                               f_toilet, f_sink,  f_fridge, f_bookcase, f_chair, f_counter, f_desk,  f_locker, f_null));
            m->place_items("office", 85,  16,  23, 18,  23, false, 0);
            m->place_items("cleaning", 85,  11,  23, 12,  23, false, 0);
            m->place_items("robots", 90,  2,  11, 3,  11, false, 0);
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_hazmatbot", 1, 7, 10);
            }
            if (x_in_y(1, 2)) {
                m->add_spawn("mon_hazmatbot", 1, 11, 16);
            }
            //lazy radiation mapping
            for (int x = 0; x <= 23; x++) {
                for (int y = 0; y <= 23; y++) {
			...
			computer *tmpcomp;
            tmpcomp = m->add_computer(2, 23, _("SRCF Security Terminal"), 0);
...
####|-------------------\n",
        ...
        for (int i = 0; i <= 23; i++) {
            for (int j = 0; j <= 23; j++) {
                if (m->ter(i, j) == t_rock_floor) {
                    if (one_in(250)) {
                        item body;
                        body.make_corpse();
                        m->add_item(i, j, body);
                        m->place_items("science",  70, i, j, i, j, true, 0);
                    } else if (one_in(80)) {
                        m->add_spawn("mon_zombie", 1, i, j);
                    }
                }
                if (m->ter(i, j) != t_metal_floor) {
                    m->adjust_radiation(x, y, rng(10, 70));
                }
                if (m->ter(i, j) == t_sewage) {
                    if (one_in(2)) {
                        m->ter_set(i, j, t_dirtfloor);
                    }
                    if (one_in(4)) {
                        m->ter_set(i, j, t_dirtmound);
                    }
                    if (one_in(2)) {
                        m->make_rubble(i, j, f_wreckage, true);
                    }
                    m->place_items("trash", 50,  i,  j, i,  j, false, 0);
                    m->place_items("sewer", 50,  i,  j, i,  j, false, 0);
                    if (one_in(5)) {
                        if (one_in(10)) {
                            m->add_spawn("mon_zombie_child", 1, i, j);
                        } else if (one_in(15)) {
                            m->add_spawn("mon_zombie_dog", 1, i, j);
                        } else {
                            m->add_spawn("mon_zombie", 1, i, j);
                        }
                    }
...
*/
		int x=0; int y=0;
        dat.fill_groundcover();
        if ((dat.south() == "haz_sar_entrance_b1" && dat.east() == "haz_sar_b1") || (dat.north() == "haz_sar_b1" &&
                dat.east() == "haz_sar_entrance_b1") || (dat.west() == "haz_sar_b1" && dat.north() == "haz_sar_entrance_b1") ||
...
|---------|#.........|-$\n",
            ...
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_rack) {
                        m->place_items("mechanics", 60,  i,  j, i,  j, false, 0);
                    }
                    if (m->ter(i, j) == t_rock_floor) {
                        if (one_in(250)) {
                            item body;
            ...
            if (dat.west() == "haz_sar_entrance_b1") {
                ...
                m->rotate(3);
                 ...
                 (dat.north() == "haz_sar_entrance_b1" && dat.east() == "haz_sar_b1") || (dat.west() == "haz_sar_b1" &&
...
$$$$-|-|=HH-|-HHHH-|####\n",
                                       ...
                                       mapf::basic_bind("= + E & 6 H V c h d r M _ $ | - # . , l S T", f_null,         f_null,
                                               ...
                                               f_counter, f_chair, f_desk,  f_rack,  f_null,                   f_null,   f_null,
                                               f_null,       f_null,       f_null, f_null,       f_null,        f_locker, f_sink,  f_toilet));
            m->spawn_item(3, 16, "sarcophagus_access_code");
            for (int i = 0; i <= 23; i++) {
                for (int j = 0; j <= 23; j++) {
                    if (m->furn(i, j) == f_locker) {
                        m->place_items("cleaning", 60,  i,  j, i,  j, false, 0);
                    ...
                    if (m->furn(i, j) == f_desk) {
                        m->place_items("cubical_office", 60,  i,  j, i,  j, false, 0);
                    }
                    if (m->furn(i, j) == f_rack) {
                        m->place_items("sewage_plant", 60,  i,  j, i,  j, false, 0);
                    }
                    if (m->ter(i, j) == t_rock_floor) {
                        if (one_in(250)) {
                            item body;
			...
			computer *tmpcomp;
            tmpcomp = m->add_computer(16, 21, _("SRCF Security Terminal"), 0);
            tmpcomp->add_option(_("Security Reminder [1055]"), COMPACT_SR1_MESS, 0);
            tmpcomp->add_option(_("Security Reminder [1056]"), COMPACT_SR2_MESS, 0);
            tmpcomp->add_option(_("Security Reminder [1057]"), COMPACT_SR3_MESS, 0);
            //tmpcomp->add_option(_("Security Reminder [1058]"), COMPACT_SR4_MESS, 0); limited to 9 computer options
