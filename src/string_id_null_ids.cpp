...
#define MAKE_NULL_ID( type, ... )  class type;  template<> const string_id<type> &string_id<type>::NULL_ID() {  static string_id<type> id = string_id<type>( __VA_ARGS__ ); return id;  }
...
#define MAKE_NULL_ID2( type, ... )  struct type;  template<> const string_id<type> &string_id<type>::NULL_ID() {  static string_id<type> id = string_id<type>( __VA_ARGS__ );  return id;  }
