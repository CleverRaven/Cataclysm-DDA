...
void complete_construction()
{
    ...
    for( auto &elem : g->active_npc ) {
        if( rl_dist( elem->pos(), u.pos() ) < PICKUP_RANGE && elem->is_friend() && !elem->in_sleepy_state() ) {
...
int construction::adjusted_time() const
{
    ...
    for( auto &elem : g->active_npc ) {
        if( rl_dist( elem->pos(), g->u.pos() ) < PICKUP_RANGE && elem->is_friend() && !elem->in_sleepy_state() ) {
