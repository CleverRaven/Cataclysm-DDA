...
static const mon_flag_id mon_flag_COMBAT_MOUNT( "COMBAT_MOUNT" );
static const mon_flag_id mon_flag_LOUDMOVES( "LOUDMOVES" );
static const mon_flag_id mon_flag_MECH_RECON_VISION( "MECH_RECON_VISION" );
