...
int Character::get_cardiofit() const
{
    ...
    */
    ...
    // Modify cardio accumulator by our cardio mods and player weight modifier.
    const int cardio_fitness = static_cast<int>( cardio_base * cardio_modifier * weight_mod );
