...
stat_mod Character::get_pain_penalty() const
{
    ...
    ret.strength = std::min( get_str() - 1, std::max( ret.strength, 1 ) );
    ret.dexterity = std::min( get_dex() - 1, std::max( ret.dexterity, 1 ) );
    ret.intelligence = std::min( get_int() - 1, std::max( ret.intelligence, 1 ) );
    ret.perception = std::min( get_per() - 1, std::max( ret.perception, 1 ) );
