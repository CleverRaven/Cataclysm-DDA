...
struct bionic_data {
    ...
    /**
     * ID of the prerequisite bionic. 
     * The ID of another bionic that must be installed before this bionic can be installed.
     * Also prevents that bionic from being removed while this bionic remains installed.
     */
    ...
    /**
     * Mutations/Traits that are removed upon installing this CBM.
