    ...
    class game
{
    ...
    public:
        ...
        int inv_for_filter( const std::string &title, item_location_filter filter,
                            const std::string &none_message = "" );
    ...
    private:
        ...
        void toggle_important( int
                               pos ); //Marks item with IMPORTANT_GEAR flag; removes flag if already present
        void autoattack();
    public:
