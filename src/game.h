...
class game
{
    ...
    public:
        ...
        int inv_for_contents(const std::string &title, const item &bag);
        int display_slice(indexed_invslice const&, const std::string &, int position=INT_MIN, int hide=0, const item *thing=nullptr);
