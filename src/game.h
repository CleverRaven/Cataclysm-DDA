...
class game
{
    ...
    protected:
        ...
        /** Loads dynamic data from the given directory. Excludes files from 'mod_interactions' sub-directory unless located within a folder labeled by a loaded mod's id.  May throw. */
