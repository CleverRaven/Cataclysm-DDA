...
class game
{
    ...
    public:
        ...
        void print_all_tile_info( const tripoint &lp, const catacurses::window &w_look, std::string area_name, int column,
    ...
    private:
        ...
        void print_fields_info( const tripoint &lp, const catacurses::window &w_look, int column,
                                int &line );
        void print_terrain_info( const tripoint &lp, const catacurses::window &w_look, std::string area_name, int column,
                                 int &line );
