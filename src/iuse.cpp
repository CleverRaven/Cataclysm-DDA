...
const trait_id trait_CARNIVORE( "CARNIVORE" );
const trait_id trait_CENOBITE( "CENOBITE" );
const trait_id trait_CHLOROMORPH( "CHLOROMORPH" );
const trait_id trait_EATDEAD( "EATDEAD" );
const trait_id trait_EATHEALTH( "EATHEALTH" );
const trait_id trait_EATPOISON( "EATPOISON" );
const trait_id trait_GILLS( "GILLS" );
...
const trait_id trait_MARLOSS_AVOID( "MARLOSS_AVOID" );
const trait_id trait_MARLOSS_BLUE( "MARLOSS_BLUE" );
const trait_id trait_MARLOSS( "MARLOSS" );
const trait_id trait_MARLOSS_YELLOW( "MARLOSS_YELLOW" );
...
const trait_id trait_M_BLOSSOMS( "M_BLOSSOMS" );
...
const trait_id trait_MUTAGEN_AVOID( "MUTAGEN_AVOID" );
const trait_id trait_MUT_JUNKIE( "MUT_JUNKIE" );
...
const trait_id trait_SPIRITUAL( "SPIRITUAL" );
