...
public:
     ...
     * the given coords.
     * The coords use same system as @ref get.
     */
    ...
    // --
    // These functions use the overmap terrain coord system,
    // with global coords.
    // The functions find the overmap that contains the
    // point and call the overmap:: function there.
