...
struct jmapgen_setmap {
     ...
     **/
    std::string colliding_vehicle( const mapgendata &dat, const tripoint_rel_ms &offset ) const;
};
...
class jmapgen_piece
{
    ...
    public:
        ...
        jmapgen_int repeat;
        virtual std::string colliding_vehicle( const mapgendata &,
...
class update_mapgen_function_json : public mapgen_function_json_base
{
    public:
        ...
        // Returns an empty string on success and the name of a colliding "vehicle" on failure.
        std::string update_map( const mapgendata &md,
