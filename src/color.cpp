...
std::string const& string_from_color(nc_color const color) {
    ...
    auto const it = std::find_if(begin(colormap), end(colormap), [&](pair_t const &p) {
...
const std::map<std::string, note_color> color_shortcuts {
    {"br", {c_brown  , _("brown")}}   ,
    {"lg", {c_ltgray , _("lt gray")}} ,
    {"dg", {c_dkgray , _("dk gray")}} ,
    {"r" , {c_ltred  , _("lt red")}}  ,
    {"R" , {c_red    , _("red")}}     ,
    {"g" , {c_ltgreen, _("lt green")}},
    {"G" , {c_green  , _("green")}}   ,
    {"b" , {c_ltblue , _("lt blue")}} ,
    {"B" , {c_blue   , _("blue")}}    ,
    {"W" , {c_white  , _("white")}}   ,
    {"C" , {c_cyan   , _("cyan")}}    ,
    {"c" , {c_ltcyan , _("lt cyan")}} ,
    {"P" , {c_pink   , _("pink")}}    ,
    {"m" , {c_magenta, _("magenta")}}
};
