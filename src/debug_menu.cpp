...
void debug()
{
    ...
    switch( *action ) {
        ...
        case debug_menu_index::QUIT_NOSAVE:
            if( query_yn(
                    _( "Quit without saving? This will mark save as 'dirty' and disable future saving to prevent accidental overwriting save. This may cause issues such as duplicated or missing items and vehicles!" ) ) ) {
