...
/** Return a list of the loaded mods, including the full name and the id name in brackets, e.g. "Dark Days Ahead [dda]".
*/
std::string mods_loaded();
/** Generate a game report, including the information returned by all of the above functions.
 */
