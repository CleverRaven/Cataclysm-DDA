...
static const mon_flag_id mon_flag_DROPS_AMMO( "DROPS_AMMO" );
static const mon_flag_id mon_flag_NOGIB( "NOGIB" );
static const mon_flag_id mon_flag_SILENT_DISAPPEAR( "SILENT_DISAPPEAR" );
