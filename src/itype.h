...
struct itype {
    ...
    public:
        ...
        cata::optional<int> invoke( player &p, item &it, const tripoint &pos ) const; // Picks first method or returns 0
        cata::optional<int> invoke( player &p, item &it, const tripoint &pos, const std::string &iuse_name ) const;
