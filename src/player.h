...
class player : public Character, public JsonSerializer, public JsonDeserializer
{
    public:
         ...
         * @param swap_obj the item (or nullptr if none) taking the place of @ref obj (used for volume calculations). 
         * @param prompt optional message to display in any menu
         * @return whether the item was successfully disposed of
         */
        virtual bool dispose_item( item& obj, const item *const swap_obj, const std::string &prompt = std::string() );
