...
public:
 ...
 private:
  ...
  bool build_lab(int x, int y, int z, int s, std::vector<point> *lab_train_points, bool ice = false);
...
// Matches any oter_id that contains the substring passed in, used when oter is a suffix, not prefix.
