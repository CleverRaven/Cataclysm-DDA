...
class map
{
    ...
    public:
        ...
        */
        ...
        /**
         * Same as move_cost() but considering rotated vehicle parts.
         */
        int move_cost_from_point( const tripoint &to, const tripoint &from,
                                  const vehicle *ignored_vehicle = nullptr ) const;
        /**
         * Same as passable() but considering rotated vehicle parts.
         */
        bool passable_from_point( const tripoint &to, const tripoint &from ) const;

        /**
         * Direct or rotated vehicle part obstacle if any.
         * @return cata::nullopt or cata::optional<tripoint> of obstacle.
         */
        cata::optional<tripoint> obstacle_point( const tripoint &to, const tripoint &from ) const;

        /**
         * Utility to check for a given property function on diagonal tiles if they correspond to connected parts of a rotated vehicle
         * and if 'to' and 'from' conform a 1 tile diagonal vector.
         * @param to
         * @param from
         * @param property both diagonal tiles must satisfy.
         * @return cata::nullopt or one of offending cata::optional<tripoint>.
         */
        cata::optional<tripoint> check_for_diagonal( const tripoint &to, const tripoint &from,
