...
class Creature_tracker
{
    public:
        ...
        size_t size() const;
        bool update_pos(const monster &critter, const int new_x_pos, const int new_y_pos, const int new_z_pos);
    ...
    private:
        ...
        std::map<tripoint, int> _old_monsters_by_location;
        // Same as mon_at, but only returns id of dead critters.
        int dead_mon_at(tripoint coords) const;
};
