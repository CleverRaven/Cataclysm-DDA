...
enum m_flag : int {
    ...
    MF_KEEP_DISTANCE,       // Attempts to keep a short distance from its current target.
...
struct mtype {
    ...
    public:
        ...
        int tracking_distance =
            8; //how close the monster is willing to approach its target while under the MATT_FOLLOW attitufe
