...
// Anchors top-right
static void draw_can_craft_indicator( WINDOW *w, int window_width, int margin_x, int margin_y, recipe &rec )
{
    ...
    if( g->u.lighting_craft_speed_multiplier(rec) == 0.0f ) {
        ...
        mvwprintz( w, margin_y + 1, x_align - 1 - utf8_width( _( "slow" ) ),  i_red  , _( "slow" ) );
    } else {
