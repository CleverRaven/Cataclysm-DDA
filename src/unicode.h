...
/*
 * Convert a Unicode code point to lowercase, e.g. Ö -> ö
 *
 ...
 */
char32_t u32_to_lowercase( char32_t ch );

/*
 * Convert a Unicode code point to uppercase
 */
char32_t u32_to_uppercase( char32_t ch );

// Remove accent from a letter in-place, e.g. ö -> o
// TODO: Remove this if adding icu4c dependency is allowed at some point in the future.
void remove_accent( char32_t &ch );

bool u32_isspace( char32_t ch );

bool u32_ispunct( char32_t ch );
