...
static void draw_recipe_subtabs(WINDOW *w, std::string tab, std::string subtab, TAB_MODE mode)
{
    ...
    case NORMAL:
    {
        int pos_x = 2;//draw the tabs on each other
        int tab_step = 3;//step between tabs, two for tabs border
        draw_subtab(w, pos_x, 0, _("ALL"), subtab == "CSC_ALL");//Add ALL subcategory to all tabs;
        pos_x += utf8_width(_("ALL")) + tab_step;
        if (tab == "CC_WEAPON") {
            draw_subtab(w, pos_x, 0, _("BASHING"), subtab == "CSC_WEAPON_BASHING");
            pos_x += utf8_width(_("BASHING")) + tab_step;
            draw_subtab(w, pos_x, 0, _("CUTTING"), subtab == "CSC_WEAPON_CUTTING");
            pos_x += utf8_width(_("CUTTING")) + tab_step;
            draw_subtab(w, pos_x, 0, _("PIERCING"), subtab == "CSC_WEAPON_PIERCING");
            pos_x += utf8_width(_("PIERCING")) + tab_step;
            draw_subtab(w, pos_x, 0, _("RANGED"), subtab == "CSC_WEAPON_RANGED");
            pos_x += utf8_width(_("RANGED")) + tab_step;
            draw_subtab(w, pos_x, 0, _("EXPLOSIVE"), subtab == "CSC_WEAPON_EXPLOSIVE");
            pos_x += utf8_width(_("EXPLOSIVE")) + tab_step;
            draw_subtab(w, pos_x, 0, _("MODS"), subtab == "CSC_WEAPON_MODS");
            pos_x += utf8_width(_("MODS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("OTHER"), subtab == "CSC_WEAPON_OTHER");
        } else if (tab == "CC_AMMO") {
            draw_subtab(w, pos_x, 0, _("BULLETS"), subtab == "CSC_AMMO_BULLETS");
            pos_x += utf8_width(_("BULLETS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("ARROWS"), subtab == "CSC_AMMO_ARROWS");
            pos_x += utf8_width(_("ARROWS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("COMPONENTS"), subtab == "CSC_AMMO_COMPONENTS");
            pos_x += utf8_width(_("COMPONENTS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("OTHER"), subtab == "CSC_AMMO_OTHER");
        } else if (tab == "CC_FOOD") {
            draw_subtab(w, pos_x, 0, _("DRINKS"), subtab == "CSC_FOOD_DRINKS");
            pos_x += utf8_width(_("DRINKS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("MEAT"), subtab == "CSC_FOOD_MEAT");
            pos_x += utf8_width(_("MEAT")) + tab_step;
            draw_subtab(w, pos_x, 0, _("VEGGI"), subtab == "CSC_FOOD_VEGGI");
            pos_x += utf8_width(_("VEGGI")) + tab_step;
            draw_subtab(w, pos_x, 0, _("SNACK"), subtab == "CSC_FOOD_SNACK");
            pos_x += utf8_width(_("SNACK")) + tab_step;
            draw_subtab(w, pos_x, 0, _("BREAD"), subtab == "CSC_FOOD_BREAD");
            pos_x += utf8_width(_("BREAD")) + tab_step;
            draw_subtab(w, pos_x, 0, _("PASTA"), subtab == "CSC_FOOD_PASTA");
            pos_x += utf8_width(_("PASTA")) + tab_step;
            draw_subtab(w, pos_x, 0, _("OTHER"), subtab == "CSC_FOOD_OTHER");
        } else if (tab == "CC_CHEM") {
            draw_subtab(w, pos_x, 0, _("DRUGS"), subtab == "CSC_CHEM_DRUGS");
            pos_x += utf8_width(_("DRUGS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("MUTAGEN"), subtab == "CSC_CHEM_MUTAGEN");
            pos_x += utf8_width(_("MUTAGEN")) + tab_step;
            draw_subtab(w, pos_x, 0, _("CHEMICALS"), subtab == "CSC_CHEM_CHEMICALS");
            pos_x += utf8_width(_("CHEMICALS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("OTHER"), subtab == "CSC_CHEM_OTHER");
        } else if (tab == "CC_ELECTRONIC") {
            draw_subtab(w, pos_x, 0, _("CBMS"), subtab == "CSC_ELECTRONIC_CBMS");
            pos_x += utf8_width(_("CBMS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("TOOLS"), subtab == "CSC_ELECTRONIC_TOOLS");
            pos_x += utf8_width(_("TOOLS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("PARTS"), subtab == "CSC_ELECTRONIC_PARTS");
            pos_x += utf8_width(_("PARTS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("LIGHTING"), subtab == "CSC_ELECTRONIC_LIGHTING");
            pos_x += utf8_width(_("LIGHTING")) + tab_step;
            draw_subtab(w, pos_x, 0, _("COMPONENTS"), subtab == "CSC_ELECTRONIC_COMPONENTS");
            pos_x += utf8_width(_("COMPONENTS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("OTHER"), subtab == "CSC_ELECTRONIC_OTHER");
        } else if (tab == "CC_ARMOR") {
            draw_subtab(w, pos_x, 0, _("STORAGE"), subtab == "CSC_ARMOR_STORAGE");
            pos_x += utf8_width(_("STORAGE")) + tab_step;
            draw_subtab(w, pos_x, 0, _("SUIT"), subtab == "CSC_ARMOR_SUIT");
            pos_x += utf8_width(_("SUIT")) + tab_step;
            draw_subtab(w, pos_x, 0, _("HEAD"), subtab == "CSC_ARMOR_HEAD");
            pos_x += utf8_width(_("HEAD")) + tab_step;
            draw_subtab(w, pos_x, 0, _("TORSO"), subtab == "CSC_ARMOR_TORSO");
            pos_x += utf8_width(_("TORSO")) + tab_step;
            draw_subtab(w, pos_x, 0, _("ARMS"), subtab == "CSC_ARMOR_ARMS");
            pos_x += utf8_width(_("ARMS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("HANDS"), subtab == "CSC_ARMOR_HANDS");
            pos_x += utf8_width(_("HANDS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("LEGS"), subtab == "CSC_ARMOR_LEGS");
            pos_x += utf8_width(_("LEGS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("FEET"), subtab == "CSC_ARMOR_FEET");
            pos_x += utf8_width(_("FEET")) + tab_step;
            draw_subtab(w, pos_x, 0, _("OTHER"), subtab == "CSC_ARMOR_OTHER");
        } else if (tab == "CC_OTHER") {
            draw_subtab(w, pos_x, 0, _("TOOLS"), subtab == "CSC_OTHER_TOOLS");
            pos_x += utf8_width(_("TOOLS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("MEDICAL"), subtab == "CSC_OTHER_MEDICAL");
            pos_x += utf8_width(_("MEDICAL")) + tab_step;
            draw_subtab(w, pos_x, 0, _("CONTAINERS"), subtab == "CSC_OTHER_CONTAINERS");
            pos_x += utf8_width(_("CONTAINERS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("MATERIALS"), subtab == "CSC_OTHER_MATERIALS");
            pos_x += utf8_width(_("MATERIALS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("PARTS"), subtab == "CSC_OTHER_PARTS");
            pos_x += utf8_width(_("PARTS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("TRAPS"), subtab == "CSC_OTHER_TRAPS");
            pos_x += utf8_width(_("TRAPS")) + tab_step;
            draw_subtab(w, pos_x, 0, _("OTHER"), subtab == "CSC_OTHER_OTHER");
        }
        break;
    }
    case FILTERED:
