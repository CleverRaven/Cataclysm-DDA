...
class tileray
{
    ...
    public:
        ...
        int dir8 () const;    // return 8-sided direction (0 = east, 1 = southeast ...)
        long dir_symbol (long
                         sym); // convert certain symbols from north-facing variant into current dir facing
