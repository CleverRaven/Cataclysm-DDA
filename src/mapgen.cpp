...
void map::draw_lab( mapgendata &dat )
{
    ...
    if( terrain_type == oter_lab || terrain_type == oter_lab_stairs
        ...
        if( dat.zlevel() == 0 ) { // We're on ground level
            ...
            tw = ( is_ot_match( "lab", dat.north(), ot_match_type::contains ) & !is_ot_match( "lab_subway", dat.north(), ot_match_type::contains) ) ? 0 : 2;
            rw = ( is_ot_match( "lab", dat.east(), ot_match_type::contains ) & !is_ot_match( "lab_subway", dat.east(), ot_match_type::contains) ) ? 1 : 2;
            bw = ( is_ot_match( "lab", dat.south(), ot_match_type::contains ) & !is_ot_match( "lab_subway", dat.south(), ot_match_type::contains) ) ? 1 : 2;
            lw = ( is_ot_match( "lab", dat.west(), ot_match_type::contains ) & !is_ot_match( "lab_subway", dat.west(), ot_match_type::contains) ) ? 0 : 2;
