...
static const mon_flag_id mon_flag_FIREPROOF( "FIREPROOF" );
static const mon_flag_id mon_flag_FIREY( "FIREY" );
static const mon_flag_id mon_flag_INSECTICIDEPROOF( "INSECTICIDEPROOF" );
static const mon_flag_id mon_flag_NO_BREATHE( "NO_BREATHE" );
static const mon_flag_id mon_flag_SEES( "SEES" );
static const mon_flag_id mon_flag_SLUDGEPROOF( "SLUDGEPROOF" );
