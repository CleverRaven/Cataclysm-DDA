    ...
    with open(path, "r") as json_file:
        ...
        for jo in json_data:
            ...
            if jo.get['type'] not in ['AMMO', 'ARMOR', 'BATTERY', 'bionic',
                                    ...
                                    'GENERIC', 'GUN', 'GUNMOD', 'item_action',
                                    'ITEM_CATEGORY', 'MAGAZINE', 'map_extra',
                                    'martial_art', 'mission_definition',
                                    'MONSTER', 'mutation', 'npc_class',
                                    'PET_ARMOR', 'proficiency', 'skill',
                                    'TOOL', 'TOOL_ARMOR', 'tool_quality',
                                    'TOOLMOD', 'vehicle_part',
                                    'vehicle_part_category', 'vitamin',
                                    'WHEEL', 'SPELL']:
                continue
