...
static void deserialize( foo &bar, JsonIn &jin )
{
    ...
    // CHECK-MESSAGES: warning: immediately translating a value read from json causes translation updating issues. Consider reading into a translation object instead.
    // CHECK-MESSAGES: note: value read from json
    ...
    // CHECK-MESSAGES: warning: read translation directly instead of constructing it from json strings to enable specifying translation contexts and ensure consistent format in json.
    // CHECK-MESSAGES: note: string read from json
