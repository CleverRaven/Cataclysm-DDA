...
matplot(0:(length(d[[1]])-1),d, type='l', lty='solid', lwd=5, xlab='Mass (kg)', ylab='Safe velocity (mph)', xaxs='i', yaxs='i', ylim=c(0,120), axes=F, mgp=c(3.5,0,0), font.lab=2, col.lab='gray10', cex.lab=1.2)
