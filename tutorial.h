...
"\
You just drank a bottle of water, reducing your thirst level and maybe leaves\n\
you with an empty bottle.  Most of the time you'll want to just drop the \n\
bottle, but you might want to save it to refill from a water source later.",
"\
