...
void npc::set_destination(game *g)
{
    ...
    {
    case need_ammo:
        options.push_back(ot_house_north);
    case need_gun:
    ...
    case need_food:
        options.push_back(ot_s_grocery_north);
        break;
...
std::string npc_action_name(npc_action action)
{
    ...
    case npc_wield_melee:
        return "Wield melee weapon";
    case npc_wield_loaded_gun:
        return "Wield loaded gun";
    case npc_wield_empty_gun:
        return "Wield empty gun";
    case npc_heal:
        return "Heal self";
    case npc_use_painkiller:
