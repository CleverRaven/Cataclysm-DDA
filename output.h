...
std::string string_input_win (WINDOW * w, std::string input, int max_length, int startx, int starty, int endx, bool loop, long & key, std::string identifier="", int w_x=-1, int w_y=-1, bool dorefresh=true);
