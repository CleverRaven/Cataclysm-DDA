...
"melee_skill" : 4,					// Monster melee skill
...
"special_freq" : 0,					// Frequency of monster special attack in percent (0 - 100)
"death_function" : "NORMAL",		// How the monster behaves on death. See JSON_FLAGS.md for a list of possible functions
"special_attack" : "BITE",			// Monster's special attack. See JSON_FLAGS.md for a list of possible special attacks
...
"categories" : ["WILDLIFE"]			// Monster categories. Can be NULL, CLASSIC (only mobs found in classic zombie movies) or WILDLIFE (natural animals)
```	
###NAMES
```C++
