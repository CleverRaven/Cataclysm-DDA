...
```C++
{
  ...
  "adjust_variables_multiply": { "dirt": "-1" }, // adjusts the variables on the item when fix is applied using MULTIPLICATION
  "adjust_variables_add": { "dirt": "-1" }, // adjusts the variables on the item when fix is applied using ADDITION
