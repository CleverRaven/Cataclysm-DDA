...
"use_action": {
    ...
    "variant_type": "condom_plain", // (Optional) Variant type to set for the transformed item. Special string `<any>` will pick a random variant from all available variants.
