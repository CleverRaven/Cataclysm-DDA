...
| character_ranged_attacks_character | This triggers when firing and throwing. When triggered by throwing, weapon is null. |  { "attacker", `character_id` },<br/> { "weapon", `itype_id` },<br/> { "ammo", `itype_id` },<br/> { "victim", `character_id` },<br/> { "victim_name", `string` }, | character (attacker) / character (victim) |
| character_ranged_attacks_monster | This triggers when firing and throwing. When triggered by throwing, weapon is null. | { "attacker", `character_id` },<br/> { "weapon", `itype_id` },<br/> { "ammo", `itype_id` },<br/>  { "victim_type", `mtype_id` }, | character / monster |
