...
| `"color"`    | (optional) string, default "light_blue"    | Used for the title borders and title + footer separators. Must be the name of a valid [color](/doc/user-guides/COLOR.md#possible-colors)                                                                                                                                                  |
...
### Message objects
You can use an object with one of these in place of a string to provide a message with different styling and/or to add translator/style comments.
...
| `"paragraph"`         | (mutually exclusive) string | Formats the string normally, for use with translator/style comments only.                                              |
