...
| enchantment(`s`/`v`)    |  ✅   |   ❌  | u, n  | Return the result of the enchantment that you or item has, both `add` and `multiply` fields.<br/>Argument is enchantment id.<br/><br/>Example:<br/>`{ "math": [ "_x = u_enchantment('ARTIFACT_RESONANCE')" ] }`|
