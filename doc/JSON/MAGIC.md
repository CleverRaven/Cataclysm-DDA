...
`ALWAYS_CASTABLE`          | This spell is always castable, ignoring no-spellcasting flags and other statuses that prevent spellcasting.
`IGNORES_SPELL_RESISTANCE` | This spell ignores spell resistance.
