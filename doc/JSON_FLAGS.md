...
- ```SOURCE_OF_FUEL``` For NPC AI, this location may contain fuel for looting.
- ```SOURCE_OF_FOOD``` For NPC AI, this location may contain food for looting.
- ```SOURCE_OF_FARMING``` For NPC AI, this location may contain useful farming supplies for looting.
- ```SOURCE_OF_FABRICATION``` For NPC AI, this location may contain fabrication tools and components for looting.
- ```SOURCE_OF_GUN``` For NPC AI, this location may contain guns for looting.
- ```SOURCE_OF_AMMO``` For NPC AI, this location may contain ammo for looting.
- ```SOURCE_OF_BOOKS``` For NPC AI, this location may contain books for looting.
- ```SOURCE_OF_WEAPON``` For NPC AI, this location may contain weapons for looting.
- ```SOURCE_OF_FORAGE``` For NPC AI, this location may contain plants to forage.
- ```SOURCE_OF_COOKING``` For NPC AI, this location may contain useful tools and ingredients to aid in cooking.
- ```SOURCE_OF_TAILORING``` For NPC AI, this location may contain useful tools for tailoring.
- ```SOURCE_OF_DRINK``` For NPC AI, this location may contain drink for looting.
- ```SOURCE_OF_VEHICLES``` For NPC AI, this location may contain vehicles/parts/vehicle tools, to loot.
- ```SOURCE_OF_ELECTRONICS``` For NPC AI, this location may contain useful electronics to loot.
- ```SOURCE_OF_CONSTRUCTION``` For NPC AI, this location may contain useful tools/components for construction.
- ```SOURCE_OF_CHEMISTRY``` For NPC AI, this location may contain useful chemistry tools/components.
- ```SOURCE_OF_CLOTHING``` For NPC AI, this location may contain useful clothing to loot.
- ```SOURCE_OF_SAFETY``` For NPC AI, this location may be safe/sheltered and a good place for a base.
- ```SOURCE_OF_ANIMALS``` For NPC AI, this location may contain useful animals for farming/riding.
- ```SOURCE_OF_MEDICINE``` For NPC AI, this location may contain useful medicines for looting.
- ```SOURCE_OF_LUXURY``` For NPC AI, this location may contain valuable/feel-good items to sell/keep.
- ```SOURCE_OF_PEOPLE``` For NPC AI, this location may have other survivors.
