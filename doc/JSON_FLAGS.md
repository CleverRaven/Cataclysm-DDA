...
- ```NUTRIENT_OVERRIDE``` When you craft an item, it checks if it's a comestible, and if it is, it stores the components. the "NUTRIENT_OVERRIDE" flag will skip this step.
