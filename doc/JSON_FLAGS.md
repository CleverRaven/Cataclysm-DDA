...
- ```BIO_OP_BIOJUTSU``` Attack with a random special martial art maneuverer.
- ```BIO_OP_TAKEDOWN``` Attack with special martial art takedown maneuverer.
- ```BIO_OP_DISARM``` Attack with a special martial art disarm maneuverer.
- ```BIO_OP_IMPALE``` Attack with a strong martial art maneuverer.
