...
| `min_pierce`, `max_pierce`, `pierce_increment` | Respond for armor piersing of the spell | "min_pierce": 0, <bp>"max_pierce": 1, <bp>"pierce_increment": 0.1,
...
| `extra_effects` | Cast `id` spell right after the end of the main. Can cast multiple different spells at once |  "extra_effects": [ { "id": "fireball", "hit_self": false, "max_level": 3 }, { "id": "storm_chain_1", "max_level": 0 } ],
