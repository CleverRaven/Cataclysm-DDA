...
`PAIN_PENALTY_MOD_STR`  | Amount of this stat you lose from pain. Default value is `(pain^0.8)/10`
`PAIN_PENALTY_MOD_DEX`  | Amount of this stat you lose from pain.
`PAIN_PENALTY_MOD_INT`  | Amount of this stat you lose from pain.
`PAIN_PENALTY_MOD_PER`  | Amount of this stat you lose from pain.
