...
Mods are placed in different places depending on whether they are part of CDDA or are third party/private ones. Included ones are found in `data/mods`, while third party/private ones are placed in th `mods` directory.
