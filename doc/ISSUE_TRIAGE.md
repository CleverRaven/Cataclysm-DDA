...
Software issue triage is not life-or-death, but it does adress the same fundamental problem, which is that thre is a limited amount of attention and skill that can be broght to bear on issues at any given time, and some issues have higher *impact* than others.
