...
| prof_leatherworking | Leatherworking | Working with leather requires a specific set of skills and tools… a set you are familiar with. | prof_leatherworking_basic
...
| prof_leatherworking_dragon | Dragon leather working | Working with dragon leather requires a specific set of skills and tools… a set you are familiar with. | prof_leatherworking
| prof_scaleworking_dragon | Dragon scale working | Working with dragon scales requires a specific set of skills and tools… a set you are familiar with. | prof_leatherworking_dragon
