...
`u_mod_healthy, npc_mod_healthy : amount_int, cap: cap_int`<br/> | Your character or the NPC will have `amount_int` added or subtracted from its health value to a cap of `cap_int`.
#### Trade / Items
