...
| effect_intensity(`s`/`v`,`s`/`v`)    |  ✅   |   ❌  | u, n  | Return the characters intensity of effect on a body part.<br/> Variables are effect ID, bodypart ID.<br/> Example:<br/>`"condition": { "math": [ "u_effect_intensity('bite', 'torso')", ">", "1"] }`|
| hp(`s`/`v`)    |  ✅   |   ✅  | u, n  | Return or set the characters hp on a body part.<br/> Variable is bodypart ID.<br/> Example:<br/>`"condition": { "math": [ "hp('torso')", "=", "100"] }`|
