...
#### One string = return value or comparison
```JSON
{ "math": [ "lhs" ] }
```
Example:
...
#### Three strings = assignment or comparison alternative
```JSON
{ "math": [ "lhs", "operator", "rhs" ] }
```
...
Comparisons can also be split into three strings for readability when using complex lhs/rhs:

```JSON
"condition": {
    "math": [
        "some_function1('value1') * ( some_function2('value2') + some_function3('value3') )",
        "<",
        "some_function4('value4') / some_function5('value5')"
    ]
}
```
