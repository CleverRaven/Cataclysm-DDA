...
| hp(...)    |  ✅   |   ✅  | u, n  | Return or set the characters hp.<br/><br/> Optional kwargs:<br/>`bodypart`: `s`/`v` - Specify the bodypart to get/set hp. If omitted, get sum of all bodypart or set all bodypart.<br/><br/> Example:<br/>`"condition": { "math": [ "hp('bodypart': 'torso')", "=", "100"] }`|
