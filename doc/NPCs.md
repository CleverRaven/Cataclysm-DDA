...
| spellcasting_adjustment_by_mod(`s`/`v`, `s`/`v`)    |   ❌  |  ✅   | u  | As spellcasting_adjustment but only applies to spells fron a specified mod. Arguments are type of adjustment and mod ID.|
| spellcasting_adjustment_by_school(`s`/`v`, `s`/`v`)    |   ❌  |  ✅   | u  | As spellcasting_adjustment but only applies to spells fron a specified school. Arguments are type of adjustment and school ID.|
| spellcasting_adjustment_by_spell(`s`/`v`, `s`/`v`)    |   ❌  |  ✅   | u  | As spellcasting_adjustment but only applies to a specified spell. Arguments are type of adjustment and spell ID.|
