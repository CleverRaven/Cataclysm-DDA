...
3. Install and configure `vcpkg`. If you already have `vcpkg` installed, you should update it to at least commit `a1cae005c39be7b18ba319fced856b68d7276271` (the most recent tested good revision) and rerun `.\bootstrap-vcpkg.bat` as described:
