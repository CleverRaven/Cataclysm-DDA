...
| [clang](https://clang.llvm.org)                      | [14.0](https://releases.llvm.org/14.0.0/docs/index.html) |
...
* Jammy [defaults to g++ 11.2](https://packages.ubuntu.com/jammy/g++)
  and [clang 14](https://packages.ubuntu.com/jammy/clang).
