...
ASCII art only requires you to have the json files for the art you want in the `data/json/ascii_art/` folder.  The `"id"` string must match the `"id"` of the item or monster you want to have the art displayed for.
### ASCII art Editors
