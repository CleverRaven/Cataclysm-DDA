...
ASCII art for items is modular and only requires you to have the jsons for the art you want in the data/json/ascii_art/ folder.  The "id" string must match the "id" of the item you want to have the art displayed for.
### ASCII art Editors
