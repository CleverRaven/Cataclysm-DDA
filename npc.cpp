...
void npc::randomize(game *g, npc_class type)
{
    ...
    case NC_SCIENTIST:
        ...
        {
        case 1:
            sklevel[sk_computer] += rng(2, 6);
            break;
        case 2:
            sklevel[sk_electronics] += rng(2, 6);
            break;
        case 3:
            sklevel[sk_firstaid] += rng(2, 6);
            break;
...
void npc::starting_weapon(game *g)
{
    ...
    case sk_bashing:
        ...
        {
        case 0:
            weapon.make(g->itypes["hammer"]);
            break;
        case 1:
            weapon.make(g->itypes["wrench"]);
            break;
        case 2:
            weapon.make(g->itypes["hammer_sledge"]);
            break;
        case 3:
            weapon.make(g->itypes["pipe"]);
            break;
        case 4:
            weapon.make(g->itypes["bat"]);
            break;
        case 5:
            weapon.make(g->itypes["crowbar"]);
            break;
        }
        break;
    case sk_cutting:
        ...
        {
        case 0:
            weapon.make(g->itypes["knife_butcher"]);
            break;
        case 1:
            weapon.make(g->itypes["hatchet"]);
            break;
        case 2:
            weapon.make(g->itypes["ax"]);
            break;
        case 3:
            weapon.make(g->itypes["machete"]);
            break;
        case 4:
            weapon.make(g->itypes["knife_combat"]);
            break;
        case 5:
            weapon.make(g->itypes["katana"]);
            break;
        }
        break;
    case sk_throw:
